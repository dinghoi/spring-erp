...
title_line = "연금·저축 등 소득·세액 공제명세서"
%>
...
-->
    ...
    <object id="factory" style="display:none;" viewastext classid="clsid:1663ed61-23eb-11d2-b92f-008048fdd814" codebase="/smsx.cab#Version=7.0.0.8">
		...
		<div id="wrap">			
			<div id="container">
				<form action="insa_pay_yeartax_saving_print.asp" method="post" name="frm">
				<div class="gView">
                ...
                <table width="1150" border="1px" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tablePrt">
					...
					<table width="1150" border="1px" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tablePrt">
						<colgroup>
						 ...
						 <thead>
                              <tr>
                                <td colspan="5" height="30" align="left" scope="col">2. 연금계좌 세액공제</td>
                              </tr>
                              <tr>
                                <td colspan="5" height="30" align="left" scope="col" style=" border-bottom:1px solid #e3e3e3;">1) 퇴직연금계좌<br>* 퇴직연금계좌에 대한 명세를 작성합니다.</td>
                              </tr>
                              <tr>
                                <th class="first" height="30" align="center" scope="col">퇴직연금 구분</th>
                                <th scope="col" height="30" align="center">금융회사 등</th>
                                <th scope="col" height="30" align="center">계좌번호(또는 증권번호)</th>
                                <th scope="col" height="30" align="center">납입금액</th>
                                <th scope="col" height="30" align="center">세액공제금액</th>
                              </tr>
                        </thead>
						<tbody>
				     <%
	           		 ...
	           		 %>
							<tr>
                                ...
                                <td align="center"><%=rs("s_bank_name")%>&nbsp;</td>
                                <td align="center"><%=rs("s_account_no")%>&nbsp;</td>
                    ...
                    <table width="1150" border="1px" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tablePrt">
						<colgroup>
						 ...
						 <thead>
                              <tr>
                                <td colspan="5" height="30" align="left" scope="col" style=" border-bottom:1px solid #e3e3e3;">2) 연금저축계좌<br>* 연금저축계좌에 대한 명세를 작성합니다.</td>
                              </tr>
                              <tr>
                                <th class="first" height="30" align="center" scope="col">연금저축 구분</th>
                                <th scope="col" height="30" align="center">금융회사 등</th>
                                <th scope="col" height="30" align="center">계좌번호(또는 증권번호)</th>
                                <th scope="col" height="30" align="center">납입금액</th>
                                <th scope="col" height="30" align="center">세액공제금액</th>
                    ...
                    <table width="1150" border="1px" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tablePrt">
						<colgroup>
						 ...
						 <thead>
                              <tr>
                                <td colspan="5" height="30" align="left" scope="col" style=" border-bottom:1px solid #e3e3e3;">3. 주택마련저축 소득공제<br>* 주택마련저축 소득공제에 대한 명세를 작성합니다.</td>
                              </tr>
                              <tr>
                                <th class="first" height="30" align="center" scope="col">저축 구분</th>
                                <th scope="col" height="30" align="center">금융회사 등</th>
                                <th scope="col" height="30" align="center">계좌번호(또는 증권번호)</th>
                                <th scope="col" height="30" align="center">납입금액</th>
                                <th scope="col" height="30" align="center">세액공제금액</th>
                    ...
                    <table width="1150" border="1px" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tablePrt">
						<colgroup>
						 ...
						 <thead>
                              <tr>
                                <td colspan="5" height="30" align="left" scope="col" style=" border-bottom:1px solid #e3e3e3;">4. 장기집합투자증권 소득공제<br>* 장기집합투자증권 소득공제에 대한 명세를 작성합니다.</td>
                              </tr>
                              <tr>
                                <th colspan="2"scope="col" height="30" align="center">금융회사 등</th>
                                <th scope="col" height="30" align="center">계좌번호(또는 증권번호)</th>
                                <th scope="col" height="30" align="center">납입금액</th>
                                <th scope="col" height="30" align="center">세액공제금액</th>
                              </tr>
				     ...
				     <%
						...
						do until rs.eof
	           			...
	           			%>
							<tr>
                                <td colspan="2" align="center"><%=rs("s_bank_name")%>&nbsp;</td>
                                <td align="center"><%=rs("s_account_no")%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("s_amt"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("s_amt"),0)%>&nbsp;</td>
							</tr>
