				...
				<div class="gView">
					<table cellpadding="0" cellspacing="0" class="tableList">
						...
						<thead>
                            ...
                            <tr>
                              <td colspan="4">(<%=inc_yyyy%>) 년 의료비 지급명세</td>
						    </tr>
						</thead>
					</table>
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <table cellpadding="0" cellspacing="0" class="tableList">
                           <colgroup>
                            ...
                            <thead>
                              <tr>
                                <th colspan="4" class="first" scope="col" style=" border-bottom:1px solid #e3e3e3;">대상자</th>
                                <th colspan="3" scope="col" style=" border-bottom:1px solid #e3e3e3;">지급처</th>
                                <th colspan="2" scope="col" style=" border-bottom:1px solid #e3e3e3;">지급명세</th>
                              </tr>
                              <tr>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
				  <tr>
				    <td>
					<div class="btnRight">
                    <a href="#" onClick="pop_Window('insa_pay_yeartax_medical_print.asp?emp_no=<%=emp_no%>&emp_name=<%=emp_name%>&inc_yyyy=<%=inc_yyyy%>','yeartax_medial_print_popup','scrollbars=yes,width=1250,height=500')" class="btnType04">의료비지급명세 출력</a>
