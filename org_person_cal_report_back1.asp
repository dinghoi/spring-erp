					...
					<table cellpadding="0" cellspacing="0" class="tableList">
						...
						<thead>
							<tr>
								...
								<th colspan="10" style=" border-bottom:1px solid #e3e3e3;" scope="col">현금 사용</th>
							...
							<tr>
							  ...
							  <th style=" border-bottom:1px solid #e3e3e3;" scope="col">대중교통비</th>
						...
						%>
							<tr>
								...
								<td bgcolor="#EEFFFF" class="right"><%=formatnumber(sum_overtime_cnt,0)%></td>
								<td bgcolor="#EEFFFF" class="right"><%=formatnumber(sum_overtime_cost,0)%></td>
								<td bgcolor="#EEFFFF" class="right"><%=formatnumber(sum_general_cnt,0)%></td>
						...
						<% if saupbu <> "본인" then	%> 
							<tr>
								...
								<th class="right"><%=formatnumber(tot_overtime_cnt,0)%></th>
								<th class="right"><%=formatnumber(tot_overtime_cost,0)%></th>
								<th class="right"><%=formatnumber(tot_general_cnt,0)%></th>
