	...
	<body>
		<div id="wrap">			
			...
			<div id="container">
				...
				<form action="insa_pay_tax_mg.asp?ck_sw=<%="n"%>" method="post" name="frm">
				<fieldset class="srch">
					<legend>조회영역</legend>
					<dl>					
						<dt>◈ 검색◈</dt>
					...
					<table cellpadding="0" cellspacing="0" class="tableList">
						...
						<thead>
							<tr>
								...
								<th colspan="4" scope="col" style=" border-bottom:1px solid #e3e3e3;"><%=mid(pmg_yymm,1,4)%>년&nbsp;<%=mid(pmg_yymm,5,2)%>월</th>
                                <th rowspan="2" scope="col">비고</th>
							</tr>
                            <tr>
				                <th scope="col" style=" border-left:1px solid #e3e3e3;">인원</th> 
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
				  <tr>
                  	<td width="15%">
					<div class="btnCenter">
                    <a href="insa_excel_pay_pay_report.asp?view_condi=<%=view_condi%>&pmg_yymm=<%=pmg_yymm%>&to_date=<%=to_date%>" class="btnType04">엑셀다운로드</a>
					</div>                  
                  	</td>
                    <td>
					<div class="btnRight">
