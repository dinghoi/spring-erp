...
'### Request Param
'=========================================
Dim board_gubun, first_sw
Dim title_line
Dim ck_sw, page
Dim condi, condi_view, condi_value
Dim pgsize, start_page, stpage
Dim sel_sql, where_sql, condi_sql, order_sql
Dim Sql, RsCount, total_record, total_page, Rs
Dim new_date, seq, board_title
Dim path, intstart, intend, first_page, i
...
objBuilder.Append "SELECT COUNT(*) FROM board "
objBuilder.Append where_sql + condi_sql
				...
				<form action="nkp_main.asp" method="post" name="frm">
					...
					<div class="gView">
						<table cellpadding="0" cellspacing="0" class="tableList">
							...
							'컬럼명 지정 및 StringBuilder 적용[허정호_20201125]
							'sel_sql = "SELECT * FROM board "
							'sql = sel_sql + where_sql + condi_sql + order_sql + " LIMIT "& stpage & "," &pgsize
							objBuilder.Append "SELECT board_title, board_gubun,	board_seq, reg_name, reg_date, read_cnt, att_file "
							objBuilder.Append "FROM board "
							objBuilder.Append where_sql & condi_sql & order_sql & " "
