...
query_person_cost = query_person_cost + "           , ifnull(IF(COMPANY_YN>0, GAS_UNIT2 , GAS_UNIT),0)   AS GAS_UNIT                                                                                         "
query_person_cost = query_person_cost + "           , ifnull(IF(COMPANY_YN>0, ROUND(GAS_KM2    * A.GAS_UNIT2    / 7) , GAS_COST),0) AS GAS_COST                                                              "
query_person_cost = query_person_cost + "           , IF(COMPANY_YN>0, GASOL_KM2 , GASOL_KM)  AS  GASOL_KM                                                                                                   "
query_person_cost = query_person_cost + "           , ifnull(IF(COMPANY_YN>0, GASOL_UNIT2 , GASOL_UNIT),0) AS GASOL_UNIT                                                                                     "
query_person_cost = query_person_cost + "           , ifnull(IF(COMPANY_YN>0, ROUND(GASOL_KM2  * A.GASOL_UNIT2  / LITER ) , GASOL_COST),0) AS GASOL_COST                                                     "
query_person_cost = query_person_cost + "           , IF(COMPANY_YN>0, DIESEL_KM2 , DIESEL_KM)  AS  DIESEL_KM                                                                                                "
query_person_cost = query_person_cost + "           , ifnull(IF(COMPANY_YN>0, DIESEL_UNIT2 , DIESEL_UNIT),0) AS  DIESEL_UNIT                                                                                 "
query_person_cost = query_person_cost + "           , ifnull(IF(COMPANY_YN>0, ROUND(DIESEL_KM2 * A.DIESEL_UNIT2 / LITER) , DIESEL_COST),0) AS DIESEL_COST                                                    "
...
query_person_cost = query_person_cost + "           , IFNULL(COMPANY_YN ,0)     COMPANY_YN                                                                                                                                            "
