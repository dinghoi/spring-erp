...
title_line = " CE출고 현황 -- "+ goods_type +" (" + from_date + " ∼ " + to_date + ")"
...
if view_condi = "전체" then
   if goods_type = "전체" then
      where_sql = " WHERE (chulgo_date >= '"+from_date+"' and chulgo_date <= '"+to_date+"') and (chulgo_id = 'CE출고')" 
	  else
	  where_sql = " WHERE (chulgo_goods_type = '"&goods_type&"') and (chulgo_date >= '"+from_date+"' and chulgo_date <= '"+to_date+"') and (chulgo_id = 'CE출고')" 
   end if
 else  
   if goods_type = "전체" then
      where_sql = " WHERE (chulgo_stock_company = '"&view_condi&"') and (chulgo_date >= '"+from_date+"' and chulgo_date <= '"+to_date+"') and (chulgo_id = 'CE출고')"
	  else
	  where_sql = " WHERE (chulgo_goods_type = '"&goods_type&"') and (chulgo_stock_company = '"&view_condi&"') and (chulgo_date >= '"+from_date+"' and chulgo_date <= '"+to_date+"') and (chulgo_id = 'CE출고')"
   end if
end if   
