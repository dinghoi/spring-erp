...
'	on Error resume next
	...
	stin_date = request.form("stin_date")
	stin_order_no = request.form("stin_order_no")
	stin_order_seq = request.form("stin_order_seq")
	stin_goods_seq = request.form("stin_goods_seq")
	stin_goods_code = request.form("stin_goods_code")
