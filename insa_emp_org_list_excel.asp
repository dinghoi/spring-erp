...
order_Sql = " ORDER BY emp_bonbu,emp_saupbu,emp_team,emp_org_name,emp_no,emp_in_date ASC"
...
<table  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr valign="middle" class="style11">
    ...
    <td width="145"><div align="center" class="style1"><%=rs("emp_reside_company")%></div></td>
    <td width="115"><div align="center" class="style1"><%=rs("cost_center")%></div></td>
    <% 'response.write(rs("emp_stay_code"))
	   'response.End %>
    <td width="200"><div align="left" class="style1"><%=stay_name%></div></td>
    ...
    <td width="500"><div align="left" class="style1"><%=rs("emp_family_zip")%>&nbsp;<%=rs("emp_family_sido")%>&nbsp;<%=rs("emp_family_gugun")%>&nbsp;<%=rs("emp_family_dong")%>&nbsp;<%=rs("emp_family_addr")%></div></td>

    <td width="500"><div align="left" class="style1"><%=rs("emp_zipcode")%>&nbsp;<%=rs("emp_sido")%>&nbsp;<%=rs("emp_gugun")%>&nbsp;<%=rs("emp_dong")%>&nbsp;<%=rs("emp_addr")%></div></td>
    ...
    <td width="200"><div align="left" class="style1"><%=emp_email%></div></td>
    ...
    <td width="250"><div align="left" class="style1"><%=rs("emp_military_id")%>&nbsp;<%=emp_military_date1%>&nbsp;<%=emp_military_date2%>&nbsp;<%=rs("emp_military_grade")%>&nbsp;<%=rs("emp_military_comm")%></div></td>
