...
Set Rs_as_type = Server.CreateObject("ADODB.Recordset")
Dbconn.open dbconnect

'//get as type 리스트
sql = "select distinct as_type from as_acpt where ifnull(as_type,'')<>'' order by as_type asc"
Rs_as_type.Open sql, Dbconn, 1

Set listAsType = getRsToDic(Rs_as_type)


Rs_as_type.close : Set Rs_as_type = Nothing
