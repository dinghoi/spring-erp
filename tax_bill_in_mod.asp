				  ...
				  <table cellpadding="0" cellspacing="0" class="tableWrite">
				    ...
				    <tbody>
				      ...
				      <tr>
                        ...
                        <%=rs("org_company")%><a href="#" onClick="pop_Window('/org_search.asp?gubun=<%="계산서"%>&org_company=<%=rs("emp_company")%>','org_search_pop','scrollbars=yes,width=600,height=400')" class="btnType03">조회</a>
