					...
					<table cellpadding="0" cellspacing="0" class="tableList">
						...
						<thead>
				            <tr>
				               ...
				               <th colspan="3" scope="col" style=" border-bottom:1px solid #e3e3e3;">사업자 가입자요율</th>
						...
						%>
							<tr>
                                ...
                                <td class="left"><%=rs("insu_comment")%>&nbsp;</td>
								<td>
                                 <a href="#" onClick="pop_Window('insa_pay_insurance_add.asp?insu_id=<%=insu_code%>&view_condi=<%=view_condi%>&insu_class=<%=rs("insu_class")%>&insu_yyyy=<%=rs("insu_yyyy")%>&u_type=<%="U"%>','pay_insurance_add_popup','scrollbars=yes,width=750,height=300')">수정</a>
                                </td>
							</tr>
						<%
							rs.movenext()
