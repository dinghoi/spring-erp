...
-->
    ...
    <object id="factory" style="display:none;" viewastext classid="clsid:1663ed61-23eb-11d2-b92f-008048fdd814" codebase="/smsx.cab#Version=7.0.0.8">
    	...
    	<div id="wrap">			
			<div id="container">
				<form action="insa_pay_month_saup_print3.asp" method="post" name="frm">
				<div class="gView">
	       ...
	       %>
                              <tr>
                                ...
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_base_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_meals_pay,0)%></td>
                                <td class="right" style="font-size:11px;">&nbsp;</td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_postage_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_re_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_overtime_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_car_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_nps_amt,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_nhis_amt,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_epi_amt,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_longcare_amt,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_income_tax,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_wetax,0)%></td>
							</tr>
                            <tr>
                                <td class="right" style=" border-left:1px solid #e3e3e3;font-size:11px;"><%=formatnumber(org_position_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_custom_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_job_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_job_support,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_jisa_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_long_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_disabled_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_other_amt1,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_sawo_amt,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_school_amt,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_nhis_bla_amt,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_long_bla_amt,0)%></td>
                                <td class="right" style="font-size:11px;"><strong><%=formatnumber(org_deduct_tot,0)%></strong></td>
							</tr>
                            <tr>
                                ...
                                <td class="right" style="font-size:11px;">&nbsp;</td>
                                <td class="right" style="font-size:11px;">&nbsp;</td>
                                <td class="right" style="font-size:11px;"><strong><%=formatnumber(org_give_tot,0)%></strong></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_hyubjo_amt,0)%></td>
                                
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_year_incom_tax,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_year_wetax,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_year_incom_tax2,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(org_year_wetax2,0)%></td>
                                <td class="right" style="font-size:11px;"><strong><%=formatnumber(org_curr_pay,0)%></strong></td>
							</tr>           
