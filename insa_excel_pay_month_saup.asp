...
title_line = cstr(curr_yyyy) + "년 " + cstr(curr_mm) + "월 " + " 급여 내역서(" + view_condi + ")"
...
<table  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	%>
                 <tr>
                    <td colspan="8" bgcolor="#EEFFFF" align="center"><%=bi_team%>&nbsp;&nbsp;&nbsp;팀계</div></td>
                    <td bgcolor="#EEFFFF" align="right"><%=formatnumber(team_pay_count,0)%>&nbsp;명</td>
	...
	%>
                 <tr>
				    <td colspan="8" bgcolor="#EEFFFF" align="center"><%=bi_org%>&nbsp;&nbsp;&nbsp;사업부계</div></td>
                    <td bgcolor="#EEFFFF" align="right"><%=formatnumber(org_pay_count,0)%>&nbsp;명</td>
  ...
  <tr>    
    <th colspan="8" style=" border-top:1px solid #e3e3e3;"><div align="center" class="style1">총계</div></th>
    <td width="100" style=" border-top:1px solid #e3e3e3;"><div align="right" class="style1"><%=formatnumber(pay_count,0)%>&nbsp;명</td>
