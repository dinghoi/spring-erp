					...
					<dl>					
                        ...
                        <dd>
                            <p>
								...
								<input type="radio" name="bill_id" value="매출" <% if bill_id = "매출" then %>checked<% end if %> style="width:30px">
								매출
								<input type="radio" name="bill_id" value="매입" <% if bill_id = "매입" then %>checked<% end if %> style="width:30px">
								매입
