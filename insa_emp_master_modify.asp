					...
					<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						<tbody>
							<tr>
                                ...
                                <th>성명(한글)</th>
                                <td class="left">
                                <input name="emp_name" type="text" id="emp_name" size="13" value="<%=emp_name%>"></td>
								<th>성명(영문)</th>
								<td colspan="2" class="left">
                                <input name="emp_ename" type="text" id="emp_ename" style="width:160px" maxlength="20" value="<%=emp_ename%>"></td>
                                <th>생년월일</th>
                                <td colspan="2" class="left">
								<input name="emp_birthday" type="text" size="10" id="datepicker5" style="width:70px;" value="<%=emp_birthday%>">
                                &nbsp;―&nbsp;
                                ...
                                <th>소&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;속</th>
								<td colspan="3" class="left"><input name="emp_org_code" type="text" id="emp_org_code" style="width:40px" readonly="true" value="<%=emp_org_code%>">
                                &nbsp;―&nbsp;
                           ...
                           <tr>     
                                <th>최초입사일</th>
                                <td class="left">
                                <input name="emp_first_date" type="text" size="10" id="datepicker" style="width:70px;" value="<%=emp_first_date%>">&nbsp;
                                </td>
                                <th>입&nbsp;&nbsp;&nbsp;사&nbsp;&nbsp;&nbsp;일</th>
                                <td class="left">
								<input name="emp_in_date" type="text" size="10" id="datepicker1" style="width:70px;" value="<%=emp_in_date%>">&nbsp;
                                </td>
                                <th>퇴직기산일</th>
                                <td class="left">
                                <input name="emp_end_gisan" type="text" size="10" id="datepicker2" style="width:70px;" value="<%=emp_end_gisan%>">
                                </td>
                                <th>근속기산일</th>
                                <td class="left">
								<input name="emp_gunsok_date" type="text" size="10" id="datepicker3" style="width:70px;" value="<%=emp_gunsok_date%>">
                                </td>
                                <th>연차기산일</th>
                                <td class="left">
								<input name="emp_yuncha_date" type="text" size="10" id="datepicker4" style="width:70px;" value="<%=emp_yuncha_date%>">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <th>비상연락</th>
								<td colspan="2" class="left">
								<input name="emp_emergency_tel" type="text" id="emp_emergency_tel" size="30" value="<%=emp_emergency_tel%>"></td>
                            </tr>
                            <tr>
                         	...
                         	<tr>
                                ...
                                <th>경조가입일</th>
                                <td class="left">
                                <input name="emp_sawo_date" type="text" size="10" id="datepicker6" style="width:70px;" value="<%=emp_sawo_date%>">
                                </td>
								<th>결혼기념일</th>
                                <td class="left">
                                <input name="emp_marry_date" type="text" size="10" id="datepicker7" style="width:70px;" value="<%=emp_marry_date%>"></td>
								<th>취미</th>
                                <td class="left">
                            ...
                            <tr>
							  ...
							  %>  
                                ...
                                <th>병역 복무기간</th>
                                <td colspan="2" class="left">
								<input name="emp_military_date1" type="text" size="10" id="datepicker8" style="width:70px;" value="<%=emp_military_date1%>">
                                ∼
                                <input name="emp_military_date2" type="text" size="10" id="datepicker9" style="width:70px;" value="<%=emp_military_date2%>">
                                </td>
                                <th>면제사유</th>
								<td class="left">
                                ...
                                <th>종교</th>
                                <td class="left">
								<input name="emp_faith" type="text" id="emp_faith" style="width:90px" value="<%=emp_faith%>"></td></td>
							</tr>
                            <tr>
