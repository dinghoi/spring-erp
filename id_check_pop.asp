					...
					<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						<tbody>
							<tr>
								...
								<td class="left"><input name="user_id" type="text" id="user_id" value="<%=user_id%>" style="width:120px" onKeyUp="checklength(this,15)"><a href="#" class="btnType03" onclick="javascript:chkfrm();" >중복확인</a></td>
							</tr>
							<tr>
								<th class="first">가능여부</th>
								<td class="left"><%=use_msg%>&nbsp;
								  <% if use_ok = "Y" then %>
                                    <a href="#" class="btnType03" onClick="id_move('<%=user_id%>');">사용</a>
                                  <% end if %>
                                </td>
							</tr>
						</tbody>
