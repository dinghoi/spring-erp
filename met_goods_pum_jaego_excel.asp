...
savefilename = field_view + "품목별 재고현황" + cstr(curr_date) + ".xls"
...
<table  border="0" cellpadding="0" cellspacing="0">
  <tr bgcolor="#EFEFEF" class="style11">
    <td colspan="13" bgcolor="#FFFFFF"><div align="left" class="style2">&nbsp;<%=field_view%> &nbsp;(<%=goods_type%>)&nbsp;재고 현황&nbsp;<%=curr_date%></div></td>
  </tr>
  <tr bgcolor="#EFEFEF" class="style11">
