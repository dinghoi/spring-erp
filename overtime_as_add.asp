...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function chkfrm() {
				if(document.frm.work_date.value > "2014-12-31") {
					alert('2014년까지만 입력이 가능합니다.');
					frm.work_date.focus();
					return false;}
	...
	<body>
		<div id="container">				
			...
			<h3 class="tit"><%=title_line%></h3>
				<form method="post" name="frm" action="overtime_as_add.asp">
					<table cellpadding="0" cellspacing="0" summary="" class="tableWrite">
						...
						<tbody>
							<tr>
                              ...
                              <input name="dept" type="text" id="dept" style="width:100px" readonly="true" value="<%=dept%>">
                              </td>
						    </tr>
							<tr>
							  <th>작업일</th>
							...
							<tr>
							  <th>야근항목</th>
								<td class="left">
                                <select name="work_gubun" id="work_gubun" style="width:200px" value="<%=work_gubun%>">
				...
				<form method="post" name="frm1" action="overtime_as_add_save.asp">
