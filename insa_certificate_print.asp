...
'임시 변경(조직 변경 후 재 변경)[허정호_20210215]
    ...
    <object id="factory" style="display:none;" viewastext classid="clsid:1663ed61-23eb-11d2-b92f-008048fdd814" codebase="/smsx.cab#Version=7.0.0.8">
        ...
        <table width="750" border="1" cellspacing="10" cellpadding="0" align="center" class="onlyprint" style="border:10px solid #0072BE;">
          <tr>
		             ...
		             <td valign="middle" align="center">
		               <table width="560" cellspacing="0" cellpadding="12"  style="border:1px solid #000000;">
                         <tr>
                            ...
                            <td align="left" valign="middle" style="border-bottom:1px solid #000000;border-right:1px solid #000000;"><span class="style2"><strong><%=rs("emp_name")%></strong></td>
                            ...
                            <td align="left" valign="middle" style="border-bottom:1px solid #000000;"><span class="style2"><strong><%=rs("emp_person1")%>-<%=emp_person2%></strong></td>
                         </tr>
                         <tr>
                            ...
                            <td align="left" valign="middle" style="border-bottom:1px solid #000000;"><span class="style2"><strong><%=rs("emp_job")%></strong></td>
                         </tr>
                         <tr>
                            ...
                            <td colspan="3" align="left" valign="middle" style="border-bottom:1px solid #000000;"><span class="style2"><strong><%=rs("emp_sido")%>&nbsp;<%=rs("emp_gugun")%>&nbsp;<%=rs("emp_dong")%>&nbsp;<%=rs("emp_addr")%></strong></td>
                         </tr>
                         <tr>
                         ...
                         <tr>
                            ...
                            <td colspan="3" align="left" valign="middle" style="border-bottom:1px solid #000000;"><span class="style2"><strong><%=mid(cstr(rs("emp_in_date")),1,4)%>년&nbsp;<%=mid(cstr(rs("emp_in_date")),6,2)%>월&nbsp;<%=mid(cstr(rs("emp_in_date")),9,2)%>일부터&nbsp;&nbsp;현재까지</strong></td>
                        </tr>
                        <tr>
	       ...
	       <tr>
          <% if cfm_company = "케이원정보통신" Or cfm_company = "케이네트웍스" then %>
		...
		서울시 금천구 가산디지털2로 18(대륭테크노타운 1차 6층)</td>
		  ...
		  if cfm_company = "케이원정보통신" then %>
			 ...
			 <td height="60" align="right" valign="middle" width="100%"><img src="/image/stamp/k_one_2021_001.png" width="80" height="80" alt="" align="right"><font style="font-size:14px"><br><br>주식회사 케이원<br />
          ...
          <% if cfm_company = "케이네트웍스" then %>
			...
			<td height="60" align="right" valign="middle" width="100%"><img src="/image/stamp/k_net_2021_001.png" width="80" height="80" alt="" align="right"><font style="font-size:14px"><br><br>주식회사 케이넷<br />
			<font style="font-size:14px">대표이사 </font><font style="font-size:16px"><b>김승일</b></font><br/>
			<font style="font-size:14px">대표이사 </font><font style="font-size:16px"><b>이재원</b></font></td>
          <% end if %>
          <% if cfm_company = "에스유에이치" then %>
	        <td height="60" align="right" valign="middle" width="100%"><img src="/image/stamp/k_one_2021_001.png" width="80" height="80" alt="" align="right"><font style="font-size:14px"><br><br>주식회사 에스유에이치<br />
          ...
          <% if cfm_company = "코리아디엔씨" then %>
			...
			<td height="60" align="right" valign="middle" width="100%"><img src="/image/stamp/k_sys_2021_001.png" width="80" height="80" alt="" align="right"><font style="font-size:14px"><br><br>주식회사 케이시스템<br />
			<font style="font-size:14px">대표이사 </font><font style="font-size:16px"><b>장원영</b></font></td>
          <% end if %>
	      </tr>
       </table>
	<br><br><br>
