...
emp_user = request.cookies("nkpmg_user")("coo_user_name")
	...
	if	u_type = "U" then
		...
		sql="insert into car_drive_user (use_car_no,use_owner_emp_no,use_date,use_compay,use_org_code,use_org_name,use_emp_name,use_emp_grade,use_reg_date,use_reg_user) values ('"&use_car_no&"','"&use_owner_emp_no&"','"&use_date&"','"&use_company&"','"&use_org_code&"','"&use_org_name&"','"&use_emp_name&"','"&use_emp_grade&"',now(),'"&emp_user&"')"
		dbconn.execute(sql)
