...
'    sql="select max(draft_no) as max_seq from emp_alba_mst where company = '"&view_condi&"'"
    sql="select max(draft_no) as max_seq from emp_alba_mst"
...
<html>
	...
	<body onload="update_view()">
			<div id="container">
				...
				<form action="alba_person_add_save.asp" method="post" name="frm">
				<div class="gView">
						...
						<tbody>
                            ...
                            <tr>
								...
								<input name="sido" type="text" id="sido" style="width:80px" readonly="true" value="<%=sido%>">
              					...
              					<a href="#" class="btnType03" onClick="pop_Window('area_search.asp?gubun=<%="1"%>','area_search_pop','scrollbars=yes,width=600,height=400')">주소조회</a>
                                </td>
                             </tr>
                            <tr>          
                ...
                <input type="hidden" name="company" value="<%=view_condi%>" ID="Hidden1">
			</form>
		</div>				
	</body>
</html>
