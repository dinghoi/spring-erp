...
order_Sql = " ORDER BY cost_group,pmg_saupbu,pmg_org_name,pmg_emp_no ASC"
...
<table  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <%
       do until rs.eof
		  ...
		  if rs("cost_group") = "" or isnull(rs("cost_group")) then
		          cost_group = ""
			 else
			      cost_group = rs("cost_group")
		  end if
		  if rs("cost_center") = "" or isnull(rs("cost_center")) then
		          cost_center = ""
			 else
		  ...
		  if f_sw = "1" then
		        bigo_org = pmg_saupbu
				bigo_cost_group = cost_group
				bigo_cost_center = cost_center
				f_sw = "2"
		  end if
  ...
  <tr valign="middle" class="style11">
    ...
    <td width="100" style="background:#E0FFFF;"><div align="right" class="style1"><%=formatnumber(sap_give_tot,0)%></div></td>
     ...
     <%	     
		  'if bigo_org <> pmg_saupbu then
		  if bigo_cost_group <> cost_group then
	 %>
  <tr valign="middle" class="style11">
  ...
  <tr valign="middle" class="style11">
    ...
    <td width="140"><div align="center" class="style1"><%=rs("pmg_company")%></div></td>
    <td width="140"><div align="center" class="style1"><%=rs("pmg_saupbu")%></div></td>
    <td width="140"><div align="center" class="style1"><%=rs("pmg_org_name")%></div></td>
