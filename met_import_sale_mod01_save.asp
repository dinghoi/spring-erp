...
'2014-01-25 기존에 설치사진 첨부 (종료)
	...
	old_chulgo_no = abc("old_chulgo_no")
...
' 출고정리		
		...
		dbconn.execute(sql)
' serial no삭제		
		sql = "delete from met_goods_serial where chulgo_date ='"&old_chulgo_date&"' and chulgo_no='"&old_chulgo_no&"' and chulgo_seq='"&old_chulgo_seq&"'"
		dbconn.execute(sql)		
