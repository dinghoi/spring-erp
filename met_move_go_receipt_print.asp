  ...
  <tr>
    <td style="border-bottom:none; border-top:none;">
     <table width="680" border="1px" cellpadding="0" cellspacing="0">
      <tr>  
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">출고일자</span></td>
        <td width="*" height="30" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=chulgo_date%>(<%=chulgo_seq%>)</span></td>
      ...
      <tr>  
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">의뢰일자</span></td>
        ...
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">의뢰담당</span></td>
      ...
      <tr>  
        ...
        <td width="20%" height="30" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rele_memo%></span></td>
      </tr>
    </table>
   </td>
  </tr>  
  ...
  <tr>
    <td style="border-bottom:none; border-top:none;"><table width="680" border="1px" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="10%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">비고</strong></td>
      </tr>
   <% do until rs.eof or rs.bof	%>
      <tr>
        <td width="3%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("chulgo_goods_seq")%></span></td>
        <td width="12%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("chulgo_goods_type")%></span></td>
        <td width="*" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("chulgo_goods_gubun")%></span></td>
        <td width="14%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("chulgo_goods")%></span></td>
        <td width="14%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("chulgo_goods_name")%></span></td>
        <td width="14%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("chulgo_standard")%></span></td>
        <td width="6%" height="20" align="right" valign="middle" ><span class="style1"><span><%=formatnumber(rs("chulgo_qty"),0)%></span>&nbsp;</td>
        <td width="10%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("chulgo_type")%></span></td>
