...
'response.write(career_empno)
'response.write(career_seq)
'response.write(career_name)
'response.End
...
sql = " delete from emp_career " & _
			"  where career_empno ='"&career_empno&"' and career_seq = '"&career_seq&"'"
...
'url = "insa_career_mg.asp?ck_sw=y&view_condi=" + career_empno + "&condi="+ career_name
if owner_view = "C" then
		   url = "/insa/insa_areer_mg.asp?ck_sw=y&view_condi=" + career_name + "&owner_view="+ owner_view
	elsec
		   url = "/insa/insa_career_mg.asp?ck_sw=y&view_condi=" + career_empno + "&owner_view="+ owner_view
end If
