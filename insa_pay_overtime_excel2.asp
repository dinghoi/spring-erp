...
title_line = "야·특근 현황(수당) -- "+ view_condi +"(" + from_date + "∼" + to_date + ")"
%>
			...
			<div id="container">
				...
				<div class="gView">
					<table border="1" cellpadding="0" cellspacing="0" class="tableList">
					  ...
					  %>
                                 <tr>
								    <td colspan="5" bgcolor="#EEFFFF" align="center"><%=ce_name%>&nbsp;&nbsp;&nbsp;계</td>
					  ...
					  %>
                                 <tr>
								    <td colspan="5" bgcolor="#EEFFFF" align="center"><%=bi_team%>&nbsp;&nbsp;&nbsp;계</td>
                      ...
                      <%    
						...
						%>
                            ...
                            <tr>
								<th colspan="5" align="center">합&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;계</th>
