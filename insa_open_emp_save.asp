...
if filenm <> "" then 
   filenm.save save_path
    sql = "update emp_master set emp_ename ='"+emp_ename+"',emp_sex ='"+emp_sex
    sql = sql + "',emp_person1 ='"+emp_person1+"',emp_person2 ='"+emp_person2+"',emp_image ='"+filename+"',emp_birthday ='"+emp_birthday+"',emp_birthday_id ='"+emp_birthday_id
    ...
    sql = sql + "',emp_hobby ='"+emp_hobby+"',emp_faith ='"+emp_faith+"',emp_last_edu ='"+emp_last_edu+"',emp_marry_date ='"+emp_marry_date+"',emp_disabled ='"+emp_disabled+"',emp_disab_grade ='"+emp_disab_grade
    sql = sql + "',emp_emergency_tel ='"+emp_emergency_tel+"',emp_extension_no ='"+emp_extension_no+"',emp_mod_user = '"+emp_mod_user+"',emp_mod_date = now() where emp_no ='"+emp_no+"'"
	Else
    sql = "update emp_master set emp_ename ='"+emp_ename+"',emp_sex ='"+emp_sex
    sql = sql + "',emp_person1 ='"+emp_person1+"',emp_person2 ='"+emp_person2+"',emp_birthday ='"+emp_birthday+"',emp_birthday_id ='"+emp_birthday_id
    sql = sql + "',emp_family_zip ='"+emp_family_zip+"',emp_family_sido ='"+emp_family_sido+"',emp_family_gugun ='"+emp_family_gugun+"', emp_family_dong ='"+emp_family_dong+"',emp_family_addr ='"+emp_family_addr+"',emp_zipcode ='"+emp_zipcode+"',emp_sido ='"+emp_sido
    sql = sql + "',emp_gugun ='"+emp_gugun+"',emp_dong ='"+emp_dong+"',emp_addr ='"+emp_addr+"',emp_tel_ddd ='"+emp_tel_ddd+"',emp_tel_no1 ='"+emp_tel_no1+"',emp_tel_no2 ='"+emp_tel_no2+"',emp_hp_ddd ='"+emp_hp_ddd+"',emp_hp_no1 ='"+emp_hp_no1+"',emp_hp_no2 ='"+emp_hp_no2
    sql = sql + "',emp_email ='"+emp_email+"',emp_military_id ='"+emp_military_id+"',emp_military_date1 ='"+emp_military_date1+"', emp_military_date2 ='"+emp_military_date2+"',emp_military_grade ='"+emp_military_grade+"',emp_military_comm ='"+emp_military_comm
    sql = sql + "',emp_hobby ='"+emp_hobby+"',emp_faith ='"+emp_faith+"',emp_last_edu ='"+emp_last_edu+"',emp_marry_date ='"+emp_marry_date+"',emp_disabled ='"+emp_disabled+"',emp_disab_grade ='"+emp_disab_grade
...
if emp_no <> "" or emp_no <> " " then
    ...
    if not rs_memb.eof then
	    sql = "update memb set hp='"&emp_hp&"',email='"&kwon_email&"',mod_id='"&user_id&"',mod_date=now() where user_id='"&emp_no&"'"
