...
title_line = stock + " < " + goods_type + " > 일자별 입출고 내역 " + "(" + from_date + " ~ " + to_date + ")"
...
'출고찾기						   
					...
					%>
				      <tr valign="middle" class="style1">
				        <td align="center" style="border-top:1px solid #515254"><%=rs("stock_company")%>&nbsp;</td>
                        <td align="center" style="border-top:1px solid #515254"><%=rs("stock_goods_type")%>&nbsp;</td>
                        <td align="center" style="border-top:1px solid #515254"><%=rs("stock_goods_code")%>&nbsp;</td>
                        <td align="center" style="border-top:1px solid #515254"><%=rs("stock_goods_gubun")%>&nbsp;</td>
                        <td align="center" style="border-top:1px solid #515254"><%=rs("stock_goods_name")%>&nbsp;</td>
                        <td align="center" style="border-top:1px solid #515254"><%=rs("stock_goods_standard")%>&nbsp;</td>
                        <td align="center" style="border-top:1px solid #515254"><%=part_number%>&nbsp;</td>
                        <td align="center" style="border-top:1px solid #515254"><%=rs("stock_goods_grade")%>&nbsp;</td>
                        <td align="center" style="border-top:1px solid #515254"><%=rs("stock_name")%>&nbsp;</td>
                        <td align="right" style="border-top:1px solid #515254"><%=formatnumber(be_jae_cnt,0)%>&nbsp;</td>
                        <td align="center" style="border-top:1px solid #515254">&nbsp;</td>
                        <td align="right" style="border-top:1px solid #515254"><%=formatnumber(sum_in_cnt,0)%>&nbsp;</td>
                        <td align="right" style="border-top:1px solid #515254"><%=formatnumber(sum_out_cnt,0)%>&nbsp;</td>
                        <td align="center" style="border-top:1px solid #515254">&nbsp;</td>
                        <td align="right" style="border-top:1px solid #515254"><%=formatnumber(sum_jae_cnt,0)%>&nbsp;</td>
                        <td align="center" style="border-top:1px solid #515254">&nbsp;</td>
			          </tr>
				    <%
'입고출력-본사구매입고	/ 직접 영업및ce쪽으로 입고시킨것						   
						   sql = "select * from met_stin_goods where (stin_stock_company = '"&stock_company&"') and (stin_stock_code = '"&stock_code&"') and (stin_goods_type = '"&stock_goods_type&"') and (stin_goods_code = '"&stock_goods_code&"') and (stin_date >= '"+st_date+"' and stin_date <= '"+to_date+"') ORDER BY stin_date ASC"
	                       Rs_in.Open Sql, Dbconn, 1
                           while not Rs_in.eof
							  be_stin_date = cstr(mid(Rs_in("stin_date"),1,4)) + cstr(mid(Rs_in("stin_date"),6,2)) + cstr(mid(Rs_in("stin_date"),9,2))
					...
					%>
				                  <tr valign="middle" class="style1">
                                     ...
                                     <td align="center">&nbsp;</td>
                                     <td align="right">&nbsp;</td>
                                     <td align="center"><%=Rs_in("stin_date")%>&nbsp;</td>
                                     <td align="right"><%=formatnumber(Rs_in("stin_qty"),0)%>&nbsp;</td>
                                     <td align="right">&nbsp;</td>
                                     <td align="center">&nbsp;</td>
                                     <td align="right">&nbsp;</td>
                                     <td align="center">&nbsp;</td>
...
'입고출력-본사 또는 개인이 ce쪽으로 출고한것(창고이동 입고건)						   
						   sql = "select * from met_mv_in_goods where (mvin_in_stock = '"&stock_code&"') and (in_goods_type = '"&stock_goods_type&"') and (in_goods_code = '"&stock_goods_code&"') and (mvin_in_date >= '"+st_date+"' and mvin_in_date <= '"+to_date+"') ORDER BY mvin_in_date ASC"
	                       Rs_in.Open Sql, Dbconn, 1
                           while not Rs_in.eof
							  be_stin_date = cstr(mid(Rs_in("mvin_in_date"),1,4)) + cstr(mid(Rs_in("mvin_in_date"),6,2)) + cstr(mid(Rs_in("mvin_in_date"),9,2))
					...
					%>
				                  <tr valign="middle" class="style1">
                                     ...
                                     <td align="center">&nbsp;</td>
                                     <td align="right">&nbsp;</td>
                                     <td align="center"><%=Rs_in("mvin_in_date")%>&nbsp;</td>
                                     <td align="right"><%=formatnumber(Rs_in("in_qty"),0)%>&nbsp;</td>
                                     <td align="right">&nbsp;</td>
                                     <td align="center">&nbsp;</td>
                                     <td align="right">&nbsp;</td>
                                     <td align="center">&nbsp;</td>
...
'출고찾기						   
					...
					%>
				                  <tr valign="middle" class="style1">
                                     ...
                                     <td align="center">&nbsp;</td>
                                     <td align="right">&nbsp;</td>
                                     <td align="center"><%=Rs_out("chulgo_date")%>&nbsp;</td>
                                     <td align="right">&nbsp;</td>
                                     <td align="right"><%=formatnumber(Rs_out("cg_qty"),0)%>&nbsp;</td>
                                     <td align="center"><%=Rs_out("rl_stock_name")%>&nbsp;</td>
                                     <td align="right">&nbsp;</td>
                                     <td align="center">&nbsp;</td>
			                      </tr>
				    <%													  
