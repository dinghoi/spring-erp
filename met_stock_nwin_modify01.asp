		...
		function pummok_list_view() {
			...
			function delcheck() 
				...
				if (a==true) {
					...
					document.frm.action = "met_stock_nwin_del_ok.asp";
					document.frm.submit();
				return true;
				}
				return false;
	...
	<body onload="pummok_list_view();">
		<div id="container">				
			<div class="gView">
                ...
                <form method="post" name="frm" action="met_stock_nwin_modify01_save.asp" enctype="multipart/form-data">
                    <table cellpadding="0" cellspacing="0" summary="" class="tableWrite">
						...
						<tbody>
							...
							<tr>
							  <th>비고</th>
							  <td class="left" colspan="8" ><textarea name="buy_memo" rows="3" id="textarea"><%=stin_memo%></textarea></td>
						    </tr>
						</tbody>
					</table>
                <br>
