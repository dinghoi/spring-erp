		...
		function NumCal(txtObj){
			...
			function delcheck() 
				...
				if (a==true) {
					...
					document.frm.action = "sales_slip_wait_del_ok.asp";
					document.frm.submit();
				return true;
				}
				return false;
	...
	<body onload="pummok_list_view();">
		...
		<div id="container">				
			...
			<h3 class="tit"><%=title_line%></h3>
				<form method="post" name="frm" action="sales_slip_wait_mod_save.asp" enctype="multipart/form-data">
					<table cellpadding="0" cellspacing="0" summary="" class="tableWrite">
						...
						<tbody>
							<tr>
							  <th>전표유형</th>
							  <td class="left">대기전표&nbsp;<%=view_slip_no%></td>
							  <th>매출조직</th>
            		...
            		<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						%>
			  				<tr id="pummok_list<%=i%>" style="display:none">
								...
								<td><input name="sales_tot<%=i%>" type="text" id="sales_tot<%=i%>" value="<%=formatnumber(cost_tab(4,i),0)%>" style="width:100px;text-align:right" readonly="true"></td>
								<td><input name="margin_cost<%=i%>" type="text" id="margin_cost<%=i%>" style="width:100px;text-align:right" readonly="true"></td>
								<td><input name="margin_tot<%=i%>" type="text" id="margin_tot<%=i%>" style="width:100px;text-align:right" readonly="true"></td>
							</tr>
						<%
							next
						%>
					...
					<table cellpadding="0" cellspacing="0" summary="" class="tableWrite">
						...
						<tbody>
							...
							<tr>
                              ...
                              <input name="att_file" type="file" id="att_file" size="80">
                              </td>
						    </tr>
						</tbody>
					</table>
