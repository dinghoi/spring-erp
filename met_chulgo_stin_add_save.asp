...
'출고의뢰 update
    sql = "Update met_chulgo_reg set chulgo_ing='"&chulgo_type&"',mod_date=now(),mod_user='"&user_name&"' where rele_no = '"&rele_no&"' and rele_seq = '"&rele_seq&"' and rele_date = '"&rele_date&"'"
		dbconn.execute(sql)
...
'		  	     sql = "Update met_chulgo_reg_goods set chulgo_ing='"&chulgo_type&"',mod_date=now(),mod_user='"&user_name&"' where rele_no = '"&rele_no&"' and rele_seq = '"&rele_seq&"' and rele_date = '"&rele_date&"' and rl_goods_seq = '"&seq_tab(i)&"' and rl_goods_code = '"&code_tab(i)&"'"
'			     dbconn.execute(sql)
''			end if
'		end if
'	next
...
'출고 입고일update	
	...
	sql = "Update met_chulgo set chulgo_type='"&chulgo_type&"',in_stock_date='"&mvin_in_date&"',mod_date=now(),mod_user='"&user_name&"' where chulgo_date = '"&chulgo_date&"' and chulgo_stock = '"&chulgo_stock&"' and chulgo_seq = '"&chulgo_seq&"'"
...
'		  else
''		    if c_chk_tab(i) <> "1" then
'		  	     sql = "Update met_chulgo_goods set cg_type='"&chulgo_type&"',mod_date=now(),mod_user='"&user_name&"' where chulgo_date = '"&chulgo_date&"' and chulgo_stock = '"&chulgo_stock&"' and chulgo_seq = '"&chulgo_seq&"' and cg_goods_code = '"&code_tab(i)&"' and cg_goods_seq = '"&seq_tab(i)&"'"
'			     dbconn.execute(sql)
''			end if
'		end if
'	next
