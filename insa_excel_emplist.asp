...
Sql = "SELECT * FROM emp_master where "+condi_sql+" (isNull(emp_end_date) or emp_end_date = '1900-01-01')  and (emp_no < '900000') ORDER BY emp_in_date,emp_no,emp_name ASC" 
...
<table  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr valign="middle" class="style11">
    ...
    <td width="145"><div align="center" class="style1"><%=rs("emp_last_edu")%></div></td>

    <td width="350"><div align="left" class="style1"><%=rs("emp_family_sido")%>&nbsp;<%=rs("emp_family_gugun")%>&nbsp;<%=rs("emp_family_dong")%>&nbsp;<%=rs("emp_family_addr")%></div></td>

    <td width="350"><div align="left" class="style1"><%=rs("emp_sido")%>&nbsp;<%=rs("emp_gugun")%>&nbsp;<%=rs("emp_dong")%>&nbsp;<%=rs("emp_addr")%></div></td>
    ...
    <td width="145"><div align="center" class="style1"><%=rs("emp_military_id")%>&nbsp;<%=emp_military_date1%>&nbsp;<%=emp_military_date2%>&nbsp;<%=rs("emp_military_grade")%>&nbsp;<%=rs("emp_military_comm")%></div></td>
