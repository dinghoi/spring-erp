...
' 사업부가틀리면
	       ...
	       %>
                              <tr>
                                ...
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_base_pay,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_meals_pay,0)%></td>
                                <td align="right" style="font-size:11px;">&nbsp;</td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_postage_pay,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_re_pay,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_overtime_pay,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_car_pay,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_nps_amt,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_nhis_amt,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_epi_amt,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_longcare_amt,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_income_tax,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_wetax,0)%></td>
							</tr>
                            <tr>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_position_pay,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_custom_pay,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_job_pay,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_job_support,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_jisa_pay,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_long_pay,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_disabled_pay,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_other_amt1,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_sawo_amt,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_school_amt,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_nhis_bla_amt,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_long_bla_amt,0)%></td>
                                <td align="right" style="font-size:11px;"><strong><%=formatnumber(team_deduct_tot,0)%></strong></td>
							</tr>
                            <tr>
                                <td align="right" style="font-size:11px;">&nbsp;</td>
                                <td align="right" style="font-size:11px;">&nbsp;</td>
                                ...
                                <td align="right" style="font-size:11px;">&nbsp;</td>
                                <td align="right" style="font-size:11px;">&nbsp;</td>
                                <td align="right" style="font-size:11px;"><strong><%=formatnumber(team_give_tot,0)%></strong></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_hyubjo_amt,0)%></td>
                                
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_year_incom_tax,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_year_wetax,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_year_incom_tax2,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_year_wetax2,0)%></td>
                                <td align="right" style="font-size:11px;"><strong><%=formatnumber(team_curr_pay,0)%></strong></td>
							</tr>
	       <%
                            team_base_pay = 0 
				            team_meals_pay = 0
...
' 팀이 틀리면							  
	       ...
	       %>
                            ...
                            <tr>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_position_pay,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_custom_pay,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_job_pay,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_job_support,0)%></td>
                                <td align="right" style="font-size:11px;"><%=formatnumber(team_jisa_pay,0)%></td>
