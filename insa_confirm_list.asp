			...
			function s_sinchung(val, val2) {
				...
				*/
				...
				if( val2=="cert" ){
					...
					actionUrl = "insa_certificate_print.asp";
				}else{
					if (!confirm("경력증명서를 신청하시겠습니까 ?")) return;
					actionUrl = "insa_certificate_career.asp";
				}
		...
		<div id="wrap">			
			...
			<div id="container">
				...
				<fieldset class="srch">
                  ...
                  <input type="hidden" name="in_name" value="<%=emp_name%>">
						...
						do until rs.eof
	           			...
	           			%>
							<tr>
                                ...
                                <td>
                                <input type="image" name="rptCert$ctl00$btnRequest" src="/image/b_certifi.jpg" alt="재직증명서 신청" onclick="s_sinchung('<%=rs("emp_no")%>','cert');return false;" style="border-width:0px;" />
                                </td>
                                <td>
                                <input type="image" name="rptCert$ctl01$btnRequest" src="/image/b_certifi.jpg" alt="경력증명서 신청" onclick="s_sinchung('<%=rs("emp_no")%>','carrer');return false;" style="border-width:0px;" />
                                </td>
							</tr>
						<%
							rs.movenext()
