...
year_tab(1,2) = cstr(year_tab(1,1)) + "년"
	...
	If ck_sw = "n" Then
		...
		file_name = pay_company + "_" + pay_yyyy + "_연봉 및 표준월액(국민 의보등)" + give_date
...
'		save_path = path & "\" & filename
	...
	title_line = "연봉 및 표준월액(국민연금 의료보험등) 자료 업로드"
	...
	<body>
		<div id="wrap">			
			...
			<div id="container">
				...
				<form action="insa_pay_year_income_up.asp" method="post" name="frm" enctype="multipart/form-data">
				<fieldset class="srch">
					<legend>조회영역</legend>
					<dl>					
						<dt>업로드내용</dt>
			...
			<% 
				...
				<form action="insa_pay_year_income_up_ok.asp" method="post" name="frm1">
					<br>
                    <div align=center>
