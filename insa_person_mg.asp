	...
	<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
		<div id="wrap">
			...
			<div id="container">
				...
				<form action="insa_person_mg.asp" method="post" name="frm">
				<div class="gView">
                ...
                <th scope="col">구분</th>
						...
						%>
							<tr>
								...
								<td>
                	<a href="#" onClick="pop_Window('insa_individual_card00.asp?emp_no=<%=rs("emp_no")%>','emp_card0_pop','scrollbars=yes,width=1300,height=650')"><%=rs("emp_name")%></a>
								</td>
                <td><%=rs("emp_grade")%>&nbsp;</td>
                <td><%=rs("emp_job")%>&nbsp;</td>
