...
Set rs_saupbu = Server.CreateObject("ADODB.Recordset")
...
if isnull(rs("cowork_yn")) or rs("cowork_yn") = "" or rs("cowork_yn") = " " or rs("cowork_yn") = "N" then
		cowork_yn = "N"
	else
  	cowork_yn = "Y"
end if
...
'response.write"alert('"&cowork_yn&"');"
'response.write "history.back();"
'response.write "</script>"
'response.end


sql_saupbu = "select * from nkp.emp_master where emp_no="&rs("reg_id")
set rs_saupbu = DbConn.Execute(sql_saupbu)
...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function frmcheck () {
				if (chkfrm()) {
					document.getElementById('cowork_reside_company').disabled=false;
					document.frm.submit ();
				}
			...
			function chkfrm() {
				...
				if(document.frm.as_process.value =="완료") {
					if(document.frm.as_unit.value =="") {
						alert('AS표준단가유형을 선택하세요');
						document.frm.as_unit.focus();
						return false;}
				}
			 ...
			 /**/
				...
				if(document.frm.as_process.value =="완료" || document.frm.as_process.value =="대체" || document.frm.as_process.value =="취소"  || document.frm.as_process.value =="대체입고")
					...
					return false;}
				if(document.frm.as_process.value =="완료")
					if(document.frm.as_type.value =="신규설치" || document.frm.as_type.value =="신규설치공사" || document.frm.as_type.value =="이전설치" || document.frm.as_type.value =="이전설치공사" || document.frm.as_type.value =="랜공사" || document.frm.as_type.value =="이전랜공사" || document.frm.as_type.value =="장비회수" || document.frm.as_type.value =="예방점검" || document.frm.as_type.value =="야특근") {
						if(document.frm.dev_inst_cnt.value < 0 || document.frm.dev_inst_cnt.value > 999 || document.frm.dev_inst_cnt.value == "-" || document.frm.dev_inst_cnt.value == "") {
							alert('설치대수가 999보다 크거나 잘못되었습니다');
							frm.dev_inst_cnt.focus();
					return false;}}
				if(document.frm.as_process.value =="완료")
					if(document.frm.as_type.value =="신규설치" || document.frm.as_type.value =="신규설치공사" || document.frm.as_type.value =="이전설치" || document.frm.as_type.value =="이전설치공사" || document.frm.as_type.value =="랜공사" || document.frm.as_type.value =="이전랜공사" || document.frm.as_type.value =="장비회수" || document.frm.as_type.value =="예방점검" || document.frm.as_type.value =="야특근") {
						if(document.frm.ran_cnt.value < 0 || document.frm.ran_cnt.value > 999 || document.frm.ran_cnt.value == "-" || document.frm.ran_cnt.value == "") {
							alert('공사대수가 999보다 크거나 잘못되었습니다');
							frm.ran_cnt.focus();
					return false;}}
				if(document.frm.as_process.value =="완료")
					if(document.frm.as_type.value =="신규설치" || document.frm.as_type.value =="신규설치공사" || document.frm.as_type.value =="이전설치" || document.frm.as_type.value =="이전설치공사" || document.frm.as_type.value =="랜공사" || document.frm.as_type.value =="이전랜공사" || document.frm.as_type.value =="장비회수" || document.frm.as_type.value =="예방점검" || document.frm.as_type.value =="야특근") {
						if(document.frm.ran_cnt.value == 0 && document.frm.dev_inst_cnt.value == 0) {
							alert('설치와 공사대수가 0 입니다.');
							frm.dev_inst_cnt.focus();
					return false;}}
				if(document.frm.as_process.value =="완료")
					if(document.frm.as_type.value =="신규설치" || document.frm.as_type.value =="신규설치공사" || document.frm.as_type.value =="이전설치" || document.frm.as_type.value =="이전설치공사" || document.frm.as_type.value =="랜공사" || document.frm.as_type.value =="이전랜공사" || document.frm.as_type.value =="야특근") {
				...
				if(document.frm.as_process.value =="완료")
					if(document.frm.as_type.value =="신규설치" || document.frm.as_type.value =="신규설치공사" || document.frm.as_type.value =="이전설치" || document.frm.as_type.value =="이전설치공사" || document.frm.as_type.value =="랜공사" || document.frm.as_type.value =="이전랜공사" || document.frm.as_type.value =="야특근") {
						if(document.frm.alba_cnt.value < 0 || document.frm.alba_cnt.value > 30 || document.frm.alba_cnt.value == "-" || document.frm.alba_cnt.value == "") {
				...
				if(document.frm.as_process.value =="완료"){
					if (document.frm.as_type.value == '신규설치' || document.frm.as_type.value == '신규설치공사' || document.frm.as_type.value == '이전설치' || document.frm.as_type.value == '이전설치공사'
						|| document.frm.as_type.value == '랜공사' || document.frm.as_type.value == '이전랜공사' || document.frm.as_type.value == '장비회수' || document.frm.as_type.value == '예방점검'
						|| doc_yn =="Y") {
			...
			function sel_cowork_reside() {
				if (document.getElementById('cowork_y').checked) {
					document.getElementById('cowork_reside_place').disabled=false;
				} else {
					document.getElementById('cowork_reside_place').disabled=true;
				}
			}
			function set_cowork_reside_company() {
				var target = document.getElementById("cowork_reside_place");
				var target_company = document.getElementById("cowork_reside_company");
				//alert(target_company.options[target.selectedIndex].value);
				target_company.options[target.selectedIndex].selected='true';
			}

			// 2019.02.22 손철옥 요구
			// 처리현황이 완료이고 장애장비가 VPN 일때 사용부품, 처리내역 을 입력할 수 있도록 수정
			function menu1() {
				...
				var f = document.frm.company.value;
					...
					if (c == '완료' || c == '대체' || c == '취소')
					  if (e == '원격처리' || e == '방문처리' || e == '기타') {
						if (d=='VPN' || d == '데스크탑' || d == '노트북' || d == 'DTO' || d == 'DTS') {
						document.getElementById('in_menu').style.display = 'none';
						document.getElementById('inst_menu').style.display = 'none';
					...
					if (c == '완료')
						if (e == '신규설치' || e == '신규설치공사' || e == '이전설치' || e == '이전설치공사' || e == '랜공사' || e == '이전랜공사' || e == '장비회수' || e == '예방점검' || e == '야특근') {
						document.getElementById('in_menu').style.display = 'none';
					...
					if (c == '완료' || c == '대체' || c == '취소')
					  if (e == '원격처리' || e == '방문처리' || e == '기타') {
						if (d=='VPN' || d == '통신장비' || d == 'AP' || d == '허브' || d == '라우터' || d == 'TA' || d == '네트웍장비' || d == '회선') {
						document.getElementById('in_menu').style.display = 'none';
						document.getElementById('inst_menu').style.display = 'none';
						document.getElementById('end_keyin1').style.display = '';
						document.getElementById('end_keyin2').style.display = '';
					...
					//2017-09-18 완료 처리시 확인서 필수이면 첨부파일 입력가능하게 처리
					if (c == '완료' && doc_yn=="Y"){
						document.getElementById('att_menu').style.display = '';
					}
				}
	...
	<body onLoad="inview()">
		<div id="wrap">
			...
			<div id="container">
				...
				<form action="as_result_reg_ok1.asp" method="post" enctype="multipart/form-data" name="frm">

				<input name="visit_date_old" type="hidden" value="<%=rs("visit_date")%>">
				<input name="visit_time_old" type="hidden" value="<%=rs("visit_time")%>">
				<input name="emp_saupbu" type="hidden" value="<%=rs_saupbu("emp_saupbu")%>">
				...
				<div class="gView">
					<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						<tbody>
							...
							<tr>
								<th class="first" rowspan="2">장애내용</th>
								<td class="left" colspan="5" rowspan="2">
                                    <textarea name="as_memo" rows="7" id="textarea"><%=rs("as_memo")%></textarea>
                                </td>
                                <th>협업여부 & </br></br>대상 상주처</br>/거래처 지정</th>
                                <td class="left">
                                    <input type="radio" name="cowork_yn" value="N" id="cowork_n" onClick="sel_cowork_reside()" <% if cowork_yn = "N" then %>checked<% end if %>>일반
                                    <input type="radio" name="cowork_yn" value="Y" id="cowork_y" onClick="sel_cowork_reside()" <% if cowork_yn = "Y" then %>checked<% end if %>>협업
                                    <br/><br/>
                                    <%
                                    cowork_reside_company = rs("reside_company")
                                    cowork_reside_place = rs("reside_place")

                                    sql_reside = " SELECT org_reside_company, org_reside_place FROM emp_org_mst"&_
                                                    " WHERE (org_reside_place is not null and org_reside_place <> '')"&_
                                                    " group by org_reside_company, org_reside_place"&_
                                                    " Order By org_reside_company, org_reside_place Asc"

                                    rs_reside.Open sql_reside, Dbconn, 1
                                    %>
                                    <select name="cowork_reside_place" id="cowork_reside_place" onChange="set_cowork_reside_company()">
                                        <option value="전체">전체</option>
                                        <%
                                        While not rs_reside.eof
                                            %>
                                            <option value='<%=rs_reside("org_reside_place")%>' <%If rs_reside("org_reside_place") = cowork_reside_place  then %>selected<% end if %>>
                                            <%=rs_reside("org_reside_place")%>
                                            </option>
                                            <%
          									rs_reside.movenext()
          								Wend
                                    ...
                                    rs_reside.Open sql_reside, Dbconn, 1
                                    %>
                                    <select name="cowork_reside_company" id="cowork_reside_company" onChange="" disabled>
                                        <option value="전체">전체</option>
                                        <%
                                        While not rs_reside.eof
                                            %>
          									<option value='<%=rs_reside("org_reside_company")%>' <%If rs_reside("org_reside_company") = cowork_reside_company  then %>selected<% end if %>>
          										<%=rs_reside("org_reside_company")%></option>
          						            <%
          									rs_reside.movenext()
          								Wend
          								rs_reside.Close()
							...
							<tr>
                                <th style="border-left:1px solid #e3e3e3;">AS표준단가<br>유형</th>
                                <td class="left">

                                <%
								Sql="SELECT max(au_month) as max_au_month FROM as_unitprice_month where  use_yn = 'Y'"
                                set Rs_etc=dbconn.execute(sql)
	                            max_au_month = Rs_etc("max_au_month")
                                rs_etc.Close()

                                Sql="SELECT * FROM as_unitprice_month WHERE au_month = '"&max_au_month&"' and use_yn = 'Y'"
								Rs_etc.Open Sql, Dbconn, 1
							    %>
								<select name="as_unit" id="select">
                                <option value=""></option>
                			    <%
								do until rs_etc.eof
			  				        %>
                					<option value='<%=rs_etc("au_code")%>' <%If rs("as_unit") = rs_etc("au_code") then %>selected<% end if %>><%=rs_etc("au_name")%></option>
                			        <%
									rs_etc.movenext()
								loop
								rs_etc.Close()
                                ...
                                <strong>야간작업</strong> <input type="checkbox" name="night" id="night" value="Y" <% if rs("night") = "Y" then %>checked<% end if %>>
								<strong>주말작업</strong> <input type="checkbox" name="weekend_work" id="weekend_work" value="Y" <% if rs("weekend_work") = "Y" then %>checked<% end if %>>
							...
							<tr>
							  ...
							  <th>처리유형</th>
								<td class="left">
								<% if (as_type = "신규설치" or as_type = "신규설치공사" or as_type = "이전설치" or as_type = "이전설치공사" or as_type = "랜공사" or as_type = "이전랜공사" or as_type = "장비회수" or as_type = "예방점검" or as_type = "야특근") then %>
                ...
                <%   else %>
                  <select name="as_type" id="as_type" style="width:150px" onChange="menu1()">
										<option value="방문처리" <%If as_type = "장애처리" then %>selected<% end if %>>장애처리</option>
										...
										<option value="야특근" <%If as_type = "야특근" then %>selected<% end if %>>야특근</option>
                  ...
                  <input name="as_process_old" type="hidden" id="as_process_old" value="<%=rs("as_process")%>">
							...
							<tr style="display:none" id="end_keyin2">
								...
								<td class="left" colspan="7"><textarea name="as_history" rows="2" id="textarea"><%=rs("as_history")%></textarea></td>
							</tr>
							<tr id="inst_menu" style="display:none">
								<th class="first" colspan="2" style="background:#E1FFE1">설치,이전,공사,회수,예방점검,야특근 수량</th>
