...
year_tab(1,2) = cstr(year_tab(1,1)) + "년"
	...
	If ck_sw = "n" Then
		...
		file_name = pay_company + "_" + pay_yyyy + "_국민연금 표준월액" + give_date
	...
	<body>
		<div id="wrap">			
			...
			<div id="container">
				...
				<form action="insa_pay_year_income_npsup.asp" method="post" name="frm" enctype="multipart/form-data">
				<fieldset class="srch">
					<legend>조회영역</legend>
					<dl>					
						<dt>업로드내용</dt>
					...
					<table cellpadding="0" cellspacing="0" class="tableList">
						...
						<thead>
							<tr>
                                ...
                                <th scope="col">국민연금<br>표준월액</th>
								<th scope="col">국민연금<br>월납부액</th>
...
'	                        incom_retirement_bank = xgr(24,i)
			...
			<% 
				...
				<form action="insa_pay_year_income_npsup_ok.asp" method="post" name="frm1">
					<br>
                    <div align=center>
