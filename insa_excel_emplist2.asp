...
savefilename = "자료 미등록현황 -- "+ condi +""+ view_condi +"" + cstr(curr_date) + ".xls"
...
sql = "select * from emp_master " + where_sql + field_sql + order_sql
...
<table  border="0" cellpadding="0" cellspacing="0">
  <tr bgcolor="#EFEFEF" class="style11">
    <td colspan="13" bgcolor="#FFFFFF"><div align="left" class="style2">&nbsp;<%=now()%> &nbsp;자료 미등록현황>&nbsp;(<%=condi%>)&nbsp;<%=view_condi%></div></td>
  </tr>
  <tr bgcolor="#EFEFEF" class="style11">
