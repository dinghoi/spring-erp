...
'### Request & Params
'===================================================
Dim Page, ck_sw, page_cnt, pg_cnt
Dim be_pg, curr_date, reg_user, mod_user
Dim view_condi, sel_company, sel_bonbu, sel_team
Dim view_tab(4,50), i, j, k
Dim pgsize, stpage, start_page
...
Dim sStr, wStr, oStr
sStr = "SELECT org_name FROM emp_org_mst "
wStr = "WHERE (ISNULL(org_end_date) OR org_end_date = '1900-01-01' OR org_end_date = '0000-00-00') "
oStr = "ORDER BY org_code ASC "
...
If view_condi = "1" Then
	...
	objBuilder.Append sStr
	objBuilder.Append whereStr & "AND org_level = '회사' "
	objBuilder.Append orderbyStr

	rs_tab.Open objBuilder.ToString(), DBConn, 1
	objBuilder.Clear()
	...
	objBuilder.Append sStr
	objBuilder.Append whereStr & "AND org_company = '"&sel_company&"' AND org_level = '본부' "
	objBuilder.Append orderbyStr
	...
	objBuilder.Append sStr
	objBuilder.Append whereStr & "AND org_company = '"&sel_company&"' AND org_level = '팀' "
	objBuilder.Append orderbyStr
	...
	k = 0
	objBuilder.Append sStr
	objBuilder.Append whereStr & "AND org_company = '"&sel_company&"' AND org_level = '상주처' "
	objBuilder.Append orderbyStr
...
Else
	...
	objBuilder.Append sStr
	objBuilder.Append whereStr & "AND org_company = '"&sel_company&"' AND org_bonbu = '"+sel_bonbu+"' AND org_level = '팀' "
	objBuilder.Append orderbyStr
	...
	k = 0
	objBuilder.Append sStr
	objBuilder.Append whereStr & "AND org_company = '"&sel_company&"' AND org_bonbu = '"+sel_bonbu+"' "
	objBuilder.Append whereStr & "AND AND org_team = '"+sel_team+"' AND org_level = '상주처' "
	objBuilder.Append orderbyStr
...
If view_condi = "3" Then
   condi_Sql = " AND (org_company = '"+sel_company+"') AND (org_bonbu = '" + sel_bonbu + "') AND (org_team = '" + sel_team + "')"
End If

If view_condi = "4" Then
   condi_Sql = " AND (org_company = '"+sel_company+"') AND (org_bonbu = '" + sel_bonbu + "') AND (org_team = '" + sel_team + "') AND (org_name = '" + sel_team + "')"
End If
...
<html>
	...
	<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
		<div id="wrap">
			<!--#include virtual = "/include/insa_header_new.asp" -->
			<!--#include virtual = "/include/insa_org_menu_new.asp" -->
			<div id="container">
