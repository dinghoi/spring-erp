...
objBuilder.Append "SELECT emtt.emp_no, emtt.emp_name, emtt.emp_job, emtt.emp_company, emtt.emp_bonbu, "
objBuilder.Append "	emtt.emp_saupbu, emtt.emp_team, emtt.emp_reside_place, emtt.emp_reside_company, "
...
objBuilder.Append "	eomt.org_reside_place, eomt.org_reside_company, eomt.org_code "
...
<html>
	...
	<body oncontextmenu="return false" ondragstart="return false">
		<div id="container">
				...
				<div class="gView">
					<table cellpadding="0" cellspacing="0" class="tableList">
						...
						%>
							<tr>
								<td class="first" colspan="3" style="height:30px;">조회된 내역이 없습니다</td>
							</tr>
                        <%
						End if
						%>
		...
		<input type="hidden" name="mg_level" value="<%=mg_level%>">
