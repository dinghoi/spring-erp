	...
	<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
		<div id="wrap">
			...
			<div id="container">
				...
				<form action="/insa/popup/insa_org_reg_save.asp" method="post" name="frm">
				<div class="gView">
						...
						<tbody>
							...
							%>
                             ...
                             <tr>
                                ...
                                <a href="#" class="btnType03" onClick="pop_Window('/insa/popup/insa_emp_select.asp?gubun=<%="orgemp"%>&view_condi=<%=view_condi%>','orgempselect','scrollbars=yes,width=600,height=400')">조직장찾기</a>
                                </td>
                                <th>조직장성명</th>
                                <td class="left">
							...
							<tr>
                                ...
                                <a href="#" class="btnType03" onClick="pop_Window('/insa/insa_org_select.asp?gubun=<%="owner"%>&mg_level=<%=org_level%>&view_condi=<%=view_condi%>','orgselect','scrollbars=yes,width=850,height=400')">상위조직찾기</a>
                                </td>
                                <th>상위조직명</th>
                                <td class="left">
