...
'### Request & Params
'===================================================
Dim u_type, edu_empno, edu_seq, emp_name
Dim edu_name, edu_office, edu_finish_no, edu_start_date
Dim edu_end_date, edu_apy, edu_comment, edu_reg_date, edu_pay
Dim title_line, rsEdu
...
If u_type = "U" Then
	objBuilder.Append "SELECT edu_empno, edu_seq, edu_name, edu_office, edu_finish_no, "
	objBuilder.Append "	edu_start_date, edu_end_date, edu_pay, edu_comment, edu_reg_date "
...
<html>
	...
	<body>
		<div id="container">
			...
			<form action="/insa/insa_edu_add_save.asp" method="post" name="frm">
