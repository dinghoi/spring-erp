...
Dim family_live, family_person1, family_person2, family_tel_ddd, family_tel_no1
Dim family_tel_no2, family_support_yn, family_national, family_disab, family_merit
Dim family_serius, family_pensioner, family_witak, family_holt, family_holt_date, family_children
Dim title_line, rsFamily
...
//					return false;}
	...
	<body>
		<div id="container">
			...
			<form action="/insa/insa_family_add_save.asp" method="post" name="frm">
				...
				<div class="gView">
					...
					<tr>
						...
						<td class="left" bgcolor="#FFFFE6">
							<input type="text" name="family_empno" id="family_empno" size="14" value="<%=family_empno%>" class="no-input" readonly/>
						</td>
					...
					<tr>
					  ...
					  &nbsp;<span style="font-size:11px;color:red;">위탁아동인경우는 기타관계를 선택하세요.</span>
					  </td>
					</tr>
					<tr>
						<th>성명<span style="color:red;">*</span></th>
						<td colspan="2" class="left">
							<input type="text" name="family_name" id="family_name" size="14" value="<%=family_name%>"/>
						</td>
						<th>출생지</th>
						<td colspan="2" class="left">
					...
					<tr>
						...
						<td colspan="2" class="left">
							<input name="family_birthday" type="text" value="<%=family_birthday%>" style="width:70px;text-align:center;" id="datepicker" readonly/>
							&nbsp;&nbsp;
						...
						<th>주민등록번호</th>
						<td colspan="2" class="left">
							<input name="family_person1" type="text" id="family_person1" style="width:40px;" maxlength="6" value="<%=family_person1%>" oninput="this.value=this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"/>
							-
							<input name="family_person2" type="text" id="family_person2" style="width:50px;" maxlength="7" value="<%=family_person2%>" oninput="this.value=this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"/>
							&nbsp;(연말정산필수)
						</td>
				   </tr>
				   <tr>
						...
						<td colspan="2" class="left">
							<input name="family_tel_ddd" type="text" id="family_tel_ddd" size="3" maxlength="3" value="<%=family_tel_ddd%>" oninput="this.value=this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"/>
							-
							<input name="family_tel_no1" type="text" id="family_tel_no1" size="4" maxlength="4" value="<%=family_tel_no1%>" oninput="this.value=this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"/>
							-
							<input name="family_tel_no2" type="text" id="family_tel_no2" size="4" maxlength="4" value="<%=family_tel_no2%>" oninput="this.value=this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"/>
						</td>
					</tr>
					<tr>
						<th>동거여부</th>
					...
					<tr>
						...
						<th>입양일자</th>
						<td class="left">
							<input name="family_holt_date" type="text" value="<%=family_holt_date%>" style="width:70px;text-align:center;" id="datepicker1" readonly/>
						</td>
						<th>위탁아동</th>
						<td class="left">
