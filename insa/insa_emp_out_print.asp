...
'### Request & Params
'===================================================
Dim from_date, to_date, view_condi, main_title, rs_emp
Dim sql_where
...
main_title = from_date&" ∼ "&to_date&" 퇴직자 현황"
...
objBuilder.Append "SELECT emtt.emp_no, emtt.emp_name, emtt.emp_birthday, emtt.emp_grade, emtt.emp_in_date, "
objBuilder.Append "	emtt.emp_end_date, emtt.emp_last_edu, emtt.emp_disabled, emtt.emp_disab_grade, "
objBuilder.Append "	emtt.emp_reside_company, emtt.emp_org_baldate, emtt.emp_grade_date, "
objBuilder.Append "	emtt.emp_position, eomt.org_name, eomt.org_code "
'objBuilder.Append "	eomt.org_company, eomt.org_bonbu, eomt.org_team "
objBuilder.Append "FROM emp_master AS emtt "
objBuilder.Append "INNER JOIN emp_org_mst AS eomt ON emtt.emp_org_code = eomt.org_code "
objBuilder.Append "WHERE (emp_end_date >= '"&from_date&"' AND emp_end_date <= '"&to_date&"') "
	...
	<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
		...
		<table width="1020" border="1" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td width="6%" height="30" align="center" bgcolor="#BFBFFF"><span class="style12C">퇴직일</span></td>
			...
			<tr>
				...
				<td width="6%" height="30" align="center">
					<span class="style12C"><%=rs_emp("emp_end_date")%></span>
				</td>
