...
if u_type = "U" then
	...
	objBuilder.Append "SELECT emtt.emp_name, emtt.emp_ename, emtt.emp_type, emtt.emp_sex, emtt.emp_person1, "
	objBuilder.Append "	emtt.emp_person2, emtt.emp_image, emtt.emp_first_date, emtt.emp_in_date, "
	objBuilder.Append "	emtt.emp_gunsok_date, emtt.emp_yuncha_date, emtt.emp_end_gisan, emtt.emp_end_date, "
	objBuilder.Append "	emtt.emp_company, emtt.emp_bonbu, emtt.emp_saupbu, emtt.emp_team, emtt.emp_org_code, "
	objBuilder.Append "	emtt.emp_org_name, emtt.emp_org_baldate, emtt.emp_stay_code, emtt.emp_stay_name, "
	objBuilder.Append "	emtt.emp_reside_place, emtt.emp_reside_company, emtt.emp_grade, emtt.emp_grade_date, "
	objBuilder.Append "	emtt.emp_job, emtt.emp_position, emtt.emp_jikgun, emtt.emp_jikmu, emtt.emp_birthday, "
	objBuilder.Append "	emtt.emp_birthday_id, emtt.emp_family_zip, emtt.emp_family_sido, emtt.emp_family_gugun, "
	objBuilder.Append "	emtt.emp_family_dong, emtt.emp_family_addr, emtt.emp_zipcode, emtt.emp_sido, emtt.emp_gugun, "
	objBuilder.Append "	emtt.emp_dong, emtt.emp_addr, emtt.emp_tel_ddd, emtt.emp_tel_no1, emtt.emp_tel_no2, "
	objBuilder.Append "	emtt.emp_hp_ddd, emtt.emp_hp_no1, emtt.emp_hp_no2, emtt.emp_email, emtt.emp_military_id, "
	objBuilder.Append "	emtt.emp_military_date1, emtt.emp_military_date2, emtt.emp_military_grade, "
	objBuilder.Append "	emtt.emp_military_comm, emtt.emp_hobby, emtt.emp_faith, emtt.emp_last_edu, "
	objBuilder.Append "	emtt.emp_marry_date, emtt.emp_disabled, emtt.emp_disab_grade, emtt.emp_sawo_id, "
	objBuilder.Append "	emtt.emp_sawo_date, emtt.emp_emergency_tel, emtt.emp_nation_code, emtt.cost_center, "
 ...
 '   emp_image = rs_emp("emp_image")
    ...
    emp_reside_place = rs_emp("org_reside_place")
	emp_reside_company = rs_emp("org_reside_company")
	...
	<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
		<div id="wrap">
			...
			<div id="container">
				...
				<form action="/insa/insa_appoint_add_save.asp" method="post" name="frm">
				<div class="gView">
						...
						<tbody>
                           ...
                           <tr>
                            ...
                            <tr style="display:none;" id="mv_menu2">
                                ...
                                <a href="#" class="btnType03" onClick="pop_Window('/insa/insa_org_select.asp?gubun=<%="apporg"%>&view_condi=<%=emp_company%>','orgselect','scrollbars=yes,width=800,height=400')">선택</a>
                                </td>
