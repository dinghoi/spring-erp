...
'### Request & Params
'===================================================
Dim curr_date, curr_hh, curr_mm, u_type, view_condi, emp_disabled
Dim emp_pay_id, title_line, emp_first_date, emp_in_date, emp_gunsok_date
Dim emp_yuncha_date, emp_end_date, emp_end_gisan, emp_birthday, emp_sawo_date
Dim emp_marry_date, emp_military_date1, emp_military_date2, photo_image
Dim emp_reg_user, emp_mod_user, emp_name, emp_ename, emp_type, emp_sex, emp_person1, emp_person2
Dim emp_image, emp_bonbu, emp_saupbu, emp_team, emp_org_code, emp_org_name, emp_org_baldate
Dim emp_stay_code, emp_stay_name, emp_reside_place, emp_reside_company, emp_grade, emp_grade_date
Dim emp_job, emp_position, emp_jikgun, emp_jikmu, emp_birthday_id, emp_family_zip, emp_family_sido
Dim emp_family_gugun, emp_family_dong, emp_family_addr, emp_zipcode, emp_sido, emp_gugun, emp_dong
Dim emp_addr, emp_tel_ddd, emp_tel_no1, emp_tel_no2, emp_hp_ddd, emp_hp_no1, emp_hp_no2, emp_email
Dim emp_military_id, emp_military_grade, emp_military_comm, emp_hobby, emp_faith, emp_last_edu
Dim emp_disab_grade, emp_sawo_id, emp_emergency_tel, emp_extension_no, emp_nation_code, cost_center
Dim cost_group, att_file, emp_reg_date, in_name, emp_mod_date
Dim rs_max, max_seq, rsEmp, dz_id
...
If u_type = "U" Then
	objBuilder.Append "SELECT emp_name, emp_ename, emp_type, emp_sex, emp_person1, emp_person2, "
	objBuilder.Append "	emp_image, emp_first_date, emp_in_date, emp_gunsok_date, emp_yuncha_date, "
	objBuilder.Append "	emp_end_gisan, emp_end_date, emtt.emp_company, emp_bonbu, emp_saupbu, emp_team, "
	objBuilder.Append "	emp_org_code, emp_org_name, emp_org_baldate, emp_stay_code, emp_stay_name, "
	objBuilder.Append "	emp_reside_place, emp_reside_company, emp_grade, emp_grade_date, emp_job, "
	objBuilder.Append "	emp_position, emp_jikgun, emp_jikmu, emp_birthday, emp_birthday_id, emp_family_zip, "
	objBuilder.Append "	emp_family_sido, emp_family_gugun, emp_family_dong, emp_family_addr, emp_zipcode, "
	objBuilder.Append "	emp_sido, emp_gugun, emp_dong, emp_addr, emp_tel_ddd, emp_tel_no1, emp_tel_no2, "
	objBuilder.Append "	emp_hp_ddd, emp_hp_no1, emp_hp_no2, emp_email, emp_military_id, emp_military_date1, "
	objBuilder.Append "	emp_military_date2, emp_military_grade, emp_military_comm, emp_hobby, emp_faith, "
	objBuilder.Append "	emp_last_edu, emp_marry_date, emp_disabled, emp_disab_grade, emp_sawo_id, emp_sawo_date, "
	objBuilder.Append "	emp_emergency_tel, emp_nation_code, emp_pay_id, emp_extension_no, cost_center, "
	objBuilder.Append "	cost_group, emp_reg_date, emp_reg_user, emp_mod_date, emp_mod_user, emp_image, "
	objBuilder.Append "	IF(memt.mg_group = '', '1', memt.mg_group) AS 'mg_group', dpit.dz_id "
	...
	<head>
		...
		<script type="text/javascript">
			...
			function chkfrm(){
				...
				if(document.frm.emp_military_id.value !== "" && $('#emp_military_id').val() !== '면제'){
					...
					<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						<tbody>
							<tr>
								...
								<th>사원 번호<%If u_type <> "U" Then%><span style="color:red;">*</span><%End If%></th>
								<td class="left">
									<input type="text" name="emp_no" id="emp_no" value="<%=emp_no%>" style="width:50px;" oninput="this.value=this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" <%If u_type = "U" Then%> class="no-input" readonly<%End If%>/>
								</td>
								<th>성명(한글)<span style="color:red;">*</span></th>
								<td class="left">
									<input type="text" name="emp_name" id="emp_name" size="9" value="<%=emp_name%>"/>
								</td>
								...
								<td colspan="2" class="left">
									<input type="text" name="emp_birthday" id="datepicker5" style="width:70px;" value="<%=emp_birthday%>" readonly/>
									&nbsp;―&nbsp;
							...
							<%
							'해당 변수로 사용되는 데이터 값(혹은 항목)이 없음[허정호_20220119]
							Dim mg_org, emp_org_level
							%>
							<tr>
								<th>소속<span style="color:red;">*</span></th>
								<td colspan="3" class="left">
									<input type="text" name="emp_org_code" id="emp_org_code" style="width:40px" readonly="true" value="<%=emp_org_code%>"/>
									&nbsp;―&nbsp;
									<input type="text" name="emp_org_name" id="emp_org_name" style="width:120px" readonly="true" value="<%=emp_org_name%>"/>
								...
								<td colspan="5" class="left">
									<input type="text" name="emp_company" id="emp_company" style="width:100px" readonly="true" value="<%=emp_company%>"/>
									<input type="text" name="emp_bonbu" id="emp_bonbu" style="width:120px" readonly="true" value="<%=emp_bonbu%>"/>
									<input type="text" name="emp_saupbu" id="emp_saupbu" style="width:120px" readonly="true" value="<%=emp_saupbu%>"/>
									<input type="text" name="emp_team" id="emp_team" style="width:120px" readonly="true" value="<%=emp_team%>"/>
									<input type="hidden" name="emp_reside_place" id="emp_reside_place" style="width:120px" readonly="true" value="<%=emp_reside_place%>"/>
									<input type="hidden" name="emp_org_level" id="emp_org_level" style="width:120px" readonly="true" value="<%=emp_org_level%>"/>
								</td>
							</tr>
							<%
							Dim rsGrade, rsJob, rsPosition, rsJikmu, rsDisabled, rsMilitaryId, rsMilitaryGrade, rsCostCenter
							%>
            				<tr>
							...
							<tr>
								...
								<td class="left">
									<input type="text" name="emp_first_date" size="10" id="datepicker" style="width:70px;" value="<%=emp_first_date%>" readonly="true"/>
								</td>
								<th>입사일<span style="color:red;">*</span></th>
								<td class="left">
									<input type="text" name="emp_in_date" size="10" id="datepicker1" style="width:70px;" value="<%=emp_in_date%>" readonly="true"/>
								</td>
								<th>퇴직기산일<span style="color:red;">*</span></th>
								<td class="left">
									<input type="text" name="emp_end_gisan" size="10" id="datepicker2" style="width:70px;" value="<%=emp_end_gisan%>" readonly="true"/>
								</td>
								<th>근속기산일<span style="color:red;">*</span></th>
								<td class="left">
									<input type="text" name="emp_gunsok_date" size="10" id="datepicker3" style="width:70px;" value="<%=emp_gunsok_date%>" readonly="true"/>
								</td>
								<th>연차기산일<span style="color:red;">*</span></th>
								<td class="left">
									<input type="text" name="emp_yuncha_date" size="10" id="datepicker4" style="width:70px;" value="<%=emp_yuncha_date%>" readonly="true"/>
								</td>
							</tr>
							<tr>
								...
								<td colspan="2" class="left">
									...
									<select name="emp_sex" id="emp_sex" value="<%=emp_sex%>" style="width:55px">
			            				<option value="" <%If emp_sex = "" Then %>selected<%End If %>>성별</option>
							...
							<tr>
								...
								<td colspan="7" class="left">
									<input type="text" name="emp_zipcode" style="width:50px;" id="emp_zipcode" value="<%=emp_zipcode%>" readonly/>
									&nbsp;-&nbsp;
									<input type="text" name="emp_sido" id="emp_sido" style="width:70px;" readonly="true" value="<%=emp_sido%>"/>
									<input type="text" name="emp_gugun" id="emp_gugun" style="width:80px;" readonly="true" value="<%=emp_gugun%>"/>
									<input type="text" name="emp_dong" id="emp_dong" style="width:100px;" readonly="true" value="<%=emp_dong%>"/>
									<input type="text" name="emp_addr" id="emp_addr" style="width:250px;" value="<%=emp_addr%>"/>
							...
							<tr>
								...
								<th>결혼기념일</th>
								<td class="left">
									<input type="text" name="emp_marry_date" size="10" id="datepicker7" style="width:70px;" value="<%=emp_marry_date%>" readonly="true"/>
								</td>
								<th>취미</th>
								<td class="left">
								...
								Set rsDisabled = DBConn.Execute(objBuilder.ToString())
								objBuilder.Clear()
							  	%>
									<select name="emp_disabled" id="emp_disabled" style="width:100px;">
                  						<option value="" <%If emp_disabled = "" Then %>selected<%End If %>>선택</option>
                				<%
								Do Until rsDisabled.EOF
			  				  	%>
                						<option value='<%=rsDisabled("emp_etc_name")%>' <%If emp_disabled = rsDisabled("emp_etc_name") Then %>selected<%End If %>><%=rsDisabled("emp_etc_name")%></option>
                				<%
									rsDisabled.MoveNext()
								Loop
								rsDisabled.Close() : Set rsDisabled = Nothing
							  	%>
            						</select>
									-
								...
								<th>비상연락</th>
								<td class="left">
									<input type="text" name="emp_emergency_tel" id="emp_emergency_tel" style="width:90px;" value="<%=emp_emergency_tel%>" oninput="this.value=this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"/>
								</td>
							</tr>
							<tr>
								...
								<th>병역 복무기간</th>
								<td colspan="2" class="left">
									<input type="text" name="emp_military_date1" size="10" id="datepicker8" style="width:70px;" value="<%=emp_military_date1%>" readonly="true"/>
									∼
									<input type="text" name="emp_military_date2" size="10" id="datepicker9" style="width:70px;" value="<%=emp_military_date2%>" readonly="true"/>
								</td>
								<th>면제사유</th>
								<td class="left">
							...
							<tr>
								...
								<td colspan="2" class="left">
									<input type="text" name="emp_stay_name" id="emp_stay_name" style="width:90px;" value="<%=emp_stay_name%>"/>
								...
								If emp_stay_code <> "" Then
									objBuilder.Append "SELECT stay_name, stay_sido, stay_dong, stay_gugun, stay_addr "
								...
								End If
								%>
									<input type="text" name="emp_stay_code" id="emp_stay_code" size="4" readonly="true" value="<%=emp_stay_code%>"/>
									-
									<input type="text" name="stay_sido" id="stay_sido" style="width:70px" readonly="true" value="<%=stay_sido%>"/>
									<input type="text" name="stay_gugun" id="stay_gugun" style="width:80px" readonly="true" value="<%=stay_gugun%>"/>
									<input type="text" name="stay_dong" id="stay_dong" style="width:100px" readonly="true" value="<%=stay_dong%>"/>
									<input type="text" name="stay_addr" id="stay_addr" style="width:255px" readonly="true" value="<%=stay_addr%>"/>
								</td>
								<th>비용그룹</th>
								<td class="left">
                					<input type="text" name="cost_group" id="cost_group" style="width:90px" readonly="true" value="<%=cost_group%>"/>
            					</td>
							</tr>
							<tr>
								<th colspan="2" class="first">내선번호</th>
								<td class="left">
									<input type="text" name="emp_extension_no" id="emp_extension_no" style="width:80px;" value="<%=emp_extension_no%>" oninput="this.value=this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"/>
								</td>
								<th>최종학력</th>
								<td class="left">
								...
								<th>상주처 회사</th>
								<td colspan="2" class="left">
									<input name="emp_reside_company" type="text" id="emp_reside_company" style="width:100px;" value="<%=emp_reside_company%>"/>
								...
								<th>한진그룹여부</th>
								<td colspan="2" class="left">
									<input type="radio" name="mg_group" value="1" <%If mg_group = "1" Then %>checked<%End If %>/>일반
									<input type="radio" name="mg_group" value="2" <%If mg_group = "2" Then %>checked<%End If %>/>한진
								</td>
							</tr>
							<tr>
								<th colspan="2" class="first">등록일자</th>
								...
								<td class="left">
                					<input type="text" name="dz_id" id="dz_id" style="width:90px;" value="<%=dz_id%>" oninput="this.value=this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"/>
            					</td>
							</tr>
						</tbody>
					</table>
					<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						<tbody>
							<tr>
								...
								<td class="left">
									<input type="file" name= "att_file"  size="70" accept="image/gif"/><span style="font-size:11px;color:red;">* 첨부파일은 1개까지 가능하며 최대용량은 2MB입니다.</span>
								</td>
							</tr>
						</tbody>
					</table>
