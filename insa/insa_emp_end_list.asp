						...
						Do Until rsEndMem.EOF
	           			...
	           			%>
							<tr>
                                ...
                                <td>
									<a href="#" onClick="pop_Window('/insa/insa_card00.asp?emp_no=<%=rsEndMem("emp_no")%>','인사 기록 카드','scrollbars=yes,width=1250,height=670')"><%=rsEndMem("emp_name")%></a>
								</td>
                                ...
                                <td>
									<a href="#" onClick="pop_Window('/insa/insa_emp_master_view.asp?view_condi=<%=rsEndMem("emp_company")%>&emp_no=<%=rsEndMem("emp_no")%>','insa_emp_modify_popup','scrollbars=yes,width=1250,height=480')">조회</a>
								</td>
                                <td colspan="2">&nbsp;</td>
							</tr>
						<%
