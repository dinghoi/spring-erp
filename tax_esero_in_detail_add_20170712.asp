				  ...
				  <table cellpadding="0" cellspacing="0" class="tableWrite">
				    ...
				    <tbody>
				      <tr>
				        ...
				        <th>공급받는회사</th>
				        <td class="left"><%=rs("owner_company")%></td>
			          </tr>
				      <tr>
				        <th class="first">사용조직</th>
				        <td class="left">
					<% if cost_grade = "0" or saupbu = "경영지원실" or team = "SM1팀" or team = "SM2팀" or team = "Repair팀" or user_name = "정호연" then	%>
                        <input name="org_name" type="text" readonly="true" value="<%=org_name%>" style="width:150px">
                        <a href="#" onClick="pop_Window('org_search.asp?gubun=<%="계산서"%>&org_company=<%=rs("owner_company")%>','org_search_pop','scrollbars=yes,width=600,height=400')" class="btnType03">조회</a>
					<%   else	%>
                    	<%=org_name%>
