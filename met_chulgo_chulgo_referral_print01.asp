...
<table width="715" cellpadding="0" cellspacing="0">
  <tr>
    <td rowspan="4" width="4%" height="20" align="center" style="border-bottom:1px solid #000000; border-top:1px solid #000000; border-right:1px solid #000000; border-left:1px solid #000000;"><span class="style1">출<br>고<br>부<br>서</span></td>
    ...
    <td rowspan="4" width="4%" height="20" align="center" style="border-bottom:1px solid #000000; border-top:1px solid #000000; border-right:1px solid #000000; border-left:1px solid #000000;"><span class="style1">의<br>뢰<br>부<br>서</span></td>
    <td width="10%" height="20" align="center" style="border-bottom:1px solid #000000; border-top:1px solid #000000; border-right:1px solid #000000;"><span class="style1">담 당</span></td>
    <td width="10%" height="20" align="center" style="border-bottom:1px solid #000000; border-top:1px solid #000000; border-right:1px solid #000000;"><span class="style1">팀 장</span></td>
...
<table width="690" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="100%" height="20" align="left"><span class="style1"><span>&nbsp;출고일자 :&nbsp;<%=mid(cstr(chulgo_date),1,4)%>년&nbsp;<%=mid(cstr(chulgo_date),6,2)%>월&nbsp;<%=mid(cstr(chulgo_date),9,2)%>일</span></td>
  </tr>  
</table>
  ...
  <tr>
    <td style="border-bottom:none; border-top:none;">
     <table width="680" border="1px" cellpadding="0" cellspacing="0">
      <tr>  
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">출고번호</span></td>
        <td width="*" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=rele_no%>&nbsp;<%=rele_seq%></strong></td>
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">출고담당</span></td>
        <td width="20%" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=chulgo_emp_name%>(<%=chulgo_emp_no%>)</strong></td>
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">출고창고</span></td>
        <td width="20%" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=chulgo_stock_name%></strong></td>
      </tr>
      <tr>  
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">출고유형</span></td>
        <td width="*" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=chulgo_id%></strong></td>
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">용도구분</span></td>
        <td width="20%" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=chulgo_goods_type%></strong></td>
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">요청그룹사</span></td>
        <td width="20%" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=rele_company%></strong></td>
      </tr>
      <tr>  
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">요청사업부</span></td>
        <td width="*" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=rele_saupbu%></strong></td>
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">요청창고</span></td>
        <td width="20%" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=rele_stock_name%></strong></td>
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">요청담당</span></td>
        <td width="20%" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=rele_emp_name%></strong></td>
      </tr>
      <tr>  
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">비고</span></td>
        <td colspan="5" width="20%" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=chulgo_memo%></strong></td>
      </tr>
    </table>
   </td>
  </tr>  
  <tr>
    <td class="style4" style="border-bottom:none; border-top:none;"><strong>❐ 본사출고 출고품목 내역</strong></td>
  </tr>
  <tr>
    <td style="border-bottom:none; border-top:none;"><table width="680" border="1px" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="10%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">용도</strong></td>
        <td width="14%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">품목구분</strong></td>
        <td width="14%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">품목코드</strong></td>
        <td width="*" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">품목명</strong></td>
        <td width="20%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">규격</strong></td>
        <td width="8%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">출고수량</strong></td>
        <td width="8%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">확인</strong></td>
      </tr>
   <%  g_seq = 0
   ...
   %>
      <tr>
        ...
        <td width="10%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("cg_goods_type")%></span></td>
        <td width="14%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("cg_goods_gubun")%></span></td>
        <td width="14%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("cg_goods_code")%></span></td>
        <td width="*" height="20" align="left" valign="middle"><span class="style1"><span>&nbsp;<%=rs("cg_goods_name")%></span></td>
        <td width="20%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("cg_standard")%></span></td>
