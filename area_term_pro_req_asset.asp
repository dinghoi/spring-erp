...
dim mi_tab(8)
dim mi_in
com_tab = array("서울","경기","부산","대구","인천","광주","대전","울산","강원","경남","경북","충남","충북","전남","전북","제주")
...
title_line = "지역별 처리 기간별 현황(요청일 기준)"
%>
	...
	<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
		<div id="wrap">			
			...
			<div id="container">
				...
				<form action="waiting.asp?pg_name=area_term_pro_req_asset.asp" method="post" name="frm">
				<fieldset class="srch">
					<legend>조회영역</legend>
					<dl>					
						<dt>조건 검색</dt>
