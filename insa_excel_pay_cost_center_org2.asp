  ...
  <tr>
    ...
    <%
       do until rs.eof
          ...
          if rs("ps_saupbu") = "" or isnull(rs("ps_saupbu")) then
		          ps_saupbu = ""
			 else
			      ps_saupbu = rs("ps_saupbu")
		  end if
		  if rs("ps_cost_group") = "" or isnull(rs("ps_cost_group")) then
		          ps_cost_group = ""
			 else
			      ps_cost_group = rs("ps_cost_group")
		  end if
		  
		  if f_sw = "1" then
		        bigo_org = ps_saupbu
				bigo_cost_group = ps_cost_group
				f_sw = "2"
		  end if
          
          pmg_base_pay = int(rs("ps_base_pay"))
          pmg_meals_pay = int(rs("ps_meals_pay"))
       	  pmg_postage_pay = int(rs("ps_postage_pay"))
	      pmg_re_pay = int(rs("ps_re_pay"))
	      pmg_overtime_pay = int(rs("ps_overtime_pay"))
	      pmg_car_pay = int(rs("ps_car_pay"))
	      pmg_position_pay = int(rs("ps_position_pay"))
	      pmg_custom_pay = int(rs("ps_custom_pay"))
	      pmg_job_pay = int(rs("ps_job_pay"))
	      pmg_job_support = int(rs("ps_job_support"))
	      pmg_jisa_pay = int(rs("ps_jisa_pay"))
	      pmg_long_pay = int(rs("ps_long_pay"))
	      pmg_disabled_pay = int(rs("ps_disabled_pay"))
		  pmg_give_total = int(rs("ps_give_total"))
		
		  if reside_sw = "1" then
		    if ps_cost_group = "" then
		      if bigo_org <> ps_saupbu then
	 %>
  ...
  <tr valign="middle" class="style11">
    ...
    <td width="100" style="background:#E0FFFF;"><div align="right" class="style1"><%=formatnumber(sap_give_tot,0)%></div></td>
     ...
     <%	     
		  ...
		  if bigo_cost_group <> ps_cost_group then
	 %>
  <tr valign="middle" class="style11">
    <td colspan="4" style="background:#E0FFFF;"><div align="center" class="style1"><%=bigo_cost_group%></div></td>
	...
	%>
  <tr valign="middle" class="style11">
    <td width="140"><div align="center" class="style1"><%=f_yymm%> ∼ <%=t_yymm%></div></td>
    <td width="120"><div align="center" class="style1"><%=rs("ps_emp_name")%></div></td>
    <td width="120"><div align="center" class="style1"><%=rs("ps_emp_no")%></div></td>
    <td width="120"><div align="center" class="style1"><%=rs("ps_company")%></div></td>
    <td width="120"><div align="center" class="style1"><%=rs("ps_saupbu")%></div></td>
    <td width="120"><div align="center" class="style1"><%=rs("ps_org_name")%></div></td>
    <td width="120"><div align="center" class="style1"><%=rs("ps_grade")%></div></td>
    <td width="120"><div align="center" class="style1"><%=rs("ps_cost_center")%></div></td>
