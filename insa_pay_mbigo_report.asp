...
be_pg = "insa_pay_mbigo_report.asp"
	...
	<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
		<div id="wrap">			
			...
			<div id="container">
				...
				<form action="insa_pay_mbigo_report.asp?ck_sw=<%="n"%>" method="post" name="frm">
				<fieldset class="srch">
					<legend>조회영역</legend>
					<dl>					
						<dt>◈ 검색◈</dt>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
				  <tr>
                    <td width="25%">
					<div class="btnleft">
                    <a href="insa_pay_mbigo_excel.asp?view_condi=<%=view_condi%>&pmg_yymm=<%=pmg_yymm%>&to_date=<%=to_date%>" class="btnType04">엑셀다운로드</a>
					</div>                  
                    </td>
                    <td width="50%">
                    </td>
				    <td width="25%">
					<div class="btnRight">
					<a href="#" onClick="pop_Window('insa_pay_mbigo_print.asp?view_condi=<%=view_condi%>&pmg_yymm=<%=pmg_yymm%>&to_date=<%=to_date%>','insa_pay_mbigo_pop','scrollbars=yes,width=1060,height=700')" class="btnType04">전월비교분석 출력</a>
					</div>                  
                    </td> 
			      </tr>
				  </table>
