...
'### Request & Params
'===================================================
Dim u_type, career_empno, career_seq, emp_name, career_join_date, career_end_date
Dim career_office, career_dept, career_position, career_task, curr_date, title_line
Dim rsCrr
...
If u_type = "U" Then
	...
	career_empno = rsCrr("career_empno")
	career_seq = rsCrr("career_seq")
	career_join_date = rsCrr("career_join_date")
	career_end_date = rsCrr("career_end_date")
	career_office = rsCrr("career_office")
	career_dept = rsCrr("career_dept")
	career_position = rsCrr("career_position")
	career_task = rsCrr("career_task")
...
<html>
	...
	<body>
		<div id="container">
			...
			<form action="/person/insa_career_add_save.asp" method="post" name="frm">
			<div class="gView">
