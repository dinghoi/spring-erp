...
Dim family_person1, family_person2, family_tel_ddd, family_tel_no1, family_tel_no2
Dim family_support_yn, family_national, family_witak, family_holt, family_holt_date
Dim family_pensioner, family_serius, family_merit, family_disab, family_children
Dim end_msg, rsMax, max_seq
...
If u_type = "U" Then
	...
	objBuilder.Append "	family_rel='"&family_rel&"',family_name='"&family_name&"',family_birthday='"&family_birthday&"',family_birthday_id='"&family_birthday_id&"',"
	objBuilder.Append "	family_job='"&family_job&"',family_live='"&family_live&"',family_support_yn='"&family_support_yn&"',family_person1='"&family_person1&"',"
	objBuilder.Append "	family_person2='"&family_person2&"',family_tel_ddd='"&family_tel_ddd&"',family_tel_no1='"&family_tel_no1&"',family_tel_no2='"&family_tel_no2&"',"
	objBuilder.Append "	family_national='"&family_national&"',family_witak='"&family_witak&"',family_holt='"&family_holt&"',family_holt_date='"&family_holt_date&"',"
	objBuilder.Append "	family_pensioner='"&family_pensioner&"',family_serius='"&family_serius&"',family_merit='"&family_merit&"',family_disab='"&family_disab&"',"
	objBuilder.Append "	family_children='"&family_children&"',family_mod_date= NOW(),family_mod_user='"&user_name&"' "
