...
'### Request & Params
'===================================================
Dim u_type, lang_seq, lang_empno, lang_id, lang_id_type
...
Else
	objBuilder.Append "SELECT MAX(lang_seq) AS 'max_seq' FROM emp_language "
	objBuilder.Append "WHERE lang_empno = '"&lang_empno&"';"
	...
	objBuilder.Append "'"&lang_empno&"','"&lang_seq&"','"&lang_id&"','"&lang_id_type&"','"&lang_point&"',"
