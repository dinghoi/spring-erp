	...
	<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
		<div id="wrap">			
			...
			<div id="container">
				...
				<form action="insa_org_owner_modify_save.asp" method="post" name="frm">
				<div class="gView">
					<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						<tbody>
							...
							<tr>
                                ...
                                <a href="#" class="btnType03" onClick="pop_Window('insa_org_select.asp?gubun=<%="owner2"%>&mg_level=<%=org_level%>&view_condi=<%=view_condi%>','orgselect','scrollbars=yes,width=850,height=400')">상위조직찾기</a>
                                </td>
                                <th>상위조직명</th>
                                <td class="left">
                             ...
                             <tr>
                              ...
                              <tr>
                                ...
                                <td class="left">
                                <input name="org_owner_date" type="text" size="10" readonly="true" id="datepicker" style="width:70px;" value="<%=org_owner_date%>" >
              					</td>
                                <th>적정인원(T.O)</th>
								<td colspan="3" class="left">
