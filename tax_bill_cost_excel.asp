...
savefilename = from_date + "~" + to_date + " " + slip_gubun + " 세금계산서 내역.xls"
...
if slip_gubun = "자재" then
	slip_sql = " and (slip_gubun = '자재' or slip_gubun = '장비') "
  else
  	slip_sql = " and (slip_gubun = '"&slip_gubun&"')"
end if

' 조건별 조회.........
sql = "select * from general_cost where tax_bill_yn = 'Y' and (slip_date >= '"&from_date&"' and slip_date <= '"&to_date&"')"&slip_sql&" ORDER BY customer, slip_date ASC"
