...
-->
    ...
    <object id="factory" style="display:none;" viewastext classid="clsid:1663ed61-23eb-11d2-b92f-008048fdd814" codebase="/smsx.cab#Version=7.0.0.8">
		...
		<div id="wrap">			
			<div id="container">
				<form action="met_goods_jaego_print.asp" method="post" name="frm">
				<div class="gView">
                ...
                <table width="1150" border="1px" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tablePrt">
						<colgroup>
						 ...
						 <thead>
                              <tr bgcolor="#f8f8f8">
				                <th height="30" class="first" align="center" scope="col" class="style14C">코드</th>
				                <th scope="col" align="center" class="style14C">품목구분</th>
                                <th scope="col" align="center" class="style14C">품목명</th>
                                <th scope="col" align="center" class="style14C">규격</th>
                                <th scope="col" align="center" class="style14C">상태</th>
				                <th scope="col" align="center" class="style14C">창고</th>
                                <th scope="col" align="center" class="style14C">전년이월</th>
                                <th scope="col" align="center" class="style14C">입고</th>
                                <th scope="col" align="center" class="style14C">출고</th>
                                <th scope="col" align="center" class="style14C">현재고</th>
