...
if u_type = "U" then
	...
	emp_company = rs("buy_company")
	emp_saupbu = rs("buy_saupbu")
	emp_org_code = rs("buy_org_code")
	emp_org_name = rs("buy_org_name")
	emp_no = rs("buy_emp_no")
	emp_name = rs("buy_emp_name")
	emp_bonbu = ""
	emp_team = ""
	...
	<body onload="pummok_list_view();">
		<div id="container">				
			<div class="gView">
                ...
                <form method="post" name="frm" action="met_buy_modify_save.asp" enctype="multipart/form-data">
                    <table cellpadding="0" cellspacing="0" summary="" class="tableWrite">
						...
						<tbody>
                            ...
                            %>
							  ...
							  <th>구매담장자</th>
							  <td class="left"><%=emp_name%>(<%=emp_no%>)&nbsp;-&nbsp;<%=emp_org_name%></td>
						    </tr>
							<tr>
							  <th>구매처</th>
