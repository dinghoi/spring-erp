...
if position = "사업부장" or cost_grade = "2" then
	if view_c = "total" then
		...
		'조직 개편 업데이트로 사업부 매칭에서 본부 매칭으로 조건 변경[허정호_20210601]
		'posi_sql = " and general_cost.bonbu = emp_org_mst.org_bonbu "&chr(13)
	else
		...
		'조직 개편 업데이트로 사업부 매칭에서 본부 매칭으로 조건 변경[허정호_20210601]
		'posi_sql = "and general_cost.bonbu = emp_org_mst.org_bonbu and general_cost.emp_name like '%" & emp_name & "%' "&chr(13)
	end if
end If
...
' 조건별 조회.........
base_sql = "     select general_cost.*, emp_org_mst.org_name AS orgName "&chr(13)&_
			...
			<div id="container">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
				  <tr>
					...
					<%
					'재무회계 요청 기능 추가(박성민)[허정호_20210422]
					'재무회계 미사용으로 기능 주석 처리[허정호_20210713]
					'If cost_grade = "0" Then
					%>
