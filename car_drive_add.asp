...
'=========================================================
'사용하지 않는 레코드 소멸 코드 추가[허정호_20201202]
Set Rs_acc = Nothing
...
If u_type <> "U" Then
	...
	'미등록으로 아래 쿼리 실행 시 쿼리 조회 시간이 1분 정보 소요됨(운영에서 쿼리 속도 느김)
	...
	Else
		...
		objBuilder.Append "ORDER BY run_date DESC "
...
'	payment = rs("payment")
	...
	rs_next2.Open objBuilder.ToString(), DBConn, 1
