	...
	for i = 1 to 20
		if code_tab(i) = "" or isnull(code_tab(i)) then
			...
			cg_goods_seq = right(("00" + cstr(j)),2)
		  	sql="insert into met_chulgo_goods (chulgo_date,chulgo_stock,chulgo_seq,cg_goods_seq,cg_goods_code,cg_goods_type,cg_goods_gubun,cg_standard,cg_goods_name,cg_goods_grade,cg_qty,cg_type,cg_return,rl_service_no,rl_trade_name,rl_trade_dept,reg_date,reg_user,chulgo_stock_company,chulgo_stock_name) values ('"&chulgo_date&"','"&chulgo_stock&"','"&chulgo_seq&"','"&cg_goods_seq&"','"&code_tab(i)&"','"&goods_type(i)&"','"&goods_gubun(i)&"','"&goods_standard(i)&"','"&goods_name(i)&"','"&goods_grade(i)&"','"&qty_tab(i)&"','"&chulgo_id&"','"&goods_return(i)&"','"&service_no&"','"&chulgo_trade_name&"','"&chulgo_trade_dept&"',now(),'"&user_name&"','"&chulgo_stock_company&"','"&chulgo_stock_name&"')" 
