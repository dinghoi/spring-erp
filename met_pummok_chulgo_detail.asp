...
title_line = goods_name + " 품목 < " + stock_name + " >창고 출고현황"
    ...
    <object id="factory" style="display:none;" viewastext classid="clsid:1663ed61-23eb-11d2-b92f-008048fdd814" codebase="/smsx.cab#Version=7.0.0.8">
		...
		<div id="container">				
			<div class="gView">
                ...
                <br>
                <h3 class="stit" style="font-size:12px;">◈ 일자별 출고 내역 ◈</h3>
		...
		' 본사출고건 입고잡은것, 창고이동 입고건 ..... 입고현황에 나오게 할것										
						...
						%>
                            <tr>
                                <td colspan="7" style="background:#ffe8e8;">총 계</td>
