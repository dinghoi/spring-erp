					...
					<table cellpadding="0" cellspacing="0" summary="" class="tableView">
						...
						<tbody> 
                            ...
                            <tr>
                                ...
                                <th>의뢰일자(번호)</th>
							    <td class="left"><%=rele_date%>&nbsp;&nbsp;&nbsp;(<%=rele_no%>&nbsp;<%=rele_seq%>)</td>
							    <th>의뢰창고</th>
							    <td class="left"><%=stock_name%>&nbsp;(<%=stock_company%>)</td>
						    </tr>
                            <tr>
							  <th>비고</th>
          	     ...
          	     <br>
     				<div class="noprint">
                        <div align=center>
                            ...
                            <span class="btnType01"><input type="button" value="출고증 출력" onClick="pop_Window('met_chulgo_chulgo_referral_print.asp?chulgo_date=<%=chulgo_date%>&chulgo_stock=<%=chulgo_stock%>&chulgo_seq=<%=chulgo_seq%>','met_chulgo_chulgo_print_pop','scrollbars=yes,width=750,height=600')"></span>
                            <span class="btnType01"><input type="button" value="인수증 출력" onClick="pop_Window('met_chulgo_chulgo_receip_print.asp?chulgo_date=<%=chulgo_date%>&chulgo_stock=<%=chulgo_stock%>&chulgo_seq=<%=chulgo_seq%>','met_chulgo_chulgo_receip_pop','scrollbars=yes,width=750,height=600')"></span>
                        </div>
					</div>
					<br>               		
