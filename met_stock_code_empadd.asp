					...
					<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						<tbody>
                            <tr>
                                ...
                                <input name="stock_level" type="text" id="stock_level" style="width:40px" readonly="true" value="<%=stock_level%>"></td>
                            </tr>
							<tr>
                                <th>창고명</th>
                                ...
                                <a href="#" class="btnType03" onClick="pop_Window('insa_emp_select.asp?gubun=<%="stock"%>&view_condi=<%=view_condi%>','orgempselect','scrollbars=yes,width=600,height=400')">찾기</a>
                                </td> 
