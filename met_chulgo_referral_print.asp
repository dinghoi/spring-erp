...
<table width="930" border="1px" cellpadding="15" cellspacing="0" bordercolor="#000000">
  <tr>
    <td style="border-bottom:none; border-top:none;">
     <table width="920" border="1px" cellpadding="0" cellspacing="0">
      <tr>  
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">의뢰번호</span></td>
        ...
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">의뢰창고</span></td>
        <td width="20%" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=rele_stock_name%></strong></td>
      </tr>
      <tr>  
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">의뢰회사</span></td>
  ...
  <tr>
    <td class="style4" style="border-bottom:none; border-top:none;"><strong>❐ 의뢰물품 내역</strong></td>
  </tr>
  <tr>
    <td style="border-bottom:none; border-top:none;">
     <table width="920" border="1px" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="10%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">품목구분</strong></td>
        <td width="10%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">품목코드</strong></td>
        <td width="10%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">품목명</strong></td>
        <td width="10%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">규격</strong></td>
        <td width="6%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">수량</strong></td>
        <td width="10%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">서비스No</strong></td>
        <td width="10%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">고객사</strong></td>
        <td width="10%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">점소명</strong></td>
        <td width="*" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">비고</strong></td>
      </tr>
   <%  g_seq = 0
   ...
   %>
      <tr>
        ...
        <td width="8%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("rl_goods_type")%></span></td>
        <td width="10%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("rl_goods_gubun")%></span></td>
        <td width="10%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("rl_goods_code")%></span></td>
        <td width="10%" height="20" align="left" valign="middle"><span class="style1"><span>&nbsp;<%=rs("rl_goods_name")%></span></td>
        <td width="10%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("rl_standard")%></span></td>
        <td width="6%" height="20" align="right" valign="middle" ><span class="style1"><span><%=formatnumber(rs("rl_qty"),0)%></span>&nbsp;</td>
        <td width="10%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("rl_service_no")%></span></td>
        <td width="10%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("rl_trade_name")%></span></td>
        <td width="10%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("rl_trade_dept")%></span></td>
        <td width="*" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("rl_bigo")%></span></td>
      </tr>
   <%
		rs.movenext()
	loop
  ...
  <tr>
    <td class="style1" align="center" style="border-bottom:none; border-top:none;"><span>위 품목에 대해 "케이원정보통신"으로 출고의뢰하였음을 확인 합니다.</span></td>
  </tr>
  <tr>
