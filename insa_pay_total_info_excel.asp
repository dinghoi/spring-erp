...
be_pg = "insa_pay_total_info_excel.asp"
...
'//title
curr_yyyy = mid(cstr(emp_month_start),1,4)
curr_mm = mid(cstr(emp_month_start),5,2)
title_line = srchCompany & " " & emp_month_start & "~"  & emp_month_end & " 사업부별인건비조회"
