...
title_line = " 구매 입고 현황 - " + " (" + from_date + " ∼ " + to_date + ")"
		...
		<div id="wrap">			
			<div id="container">
                ...
                <table width="1150" border="1px" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tablePrt">
						...
						<thead>
                              <tr bgcolor="#f8f8f8">
				                <th class="first" height="30" scope="col"><font style="font-size:14px">용도구분</th>
				     ...
				     <%
	           		 ...
	           		 %>
                            <tr>
                                    <td height="30" align="left" bgcolor="#EEFFFF"><%=rs("stin_goods_type")%></td>
                                    <td align="left" bgcolor="#EEFFFF"><%=rs("stin_buy_no")%>-<%=rs("stin_buy_seq")%></td>
                                    <td align="left" bgcolor="#EEFFFF"><%=order_org_name%></td>
                                    <td align="left" bgcolor="#EEFFFF"><%=order_emp_name%></td>
                                    <td align="left" bgcolor="#EEFFFF"><%=rs("stin_order_no")%>-<%=rs("stin_order_seq")%></td>
                                    <td align="left" bgcolor="#EEFFFF"><%=rs("stin_trade_name")%></td>
                                    <td align="left" bgcolor="#EEFFFF"><%=rs("stin_in_date")%></td>
