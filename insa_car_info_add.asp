...
<html>
	...
	<body onload="update_view()">
					...
					<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						<tbody>
							...
							<tr>
								...
								<td class="left">
                            <%
					            Sql="select * from emp_org_mst where (isNull(org_end_date) or org_end_date = '1900-01-01' OR org_end_date = '0000-00-00') and (org_level = '회사') ORDER BY org_code ASC"
			...
			if u_type = "U" and user_id = "101100" Or user_id = "100104" Or user_id = "101063" Or user_id = "100392" then	%>
