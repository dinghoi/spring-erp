...
title_line = "받은 전자결재 함 ( " + user_name + " " + user_grade + " )"
			...
			<div id="container">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
				  <tr>
				    ...
				    <td>
                    <div id="paging">
                        <a href="sign_process_mg.asp?page=<%=first_page%>">[처음]</a>
                  	<% if intstart > 1 then %>
                        <a href="sign_process_mg.asp?page=<%=intstart -1%>">[이전]</a>
                      <% end if %>
                      ...
                      <% next %>
                  	<% if 	intend < total_page then %>
                        <a href="sign_process_mg.asp?page=<%=intend+1%>">[다음]</a> <a href="sign_process_mg.asp?page=<%=total_page%>">[마지막]</a>
                        <%	else %>
                        [다음]&nbsp;[마지막]
                      <% end if %>
                    </div>
