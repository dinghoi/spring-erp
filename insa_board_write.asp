	...
	<body oncontextmenu="return false" ondragstart="return false">
		<div id="wrap">			
			...
			<div id="container">				
				...
				<form method="post" name="frm" action="insa_board_write_ok.asp" enctype="multipart/form-data">
...
<!--#include virtual="/fckeditor/fckeditor.asp" -->
							...
							<tr>
								...
								<img src="/image/but_ser1.jpg" onclick="file_browse()" style="cursor:pointer">
