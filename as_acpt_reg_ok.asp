...
'	end if
	...
	do until i = w_cnt
		...
		if	(company = "케") then		
			sql="insert into as_acpt (acpt_date,acpt_man,acpt_grade,acpt_user,user_grade,tel_ddd,tel_no1,tel_no2,hp_ddd,hp_no1,hp_no2,company,dept,sido,gugun,dong,addr,mg_ce_id,mg_ce,mg_group,as_memo,cowork_yn,request_date,request_time,as_process,as_type,visit_request_yn,maker,as_device,model_no,serial_no,asets_no,reside,reside_place,reside_company,team,sms,reg_id,write_date,write_cnt,doc_yn) values (cast('"&acpt_date&"' as datetime),'"&acpt_man&"','"&acpt_grade&"','"&acpt_user&"','"&user_grade&"','"&tel_ddd&"','"&tel_no1&"','"&tel_no2&"','"&hp_ddd&"','"&hp_no1&"','"&hp_no2&"','"&company&"','"&dept&"','"&sido&"','"&gugun&"','"&dong&"','"&addr&"','"&s_ce_id&"','"&s_ce&"','"&mg_group&"','"&as_memo&"','"&cowork_yn&"','"&request_date&"','"&request_time&"','"&as_process&"','"&as_type&"','"&visit_request_yn&"','"&maker&"','"&as_device&"','"&model_no&"','"&serial_no&"','"&asets_no&"','"&reside&"','"&reside_place&"','"&reside_companye&"','"&team&"','"&sms_yn&"','"&regi_id&"',cast('"&acpt_date&"' as datetime),"&i&",'"&doc_yn&"')"
			dbconn.execute(sql)
			'Response.write sql
			itft_type = as_type
			...
			sql="insert into as_acpt (acpt_date,acpt_man,acpt_user,user_man,tel_ddd,tel_no1,tel_no2,company,dept,sido,gugun,dong,addr,mg_ce_id,mg_ce,as_major,as_memo,cowork_yn,request_date,request_time,as_process,as_type,maker,as_device,model_no,serial_no,asets_no,reside_place,sms,mg_company,write_date,write_cnt,doc_yn) values (cast('"&acpt_date&"' as datetime),'"&acpt_man&"','"&acpt_user&"','"&acpt_user&"','"&tel_ddd&"','"&tel_no1&"','"&tel_no2&"','"&company&"','"&dept&"','"&sido&"','"&gugun&"','"&dong&"','"&addr&"','"&s_ce_id&"','"&s_ce&"','"&as_major&"','"&as_memo&"','"&cowork_yn&"','"&request_date&"','"&request_time&"','"&as_process&"','"&itft_type&"','"&maker&"','"&as_device&"','"&model_no&"','"&serial_no&"','"&asets_no&"','콜센터','"&sms_yn&"','케이원',cast('"&acpt_date&"' as datetime),"&i&",'"&doc_yn&"')"
			'Response.write(sql)
			dbconn1.execute(sql)
		else
			sql="insert into as_acpt (acpt_date,acpt_man,acpt_grade,acpt_user,user_grade,tel_ddd,tel_no1,tel_no2,hp_ddd,hp_no1,hp_no2,company,dept,sido,gugun,dong,addr,mg_ce_id,mg_ce,mg_group,as_memo,cowork_yn,request_date,request_time,as_process,as_type,visit_request_yn,maker,as_device,model_no,serial_no,asets_no,reside,reside_place,reside_company,team,sms,reg_id,doc_yn) values (cast('"&acpt_date&"' as datetime),'"&acpt_man&"','"&acpt_grade&"','"&acpt_user&"','"&user_grade&"','"&tel_ddd&"','"&tel_no1&"','"&tel_no2&"','"&hp_ddd&"','"&hp_no1&"','"&hp_no2&"','"&company&"','"&dept&"','"&sido&"','"&gugun&"','"&dong&"','"&addr&"','"&s_ce_id&"','"&s_ce&"','"&mg_group&"','"&as_memo&"','"&cowork_yn&"','"&request_date&"','"&request_time&"','"&as_process&"','"&as_type&"','"&visit_request_yn&"','"&maker&"','"&as_device&"','"&model_no&"','"&serial_no&"','"&asets_no&"','"&reside&"','"&reside_place&"','"&reside_company&"','"&team&"','"&sms_yn&"','"&user_id&"','"&doc_yn&"')"
			dbconn.execute(sql)
		end if  
	loop
