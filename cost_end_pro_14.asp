...
' 유류비 단가 및 유류비 계산
	...
	do until rs.eof
		...
		if team = "본사팀" or team = "공사팀" or team = "RepairCenter" then
			oil_unit_id = "1"
		  else
			oil_unit_id = "2"
		end if
...
' 급여 SUM
	...
	do until rs.eof
		...
		sql = "select * from org_cost where cost_year ='"&cost_year&"' and emp_company ='"&rs("pmg_company")&"' and bonbu ='"&rs("pmg_bonbu")&"' and saupbu ='"&rs("pmg_saupbu")&"' and team ='"&rs("pmg_team")&"' and org_name ='"&rs("pmg_org_name")&"' and reside_place ='"&rs("pmg_reside_place")&"' and company ='"&rs("pmg_reside_company")&"' and cost_id ='인건비' and cost_detail ='"&cost_detail&"'"
		set rs_cost=dbconn.execute(sql)
	
		if rs_cost.eof or rs_cost.bof then
			sql = "insert into org_cost (cost_year,emp_company,bonbu,saupbu,team,org_name,reside_place,company,cost_id,cost_detail,cost_amt_"&cost_month&",sort_seq) values ('"&cost_year&"','"&rs("pmg_company")&"','"&rs("pmg_bonbu")&"','"&rs("pmg_saupbu")&"','"&rs("pmg_team")&"','"&rs("pmg_org_name")&"','"&rs("pmg_reside_place")&"','"&rs("pmg_reside_company")&"','인건비','"&cost_detail&"',"&rs("cost")&","&sort_seq&")"
			dbconn.execute(sql)
		  else
			sql = "update org_cost set cost_amt_"&cost_month&"="&rs("cost")&",sort_seq="&sort_seq&" where cost_year ='"&cost_year&"' and emp_company ='"&rs("pmg_company")&"' and bonbu ='"&rs("pmg_bonbu")&"' and saupbu ='"&rs("pmg_saupbu")&"' and team ='"&rs("pmg_team")&"' and org_name ='"&rs("pmg_org_name")&"' and reside_place ='"&rs("pmg_reside_place")&"' and company ='"&rs("pmg_reside_company")&"' and cost_id ='인건비' and cost_detail ='"&cost_detail&"'"
			dbconn.execute(sql)
		end if		
		rs.movenext()
	loop
...
' 4대보험 SUM
	...
	do until rs.eof
		...
		sql = "select * from org_cost where cost_year ='"&cost_year&"' and emp_company ='"&rs("de_company")&"' and bonbu ='"&rs("de_bonbu")&"' and saupbu ='"&rs("de_saupbu")&"' and team ='"&rs("de_team")&"' and org_name ='"&rs("de_org_name")&"' and reside_place ='"&rs("de_reside_place")&"' and company ='"&rs("de_reside_company")&"' and cost_id ='인건비' and cost_detail ='4대보험'"
		set rs_cost=dbconn.execute(sql)
	
		sort_seq = 1
		if rs_cost.eof or rs_cost.bof then
			sql = "insert into org_cost (cost_year,emp_company,bonbu,saupbu,team,org_name,reside_place,company,cost_id,cost_detail,cost_amt_"&cost_month&",sort_seq) values ('"&cost_year&"','"&rs("de_company")&"','"&rs("de_bonbu")&"','"&rs("de_saupbu")&"','"&rs("de_team")&"','"&rs("de_org_name")&"','"&rs("de_reside_place")&"','"&rs("de_reside_company")&"','인건비','4대보험',"&rs("cost")&","&sort_seq&")"
			dbconn.execute(sql)
		  else
			sql = "update org_cost set cost_amt_"&cost_month&"="&rs("cost")&",sort_seq="&sort_seq&" where cost_year ='"&cost_year&"' and emp_company ='"&rs("de_company")&"' and bonbu ='"&rs("de_bonbu")&"' and saupbu ='"&rs("de_saupbu")&"' and team ='"&rs("de_team")&"' and org_name ='"&rs("de_org_name")&"' and reside_place ='"&rs("de_reside_place")&"' and company ='"&rs("de_reside_company")&"' and cost_id ='인건비' and cost_detail ='4대보험'"
			dbconn.execute(sql)
		end if		
		rs.movenext()
	loop
...
' 알바비
	...
	do until rs.eof
		...
		sql = "select * from org_cost where cost_year ='"&cost_year&"' and emp_company ='"&rs("company")&"' and bonbu ='"&rs("bonbu")&"' and saupbu ='"&rs("saupbu")&"' and team ='"&rs("team")&"' and org_name ='"&rs("org_name")&"' and company ='"&rs("cost_company")&"' and cost_id ='인건비' and cost_detail ='알바비'"
		set rs_cost=dbconn.execute(sql)
	
		sort_seq = 8
		if rs_cost.eof or rs_cost.bof then
			sql = "insert into org_cost (cost_year,emp_company,bonbu,saupbu,team,org_name,company,cost_id,cost_detail,cost_amt_"&cost_month&",sort_seq) values ('"&cost_year&"','"&rs("company")&"','"&rs("bonbu")&"','"&rs("saupbu")&"','"&rs("team")&"','"&rs("org_name")&"','"&rs("cost_company")&"','인건비','알바비',"&rs("cost")&","&sort_seq&")"
			dbconn.execute(sql)
		  else
			sql = "update org_cost set cost_amt_"&cost_month&"="&rs("cost")&",sort_seq="&sort_seq&" where cost_year ='"&cost_year&"' and emp_company ='"&rs("company")&"' and bonbu ='"&rs("bonbu")&"' and saupbu ='"&rs("saupbu")&"' and team ='"&rs("team")&"' and org_name ='"&rs("org_name")&"' and company ='"&rs("cost_company")&"' and cost_id ='인건비' and cost_detail ='알바비'"
			dbconn.execute(sql)
		end if		
		rs.movenext()
	loop
...
' DB SUM 야특근
	...
	do until rs.eof
		...
		"' and company ='"&rs("company")&"' and cost_id ='야특근' and cost_detail ='"&rs("cost_detail")&"'"
		set rs_cost=dbconn.execute(sql)
	
		if rs_cost.eof or rs_cost.bof then
			sql = "insert into org_cost (cost_year,emp_company,bonbu,saupbu,team,org_name,reside_place,company,cost_id,cost_detail,cost_amt_"&cost_month&") values ('"&cost_year&"','"&rs("emp_company")&"','"&rs("bonbu")&"','"&rs("saupbu")&"','"&rs("team")&"','"&rs("org_name")&"','"&rs("reside_place")&"','"&rs("company")&"','야특근','"&rs("cost_detail")&"',"&rs("cost")&")"
			dbconn.execute(sql)
		  else
			sql = "update org_cost set cost_amt_"&cost_month&"="&rs("cost")&" where cost_year ='"&cost_year&"' and emp_company ='"&rs("emp_company")&"' and bonbu ='"&rs("bonbu")&"' and saupbu ='"&rs("saupbu")&"' and team ='"&rs("team")&"' and org_name ='"&rs("org_name")&"' and reside_place ='"&rs("reside_place")&"' and company ='"&rs("company")&"' and cost_id ='야특근' and cost_detail ='"&rs("cost_detail")&"'"
			dbconn.execute(sql)
		end if		
		rs.movenext()
	loop
...
'일반비용	
	...
	dbconn.execute(sql)
' DB SUM 처리 (비용)
	sql = "select emp_company,bonbu,saupbu,team,org_name,reside_place,company,account,sum(cost) as cost from general_cost where (slip_gubun = '비용') and (cancel_yn = 'N') and (saupbu = '"&saupbu&"') and (slip_date >='"&from_date&"' and slip_date <='"&to_date&"') group by emp_company,bonbu,saupbu,team,org_name,reside_place,company,account"
	rs.Open sql, Dbconn, 1
	do until rs.eof
	...
	rs.close()
' DB SUM 처리 (비용 외)
	sql = "select slip_gubun,emp_company,bonbu,saupbu,team,org_name,reside_place,company,account,sum(cost) as cost from general_cost where (slip_gubun <> '비용') and (cancel_yn = 'N') and (saupbu = '"&saupbu&"') and (slip_date >='"&from_date&"' and slip_date <='"&to_date&"') group by slip_gubun,emp_company,bonbu,saupbu,team,org_name,reside_place,company,account"
	rs.Open sql, Dbconn, 1
	do until rs.eof
...
' DB SUM 교통비
	...
	do until rs.eof
		...
		sql = "select * from org_cost where cost_year ='"&cost_year&"' and emp_company ='"&rs("emp_company")&"' and bonbu ='"&rs("bonbu")& _
		"' and saupbu ='"&rs("saupbu")&"' and team ='"&rs("team")&"' and org_name ='"&rs("org_name")&"' and reside_place ='"&rs("reside_place")& _
		"' and company ='"&rs("company")&"' and cost_id ='교통비' and cost_detail ='"&rs("car_owner")&"'"
		set rs_cost=dbconn.execute(sql)
	
		if rs_cost.eof or rs_cost.bof then
			sql = "insert into org_cost (cost_year,emp_company,bonbu,saupbu,team,org_name,reside_place,company,cost_id,cost_detail,cost_amt_"&cost_month&") values ('"&cost_year&"','"&rs("emp_company")&"','"&rs("bonbu")&"','"&rs("saupbu")&"','"&rs("team")&"','"&rs("org_name")&"','"&rs("reside_place")&"','"&rs("company")&"','교통비','"&rs("car_owner")&"',"&rs("cost")&")"
			dbconn.execute(sql)
		  else
			sql = "update org_cost set cost_amt_"&cost_month&"="&rs("cost")&" where cost_year ='"&cost_year&"' and emp_company ='"&rs("emp_company")&"' and bonbu ='"&rs("bonbu")&"' and saupbu ='"&rs("saupbu")&"' and team ='"&rs("team")&"' and org_name ='"&rs("org_name")&"' and reside_place ='"&rs("reside_place")&"' and company ='"&rs("company")&"' and cost_id ='교통비' and cost_detail ='"&rs("car_owner")&"'"
			dbconn.execute(sql)
		end if		
		rs.movenext()
	loop
...
' DB SUM 교통비 (차량수리비)
	...
	do until rs.eof
		...
		sql = "select * from org_cost where cost_year ='"&cost_year&"' and emp_company ='"&rs("emp_company")&"' and bonbu ='"&rs("bonbu")& _
		"' and saupbu ='"&rs("saupbu")&"' and team ='"&rs("team")&"' and org_name ='"&rs("org_name")&"' and reside_place ='"&rs("reside_place")& _
		"' and company ='"&rs("company")&"' and cost_id ='교통비' and cost_detail ='차량수리비'"
		set rs_cost=dbconn.execute(sql)
	
		if rs_cost.eof or rs_cost.bof then
			sql = "insert into org_cost (cost_year,emp_company,bonbu,saupbu,team,org_name,reside_place,company,cost_id,cost_detail,cost_amt_"&cost_month&") values ('"&cost_year&"','"&rs("emp_company")&"','"&rs("bonbu")&"','"&rs("saupbu")&"','"&rs("team")&"','"&rs("org_name")&"','"&rs("reside_place")&"','"&rs("company")&"','교통비','차량수리비',"&rs("cost")&")"
			dbconn.execute(sql)
		  else
			sql = "update org_cost set cost_amt_"&cost_month&"="&rs("cost")&" where cost_year ='"&cost_year&"' and emp_company ='"&rs("emp_company")&"' and bonbu ='"&rs("bonbu")&"' and saupbu ='"&rs("saupbu")&"' and team ='"&rs("team")&"' and org_name ='"&rs("org_name")&"' and reside_place ='"&rs("reside_place")&"' and company ='"&rs("company")&"' and cost_id ='교통비' and cost_detail ='차량수리비'"
			dbconn.execute(sql)
		end if		
		rs.movenext()
	loop
...
'	sql = "select emp_company,bonbu,saupbu,team,org_name,reside_place,reside_company,account,sum(cost) as cost from card_slip where (end_sw = 'Y') and (saupbu = '"&saupbu&"') and (slip_date >='"&from_date&"' and slip_date <='"&to_date&"') group by emp_company,bonbu,saupbu,team,org_name,reside_place,reside_company,account"
	sql = "select emp_company,bonbu,saupbu,team,org_name,reside_place,reside_company,account,sum(cost) as cost from card_slip where (saupbu = '"&saupbu&"') and (slip_date >='"&from_date&"' and slip_date <='"&to_date&"') and card_type not like '%주유%' group by emp_company,bonbu,saupbu,team,org_name,reside_place,reside_company,account"
	rs.Open sql, Dbconn, 1
	do until rs.eof
							
		sql = "select * from org_cost where cost_year ='"&cost_year&"' and emp_company ='"&rs("emp_company")&"' and bonbu ='"&rs("bonbu")& _
		"' and saupbu ='"&rs("saupbu")&"' and team ='"&rs("team")&"' and org_name ='"&rs("org_name")&"' and reside_place ='"&rs("reside_place")& _
		"' and company ='"&rs("reside_company")&"' and cost_id ='법인카드' and cost_detail ='"&rs("account")&"'"
		set rs_cost=dbconn.execute(sql)
	
		if rs_cost.eof or rs_cost.bof then
			sql = "insert into org_cost (cost_year,emp_company,bonbu,saupbu,team,org_name,reside_place,company,cost_id,cost_detail,cost_amt_"&cost_month&") values ('"&cost_year&"','"&rs("emp_company")&"','"&rs("bonbu")&"','"&rs("saupbu")&"','"&rs("team")&"','"&rs("org_name")&"','"&rs("reside_place")&"','"&rs("reside_company")&"','법인카드','"&rs("account")&"',"&rs("cost")&")"
			dbconn.execute(sql)
		  else
			sum_cost = clng(rs("cost")) + clng(rs_cost(9+cost_month))
			sql = "update org_cost set cost_amt_"&cost_month&"="&sum_cost&" where cost_year ='"&cost_year&"' and emp_company ='"&rs("emp_company")&"' and bonbu ='"&rs("bonbu")&"' and saupbu ='"&rs("saupbu")&"' and team ='"&rs("team")&"' and org_name ='"&rs("org_name")&"' and reside_place ='"&rs("reside_place")&"' and company ='"&rs("reside_company")&"' and cost_id ='법인카드' and cost_detail ='"&rs("account")&"'"
			dbconn.execute(sql)
		end if		
		rs.movenext()
	loop
