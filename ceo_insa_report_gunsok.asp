...
be_pg = "ceo_insa_report_gunsok.asp"
	...
	<body>
		<div id="wrap">			
			...
			<div id="container">
				...
				<form action="ceo_insa_report_gunsok.asp?ck_sw=<%="n"%>" method="post" name="frm">
				<fieldset class="srch">
					<legend>조회영역</legend>
					<dl>					
						<dt>조건 검색</dt>
					...
					<table cellpadding="0" cellspacing="0" class="tableList">
						...
						%>	
                            <tr>
                                ...
                                <td>
                                <a href="#" onClick="pop_Window('insa_gunsok_count_view.asp?emp_company=<%=view_condi%>&emp_bonbu=<%=com_tab(i)%>&gunsok_yy=<%="1"%>','insa_gunsok_count_pop','scrollbars=yes,width=890,height=700')"><%=formatnumber(gun_cnt(i,2),0)%></a>
                                </td>
                                <td>
                                <a href="#" onClick="pop_Window('insa_gunsok_count_view.asp?emp_company=<%=view_condi%>&emp_bonbu=<%=com_tab(i)%>&gunsok_yy=<%="2"%>','insa_gunsok_count_pop','scrollbars=yes,width=890,height=700')"><%=formatnumber(gun_cnt(i,3),0)%></a>
                                </td>
                                <td>
                                <a href="#" onClick="pop_Window('insa_gunsok_count_view.asp?emp_company=<%=view_condi%>&emp_bonbu=<%=com_tab(i)%>&gunsok_yy=<%="3"%>','insa_gunsok_count_pop','scrollbars=yes,width=890,height=700')"><%=formatnumber(gun_cnt(i,4),0)%></a>
                                </td>
                                <td>
                                <a href="#" onClick="pop_Window('insa_gunsok_count_view.asp?emp_company=<%=view_condi%>&emp_bonbu=<%=com_tab(i)%>&gunsok_yy=<%="4"%>','insa_gunsok_count_pop','scrollbars=yes,width=890,height=700')"><%=formatnumber(gun_cnt(i,5),0)%></a>
                                </td>
                                <td>
                                <a href="#" onClick="pop_Window('insa_gunsok_count_view.asp?emp_company=<%=view_condi%>&emp_bonbu=<%=com_tab(i)%>&gunsok_yy=<%="5"%>','insa_gunsok_count_pop','scrollbars=yes,width=890,height=700')"><%=formatnumber(gun_cnt(i,6),0)%></a>
                                </td>
                                <td>
                                <a href="#" onClick="pop_Window('insa_gunsok_count_view.asp?emp_company=<%=view_condi%>&emp_bonbu=<%=com_tab(i)%>&gunsok_yy=<%="6"%>','insa_gunsok_count_pop','scrollbars=yes,width=890,height=700')"><%=formatnumber(gun_cnt(i,7),0)%></a>
                                </td>
                                <td>
                                <a href="#" onClick="pop_Window('insa_gunsok_count_view.asp?emp_company=<%=view_condi%>&emp_bonbu=<%=com_tab(i)%>&gunsok_yy=<%="7"%>','insa_gunsok_count_pop','scrollbars=yes,width=890,height=700')"><%=formatnumber(gun_cnt(i,8),0)%></a>
                                </td>
                                <td>
                                <a href="#" onClick="pop_Window('insa_gunsok_count_view.asp?emp_company=<%=view_condi%>&emp_bonbu=<%=com_tab(i)%>&gunsok_yy=<%="8"%>','insa_gunsok_count_pop','scrollbars=yes,width=890,height=700')"><%=formatnumber(gun_cnt(i,9),0)%></a>
                                </td>
                                <td>
                                <a href="#" onClick="pop_Window('insa_gunsok_count_view.asp?emp_company=<%=view_condi%>&emp_bonbu=<%=com_tab(i)%>&gunsok_yy=<%="9"%>','insa_gunsok_count_pop','scrollbars=yes,width=890,height=700')"><%=formatnumber(gun_cnt(i,10),0)%></a>
                                </td>
                                <td>
                                <a href="#" onClick="pop_Window('insa_gunsok_count_view.asp?emp_company=<%=view_condi%>&emp_bonbu=<%=com_tab(i)%>&gunsok_yy=<%="10"%>','insa_gunsok_count_pop','scrollbars=yes,width=890,height=700')"><%=formatnumber(gun_cnt(i,11),0)%></a>
                                </td>
                                <td>
                                <a href="#" onClick="pop_Window('insa_gunsok_count_view.asp?emp_company=<%=view_condi%>&emp_bonbu=<%=com_tab(i)%>&gunsok_yy=<%="11"%>','insa_gunsok_count_pop','scrollbars=yes,width=890,height=700')"><%=formatnumber(gun_cnt(i,12),0)%></a>
                                </td>
                                <td>
                                <a href="#" onClick="pop_Window('insa_gunsok_count_view.asp?emp_company=<%=view_condi%>&emp_bonbu=<%=com_tab(i)%>&gunsok_yy=<%="12"%>','insa_gunsok_count_pop','scrollbars=yes,width=890,height=700')"><%=formatnumber(gun_cnt(i,13),0)%></a>
                                </td>
                                <td>
                                 <a href="#" onClick="pop_Window('insa_gunsok_count_view.asp?emp_company=<%=view_condi%>&emp_bonbu=<%=com_tab(i)%>&gunsok_yy=<%="13"%>','insa_gunsok_count_pop','scrollbars=yes,width=890,height=700')"><%=formatnumber(gun_cnt(i,14),0)%></a>
                                </td>
                                <td>
                                <a href="#" onClick="pop_Window('insa_gunsok_count_view.asp?emp_company=<%=view_condi%>&emp_bonbu=<%=com_tab(i)%>&gunsok_yy=<%="14"%>','insa_gunsok_count_pop','scrollbars=yes,width=890,height=400')"><%=formatnumber(gun_cnt(i,15),0)%></a>
                                </td>
                                <td>
                                <a href="#" onClick="pop_Window('insa_gunsok_count_view.asp?emp_company=<%=view_condi%>&emp_bonbu=<%=com_tab(i)%>&gunsok_yy=<%="15"%>','insa_gunsok_count_pop','scrollbars=yes,width=890,height=400')"><%=formatnumber(gun_cnt(i,16),0)%></a>
                                </td>
                                <td>
                                <a href="#" onClick="pop_Window('insa_gunsok_count_view.asp?emp_company=<%=view_condi%>&emp_bonbu=<%=com_tab(i)%>&gunsok_yy=<%="16"%>','insa_gunsok_count_pop','scrollbars=yes,width=890,height=400')"><%=formatnumber(gun_cnt(i,17),0)%></a>
                                </td>
                                <td><%=formatnumber(clng(gun_cnt(i,1)+gun_cnt(i,2)+gun_cnt(i,3)+gun_cnt(i,4)+gun_cnt(i,5)+gun_cnt(i,6)+gun_cnt(i,7)+gun_cnt(i,8)+gun_cnt(i,9)+gun_cnt(i,10)+gun_cnt(i,11)+gun_cnt(i,12)+gun_cnt(i,13)+gun_cnt(i,14)+gun_cnt(i,15)+gun_cnt(i,16)+gun_cnt(i,17)+gun_cnt(i,18)),0)%>&nbsp;</td>
                             </tr>
                        <%
							end if
						next
