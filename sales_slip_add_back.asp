...
sales_company = emp_company
sales_bonbu = bonbu
sales_saupbu = saupbu
sales_team = team
sales_org_name = org_name
trade_code = ""
trade_no = ""
trade_name = ""
trade_person = ""
	...
	<head>
		...
		<script type="text/javascript">
			...
			{ 
				...
				slip_id = document.frm.old_slip_id.value
//				var popupW = 600;
//				var popupH = 400;
...
//				alert("aaaa");
				code_ary[0] = document.frm.pummok_code1.value + "/" + document.frm.standard1.value + "/" + document.frm.qty1.value + "/" + document.frm.buy_cost1.value + "/" + document.frm.sales_cost1.value;
				code_ary[1] = document.frm.pummok_code2.value + "/" + document.frm.standard2.value + "/" + document.frm.qty2.value + "/" + document.frm.buy_cost2.value + "/" + document.frm.sales_cost2.value;
				code_ary[2] = document.frm.pummok_code3.value + "/" + document.frm.standard3.value + "/" + document.frm.qty3.value + "/" + document.frm.buy_cost3.value + "/" + document.frm.sales_cost3.value;
				code_ary[3] = document.frm.pummok_code4.value + "/" + document.frm.standard4.value + "/" + document.frm.qty4.value + "/" + document.frm.buy_cost4.value + "/" + document.frm.sales_cost4.value;
				code_ary[4] = document.frm.pummok_code5.value + "/" + document.frm.standard5.value + "/" + document.frm.qty5.value + "/" + document.frm.buy_cost5.value + "/" + document.frm.sales_cost5.value;
				code_ary[5] = document.frm.pummok_code6.value + "/" + document.frm.standard6.value + "/" + document.frm.qty6.value + "/" + document.frm.buy_cost6.value + "/" + document.frm.sales_cost6.value;
				code_ary[6] = document.frm.pummok_code7.value + "/" + document.frm.standard7.value + "/" + document.frm.qty7.value + "/" + document.frm.buy_cost7.value + "/" + document.frm.sales_cost7.value;
				code_ary[7] = document.frm.pummok_code8.value + "/" + document.frm.standard8.value + "/" + document.frm.qty8.value + "/" + document.frm.buy_cost8.value + "/" + document.frm.sales_cost8.value;
				code_ary[8] = document.frm.pummok_code9.value + "/" + document.frm.standard9.value + "/" + document.frm.qty9.value + "/" + document.frm.buy_cost9.value + "/" + document.frm.sales_cost9.value;
				code_ary[9] = document.frm.pummok_code10.value + "/" + document.frm.standard10.value + "/" + document.frm.qty10.value + "/" + document.frm.buy_cost10.value + "/" + document.frm.sales_cost10.value;
	...
	<% end if	%>
		<div id="container">				
			...
			<h3 class="tit"><%=title_line%></h3>
				<form method="post" name="frm" action="sales_slip_add_save.asp" enctype="multipart/form-data">
					<table cellpadding="0" cellspacing="0" summary="" class="tableWrite">
						...
						<tbody>
							<tr>
							  <th>전표유형</th>
							  <td class="left">
                              <input type="radio" name="slip_id" value="1" <% if slip_id = "1" then %>checked<% end if %> style="width:20px" id="Radio3">대기
  							  <input type="radio" name="slip_id" value="2" <% if slip_id = "2" then %>checked<% end if %> style="width:20px" id="Radio4">수주
							  <%=view_slip_id%>&nbsp;<%=view_slip_no%>
                              </td>
							  <th>매출조직</th>
                              ...
                              <strong>매출조직변경</strong>
                				...
                				<input name="sales_company" id="sales_company" type="text" value="<%=sales_company%>" readonly="true" style="display:none;width:120px">
            		...
            		<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						%>
			  				<tr id="pummok_list<%=i%>" style="display:none">
								...
								<td>
                                <input name="srv_type<%=i%>" type="text" id="srv_type<%=i%>" value="<%=pummok_tab(2,i)%>" style="width:120px" readonly="true">
                                <input name="pummok_code<%=i%>" type="hidden" id="pummok_code<%=i%>" value="<%=pummok_tab(1,i)%>" readonly="true">
                                </td>
								<td><input name="pummok<%=i%>" type="text" id="pummok<%=i%>" value="<%=pummok_tab(3,i)%>" style="width:120px" readonly="true"></td>
								<td><input name="standard<%=i%>" type="text" id="standard<%=i%>" value="<%=pummok_tab(4,i)%>" style="width:170px"></td>
								<td><input name="qty<%=i%>" type="text" id="qty<%=i%>" value="<%=formatnumber(cost_tab(1,i),0)%>" style="width:50px;text-align:right" onKeyUp="NumCal(this);"></td>
								<td><input name="buy_cost<%=i%>" type="text" id="buy_cost<%=i%>" value="<%=formatnumber(cost_tab(2,i),0)%>" style="width:100px;text-align:right" onKeyUp="NumCal(this);" ></td>
								<td><input name="sales_cost<%=i%>" type="text" id="sales_cost<%=i%>" value="<%=formatnumber(cost_tab(3,i),0)%>" style="width:100px;text-align:right" onKeyUp="NumCal(this);" ></td>
								<td><input name="sales_tot<%=i%>" type="text" disabled id="sales_tot<%=i%>" style="width:100px;text-align:right" value="<%=formatnumber(cost_tab(4,i),0)%>"></td>
								<td><input name="margin_cost<%=i%>" type="text" disabled id="margin_cost<%=i%>" style="width:100px;text-align:right"></td>
								<td><input name="margin_tot<%=i%>" type="text" disabled id="margin_tot<%=i%>" style="width:100px;text-align:right"></td>
							</tr>
						<%
							next
						%>
...
<br>
					...
					<input type="hidden" name="old_slip_id" value="<%=slip_id%>">
					<input type="hidden" name="old_slip_no" value="<%=slip_no%>">
					<input type="hidden" name="old_slip_seq" value="<%=slip_seq%>">
