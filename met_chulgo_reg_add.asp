...
//				var url = "met_goods_select.asp?code_ary="+code_ary;
				pop_Window(url,'출고의뢰품목선택','scrollbars=yes,width=960,height=400');
	...
	<body>
		<div id="container">				
			<div class="gView">
                ...
                <form method="post" name="frm" action="met_chulgo_reg_add_save.asp" enctype="multipart/form-data">
				<div class="gView">
            	...
            	<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						%>
			  				<tr id="pummok_list<%=i%>" style="display:none">
								...
								<td><input name="goods_name<%=i%>" type="text" id="goods_name<%=i%>" value="<%=pummok_tab(4,i)%>" style="width:100px" readonly="true">
                                ...
                                <td><input name="jqty<%=i%>" type="text" id="jqty<%=i%>" style="width:60px;text-align:right" value="<%=formatnumber(jqty,0)%>" readonly="true"></td>
                                ...
                                <td>
                                <input name="service_no<%=i%>" type="text" id="service_no<%=i%>" value="<%=pummok_tab(7,i)%>" style="width:80px">
                                </td>
                                <td>
                                <input name="trade_name<%=i%>" type="text" id="trade_name<%=i%>" value="<%=pummok_tab(8,i)%>" style="width:100px">
                                </td>
                                <td>
                                <input name="trade_dept<%=i%>" type="text" id="trade_dept<%=i%>" value="<%=pummok_tab(9,i)%>" style="width:100px">
                                </td>
                                <td>
                                <input name="r_bigo<%=i%>" type="text" id="r_bigo<%=i%>" value="<%=pummok_tab(10,i)%>" style="width:150px">
                                </td>
							</tr>
						<%
							next
