...
if goods_type = "전체" then
        sql = "select * from met_stock_gmaster where (stock_company = '"&view_condi&"') " + field_sql + order_sql 
   else		
		sql = "select * from met_stock_gmaster where (stock_company = '"&view_condi&"') and (stock_goods_type = '"&goods_type&"') " + field_sql + order_sql
end if
...
<table  border="0" cellpadding="0" cellspacing="0">
  <tr bgcolor="#EFEFEF" class="style11">
    <td colspan="13" bgcolor="#FFFFFF"><div align="left" class="style2">&nbsp;<%=field_check%> &nbsp;(<%=goods_type%>)&nbsp;재고 현황&nbsp;<%=curr_date%></div></td>
  </tr>
  <tr bgcolor="#EFEFEF" class="style11">
  ...
  <tr valign="middle" class="style11">
    ...
    <td width="145"><div align="center" class="style1"><%=rs("stock_bonbu")%></div></td>
    <td width="145"><div align="center" class="style1"><%=rs("stock_saupbu")%></div></td>
    <td width="145"><div align="center" class="style1"><%=rs("stock_team")%></div></td>
