...
<html>
	...
	<body onload="update_view()">
			<div id="container">
				...
				<form action="insa_albacost_save.asp" method="post" name="frm">
				<div class="gView">
					<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						<tbody>
							<tr>
								...
								<a href="#" class="btnType03" onClick="pop_Window('insa_alba_search.asp?gubun=<%="1"%>','alba_search','scrollbars=yes,width=600,height=400')">찾기</a>
            					</td>
								<th >성명</th>
								<td class="left" >
							...
							<tr>
								...
								<td class="left" >
                                <input name="company" type="text" value="<%=company%>" style="width:90px" readonly="true">
                                -
                                <input name="org_name" type="text" value="<%=org_name%>" style="width:90px" readonly="true">
                        	...
                        	<tr>
								...
								<th>전자결재No.</th>
								<td class="left">
                                <input name="sign_no" type="text" value="<%=sign_no%>" style="width:90px" readonly="true">
                                </td>
							</tr>
							<tr>
