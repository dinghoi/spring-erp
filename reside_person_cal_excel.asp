...
reside_company=Request("reside_company")
from_date = mid(cost_month,1,4) + "-" + mid(cost_month,6,2) + "-31"

savefilename = cost_month + "월 상주처별 사용및 정산 현황.xls"
...
sql = "select * from emp_master_month where (emp_month = '"&cost_month&"') and (emp_end_date = '1900-01-01' or isnull(emp_end_date) or emp_end_date >= '"&from_date&"') and (emp_reside_company = '"&reside_company&"') order by emp_reside_place, emp_name"
rs_emp.Open sql, Dbconn, 1
	
title_line = cost_month + "월 상주처별 개인별 비용사용 및 정산현황"
%>
