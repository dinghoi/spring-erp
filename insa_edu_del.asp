...
'response.write(edu_seq)
'response.write(edu_empname)
'response.End
...
dbconn.open DbConnect
	...
	if owner_view = "C" then 
	           url = "insa_edu_mg.asp?ck_sw=y&view_condi=" + edu_empname + "&owner_view="+ owner_view
		else 
		       url = "insa_edu_mg.asp?ck_sw=y&view_condi=" + edu_empno + "&owner_view="+ owner_view
	end if
