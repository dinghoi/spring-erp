...
//-->
<frameset rows="20%,80%">
  <frame  src="insa_emp_infor_top.asp" scrolling="no" mane="top">
<frameset cols="150,*" border="0">
  <frame name="left" src="insa_emp_infor_left.asp" target="main">
  <frame name="right" src="insa_emp_infor_view.asp?emp_no=<%=emp_no%>" >
</frameset>
  <noframes>    
	<body>
		<div id="wrap">			
