<%
'sql = "select emp_saupbu from emp_master_month where (emp_month ='"&end_month&"') and (cost_center <> '颊劳力寇') /* group by emp_saupbu */ "
...
objBuilder.Append "	AND emmt.cost_center <> '颊劳力寇' "
...
'sql = "select emp_reside_company from emp_master_month where (emp_month ='"&end_month&"') and (mg_saupbu = '') and (emp_reside_company <> '') and (cost_center <> '颊劳力寇') /* group by emp_reside_company */ "
...
objBuilder.Append "	AND cost_center <> '颊劳力寇' "
