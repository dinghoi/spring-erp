<%
' 회사 차량 운행 주유카드 셋팅
objBuilder.Append "CALL USP_ORG_END_TRAN_COMP_SEL('"&deptName&"', '"&from_date&"', '"&to_date&"');"
...
' 카드비용 집계
objBuilder.Append "CALL USP_ORG_END_CARD_COST_SEL('"&deptName&"', '"&from_date&"', '"&to_date&"');"
