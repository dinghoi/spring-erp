<%
'야특근 마감 처리
objBuilder.Append "CALL USP_ORG_END_OVERTIME_END_UP('"&from_date&"', '"&to_date&"', '"&deptName&"');"
DBConn.Execute(objBuilder.ToString())
objBuilder.Clear()

'일반 경비 조회
objBuilder.Append "CALL USP_ORG_END_GENERAL_SEL('"&end_month&"', '"&deptName&"', '"&from_date&"', '"&to_date&"');"
...
'DB SUM 처리(비용)
objBuilder.Append "CALL USP_ORG_END_GENERAL_ORG_COST_SEL('"&deptName&"', '"&from_date&"', '"&to_date&"');"
...
'DB SUM 처리(비용 외)
objBuilder.Append "CALL USP_ORG_END_GENERAL_ETC_SEL('"&deptName&"', '"&from_date&"', '"&to_date&"');"
