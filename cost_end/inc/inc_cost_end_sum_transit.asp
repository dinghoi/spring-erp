<%
'교통비 마감
objBuilder.Append "CALL USP_ORG_END_TRANSIT_END_UP('"&from_date&"', '"&to_date&"', '"&deptName&"');"
DBConn.Execute(objBuilder.ToString())
objBuilder.Clear()

'교통비 조회
objBuilder.Append "CALL USP_ORG_END_TRANSIT_SEL('"&deptName&"', '"&from_date&"', '"&to_date&"');"
...
'DB SUM 교통비(차량수리비)
objBuilder.Append "CALL USP_ORG_END_TRAN_REPAIR_SEL('"&deptName&"', '"&from_date&"', '"&to_date&"');"
