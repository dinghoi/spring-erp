					...
					<table cellpadding="0" cellspacing="0" class="tableList">
						...
						%>
							<tr>
								...
								<td class="left"><strong><%=board_title%></strong>&nbsp;<a href="board_view.asp?board_back=<%=board_gubun%>&board_gubun=<%=rs("board_gubun")%>&board_seq=<%=rs("board_seq")%>&page=<%=page%>&condi=<%=condi%>&condi_value=<%=condi_value%>&ck_sw=<%="y"%>"><%=rs("board_title")%></a>
