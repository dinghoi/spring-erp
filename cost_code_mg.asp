	...
	<body oncontextmenu="return false" ondragstart="return false">
		<div id="wrap">			
			...
			<div id="container">
				...
				<form action="cost_code_mg.asp" method="post" name="condi_frm">
				<fieldset class="srch">
					<legend>조회영역</legend>
					<dl>					
						<dt>조건 검색</dt>
				    ...
				    <tr>
				      <td width="64%" height="356" valign="top"><table cellpadding="0" cellspacing="0" class="tableList">
				        ...
				        <tr>
				          ...
				          <td><a href="cost_code_mg.asp?etc_code=<%=rs("etc_code")%>&etc_type=<%=rs("etc_type")%>&u_type=<%="U"%>"><%=rs("etc_name")%></a></td>
				          <td>&nbsp;<%=rs("etc_group")%></td>
				          <td>&nbsp;<%=rs("group_name")%></td>
				          <td><%=mg_group_view%></td>
				      ...
				      <td width="34%" valign="top"><form method="post" name="frm" action="cost_code_reg_ok.asp">
				        <table cellpadding="0" cellspacing="0" summary="" class="tableWrite">
				          <tbody>
				            ...
				            <tr>
				              <th>금액</th>
				              <td class="left"><input name="etc_amt" type="text" id="etc_amt" value="<%=formatnumber(u_etc_amt,0)%>" onKeyUp="plusComma(this);" style="width:80px;text-align:right"></td>
			                </tr>
				            <tr>
				              <th>사용여부</th>
