					...
					<table cellpadding="0" cellspacing="0" summary="" class="tableView">
						...
						<tbody> 
                            ...
                            <tr>
                                ...
                                <th>입고번호</th>
                                <td colspan="3" class="left"><%=stin_order_no%>&nbsp;<%=stin_order_seq%></td>

						    </tr>
                            <tr>
                                <th>입고창고</th>
							    <td colspan="3" class="left"><%=stin_stock_name%>&nbsp;</td>
                                <th>입고담당</th>
							...
							<tr>
							    ...
							    <th>사업자번호</th>
							    <td colspan="3" class="left"><%=stin_trade_no%></td>

						    </tr>
                            <tr>
							  <th>비고</th>
							  <td colspan="5" class="left"><%=stin_memo%>&nbsp;</td>
						    </tr>
						</tbody>
					</table>
                <br>
