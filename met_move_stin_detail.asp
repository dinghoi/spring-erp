    ...
    <object id="factory" style="display:none;" viewastext classid="clsid:1663ed61-23eb-11d2-b92f-008048fdd814" codebase="/smsx.cab#Version=7.0.0.8">
		...
		<div id="container">				
			<div class="gView">
				...
				<form method="post" name="frm" action="met_move_stin_cancel.asp">
					<table cellpadding="0" cellspacing="0" summary="" class="tableView">
                      ...
                      <th>의뢰일자<br>담당</th>
                            ...
                            <tr>
                              <th>출고일자</th>
						      <td class="left"><%=chulgo_date%>&nbsp;&nbsp;(요청:&nbsp;<%=chulgo_rele_date%>)</td>
							  <th>출고담당</th>
                ...
                <br>
                <h3 class="stit" style="font-size:12px;">◈ 창고이동 입고 세부 내역 ◈</h3>
       ...
       <% if cancel_yn = "Y" then   %>
                            <span class="btnType01"><input type="button" value="인수증 출력" onClick="pop_Window('met_move_stin_receip_print.asp?mvin_in_date=<%=mvin_in_date%>&mvin_in_stock=<%=mvin_in_stock%>&mvin_in_seq=<%=mvin_in_seq%>','met_move_stin_print_pop','scrollbars=yes,width=750,height=600')"></span>
       <% end if %>                     
                        </div>
					</div>
					<br>               		
