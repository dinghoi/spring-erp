...
asset_company = request.cookies("srvmg_user")("coo_asset_company")
	...
	<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
		<div id="wrap">			
			...
			<div id="container">
				...
				<form action="nh_acpt_reg_ok.asp" method="post" name="frm">
				<div class="gView">
						...
						<tbody>
							...
							<tr>
								...
								<td class="left" colspan="5">
              					...
              					<input name="old_mg_ce" type="hidden" id="old_mg_ce" value="">
              					<input name="old_mg_ce_id" type="hidden" id="old_mg_ce_id" value="">
              					<input name="old_belong" type="hidden" id="old_belong" value="">
              					<input name="old_reside_place" type="hidden" id="old_reside_place" value="">
                                </td>
							...
							<tr id="change_addr" style="display:none">
								...
								<td class="left" colspan="7">
              					...
              					<input name="belong" type="hidden" id="belong" value="">
							...
							%>
								...
								<th>시리얼NO</th>
								<td class="left"><input name="serial_no" type="text" id="serial_no" style="width:150px" notnull errname="시리얼NO" onKeyUp="checklength(this,20)"></td>
							</tr>
						</tbody>
					</table>
				</div>
