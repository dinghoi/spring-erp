            	...
            	<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						%>
			  				<tr id="pummok_list<%=i%>" style="display:none">
                                ...
                                <td class="right"><%=formatnumber(amount_tab(2,i),0)%>
                                ...
                                <td><input name="c_amt<%=i%>" type="text" id="c_amt<%=i%>" style="width:100px;text-align:right" value="<%=formatnumber(amount_tab(3,i),0)%>" onKeyUp="NumCal(this);">
                                </td>
							</tr>
						<%
							next
