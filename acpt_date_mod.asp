		...
		<script type="text/javascript">
			...
			function chkfrm() {
				...
				if(document.frm.acpt_date.value >= document.frm.old_date.value) {
					alert('발생일자가 현재일보다 같거나 클수가 없습니다.');
					frm.acpt_date.focus();
					return false;}
				  ...
				  <table cellpadding="0" cellspacing="0" class="tableWrite">
				    ...
				    <tbody>
				      ...
				      <tr>
				        ...
				        <th>변경일자</th>
				        <td class="left"><input name="acpt_date" type="text" id="datepicker" style="width:80px;text-align:center" value="<%=acpt_date%>" readonly="true"></td>
			          </tr>
			        </tbody>
			      </table>
				</div>
