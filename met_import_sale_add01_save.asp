...
'                    response.End()
                    ...
                    if rowcount > -1 then
		               for si=0 to rowcount
		                 ...
		                 if Rs_seri.eof or Rs_seri.bof then
							   ...
							   sql = "update met_goods_serial set chulgo_date='"&chulgo_date&"',chulgo_no='"&rele_no&"',chulgo_seq='"&rele_seq&"',chlugo_amt='"&unit_danga&"',chulgo_trade='"&chulgo_trade_name&"',chulgo_trade_dept='"&chulgo_trade_dept&"',chulgo_bigo='"&serial_bigo&"',mod_date=now(),mod_user='"&user_name&"' where goods_code = '"&code_tab(i)&"' and serial_no = '"&serial_seq&"' and serial_seq = '"&serial_no&"'"
			...
			cg_goods_seq = right(("00" + cstr(j)),2)
		  	sql="insert into met_chulgo_goods (chulgo_date,chulgo_stock,chulgo_seq,cg_goods_seq,cg_goods_code,cg_goods_type,cg_goods_gubun,cg_standard,cg_goods_name,cg_goods_grade,cg_qty,cg_amt,cg_type,rl_service_no,rl_trade_name,rl_trade_dept,reg_date,reg_user,chulgo_stock_company,chulgo_stock_name,excel_att_file) values ('"&chulgo_date&"','"&chulgo_stock&"','"&chulgo_seq&"','"&cg_goods_seq&"','"&code_tab(i)&"','"&goods_type(i)&"','"&goods_gubun(i)&"','"&goods_standard(i)&"','"&goods_name(i)&"','"&goods_grade(i)&"','"&qty_tab(i)&"','"&amt_tab(i)&"','"&chulgo_id&"','"&service_no&"','"&chulgo_trade_name&"','"&chulgo_trade_dept&"',now(),'"&user_name&"','"&chulgo_stock_company&"','"&chulgo_stock_name&"','"&filename&"')" 
