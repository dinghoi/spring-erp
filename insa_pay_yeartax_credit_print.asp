                ...
                <table width="1150" border="1px" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tablePrt">
					...
					<table width="1150" border="1px" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tablePrt">
						<colgroup>
						 ...
						 <thead>
                              <tr>
                                <th colspan="11" height="30" align="left" scope="col" style=" border-bottom:1px solid #e3e3e3;">1. 공제대상자 및 공제대상금액 명세</th>
                              </tr>
                              <tr>
                                <th colspan="4" height="30" align="center" scope="col" style=" border-bottom:1px solid #e3e3e3;">공제대상자</th>
                                <th colspan="7" height="30" align="center" scope="col" style=" border-bottom:1px solid #e3e3e3;">신용카드등 사용금액</th>
                              </tr>
                              <tr>
						...
						do until rs.eof
                          ...
                          if chk_sum > 0 then 
	           			...
	           			%>
                            ...
                            <tr>
                                <td class="first" height="30" align="center" style=" border-left:1px solid #e3e3e3;">그 밖의 자료</td>
						...
						%>
                        	<tr>
                                <td colspan="5" height="30" align="center">10합계액</td>
                            ...
                            <tr>
                                <th colspan="11" height="30" align="left" scope="col" style=" border-bottom:1px solid #e3e3e3; background:#f8f8f8;">2. 신용카드등 소득공제액의 계산</th>
                            </tr>
                        <%
						    tax15_31 = 0
							tax15_32 = 0
						...
						%>
                            <tr>
                                <th rowspan="2" colspan="3" height="30" align="center" style="background:#f8f8f8;">11전통시장사용분<br>공제액<br>(9*30%)</th>
                                <th rowspan="2" colspan="2" style="background:#f8f8f8;">12대중교통이용분<br>공제액<br>(10*30%)</th>
                                <th rowspan="2" align="center" style="background:#f8f8f8;">13직불·선불카드<br>현금영수증등 사용분<br>(7+8)*30%</th>
                                <th rowspan="2" align="center" style="background:#f8f8f8;">14신용카드사용분<br>공제액<br>(6*15%)</th>
                                <th colspan="3" align="center" style="background:#f8f8f8;">15공제제외금액 계산</th>
                                <th rowspan="2" align="center" style="background:#f8f8f8;">16체크카드등<br>사용액증가분<br>공제액</th>
							</tr>
                            <tr>
                                <th height="30" align="center" style="background:#f8f8f8; border-left:1px solid #e3e3e3;"">15-1<br>총급여</th>
                                <th align="center" style="background:#f8f8f8;">15-2<br>최저사용금액<br>(15-1*25%)</th>
                                <th align="center" style="background:#f8f8f8;">15-3<br>공제제외금액</th>
							</tr>
                            <tr>
                            ...
                            <tr>
                                <th colspan="3" height="30" align="center" style="background:#f8f8f8;">17공제가능금액<br>[11+12+13+14-(15-3)+16]<br>(9*30%)</th>
                                <th colspan="2" align="center"style="background:#f8f8f8;">18공제한도액<br>[3백만원과<br>(15-1)*20%중 적은금액]</th>
                                <th align="center" style="background:#f8f8f8;">19일반 공제금액<br>(17과 18중 작은금액)</th>
                                <th colspan="2" style="background:#f8f8f8;">20전통시장 추가공제금액<br>[17-18(음수이면 0으로 봄)과<br>11중 적은금액(한도:1백만원)]</th>
                                <th colspan="2" align="center" style="background:#f8f8f8;">21대중교통 추가공제금액<br>[17-20-19(음수이면 0으로 봄)과<br>12중 적은금액(한도:1백만원)]</th>
                                <th align="center" style="background:#f8f8f8;">22최종 공제금액<br>[19+20+21]</th>
							</tr>
                            <tr>
                            ...
                            <tr>
                                <th colspan="11" height="30" align="left" scope="col" style=" border-bottom:1px solid #e3e3e3; background:#f8f8f8;">15-3 계산</th>
                            </tr>
                            <tr>
                                <th colspan="4" height="30" align="center" style="background:#f8f8f8;">구분</th>
                                <th colspan="5" align="center"style="background:#f8f8f8;">계산식</th>
                                <th colspan="2" align="center" style="background:#f8f8f8;">15-3</th>
							</tr>
                            <tr>
                                <th colspan="4" height="30" align="center" style="background:#f8f8f8;">15-2 최저사용금액 ≤ 신용카드사용분6</th>
                            ...
                            <tr>
                                <th colspan="11" height="30" align="left" scope="col" style=" border-bottom:1px solid #e3e3e3; background:#f8f8f8;">16 계산</th>
                            </tr>
                            <tr>
                                <th colspan="3" height="30" align="center" style="background:#f8f8f8;">구분</th>
                                <th align="center" style="background:#f8f8f8;">과세기간</th>
                                <th colspan="2" align="center" style="background:#f8f8f8;">금액</th>
                                <th colspan="5" align="left" style="background:#f8f8f8;">16체크카드 등 사용액 증가분 공제액</th>
							</tr>
                            <tr>
                                <th rowspan="2" colspan="3" height="30" align="center" style="background:#f8f8f8;">본인의 신용카드등 사용액</th>
                                <th align="center" style="background:#f8f8f8;">2013년</th>
                                <td colspan="2" align="right"><%=formatnumber(c_hap1,0)%>&nbsp;</td>
                                <td rowspan="2" colspan="5" align="left" >&nbsp;</td>
							</tr>
                            <tr>
                                <th height="30" align="center" style=" border-left:1px solid #e3e3e3; background:#f8f8f8;">2014년</th>
                                <td colspan="2" align="right"><%=formatnumber(c_hap1,0)%>&nbsp;</td>
							</tr>
                            <tr>
                                <th rowspan="2" colspan="3" height="30" align="center" style="background:#f8f8f8;">본인의 신용카드등 사용액</th>
                                <th align="center" style="background:#f8f8f8;">2013년</th>
                                <td colspan="2" align="right"><%=formatnumber(c_hap1,0)%>&nbsp;</td>
                                <td rowspan="2" colspan="5" align="left" >(계산식)<br>㉮2013년 본인의 신용카드 등 사용액 ≥ 2014년 본인의 신용카드 등 사용액 : "0"<br>㉯2013년 본인의 신용카드 등 사용액 < 2014년 본인의 신용카드등<br>사용액:(2014년 하반기 추가공제율사용분 - 2013년 추가공제율사용분<br>*50%) * 10%(단, 음수인 경우 "0")</td>
							</tr>
                            <tr>
                                <th height="30" align="center" style="border-left:1px solid #e3e3e3; background:#f8f8f8;">2014년<br>하반기</th>
                                <td colspan="2" align="right"><%=formatnumber(c_hap1,0)%>&nbsp;</td>
							</tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="11" height="30" align="left" scope="col" style=" border-bottom:1px solid #e3e3e3;">「조세특례제한법 시행령」제121조의2제8항에 따라 신용카드 등 사용금액에 대한 소득공제를 신청 합니다.<br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2015 년 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;월 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;일<br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;신청인 : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(서명 또는 인)<br></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th height="30" align="center" style="background:#f8f8f8;">구비서류</th>
                                <td colspan="9" height="30" align="left"  >신용카드 등 사용금액 확인서(별지 제74호의5서식을 말합니다) 또는 국세청 홈페이지에서 제공하는 신용카드 등 사용금액 명세를 출력한 서류 1부</td>
                                <td>수수료 없음</td>
							</tr>
                   <%
				          end if
