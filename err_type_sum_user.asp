...
if reside = "9" and company = "전체" then
	...
	grade_sql = " (company = '" + reside_company + "' or company = '" + company + "') "
end if
...
for k = 1 to 31 step 6
	...
	sql = sql + " WHERE (as_process = '완료') and (as_type = '방문처리' or as_type = '원격처리') and (substring(err_pc_sw,"& k &",4)<>'') and " + grade_sql + " and (CAST(acpt_date as date) >= '" + from_date + "' AND CAST(acpt_date as date) <= '"+to_date+"')"
...
for k = 1 to 19 step 6
	...
	sql = sql + " WHERE (as_process = '완료') and (as_type = '방문처리' or as_type = '원격처리') and (substring(err_pc_hw,"& k &",4)<>'') and " + grade_sql + " and (CAST(acpt_date as date) >= '" + from_date + "' AND CAST(acpt_date as date) <= '"+to_date+"')"
...
for k = 1 to 13 step 6
	...
	sql = sql + " WHERE (as_process = '완료') and (as_type = '방문처리' or as_type = '원격처리') and (substring(err_monitor,"& k &",4)<>'') and " + grade_sql + " and (CAST(acpt_date as date) >= '" + from_date + "' AND CAST(acpt_date as date) <= '"+to_date+"')"
...
for k = 1 to 13 step 6
	...
	sql = sql + " WHERE (as_process = '완료') and (as_type = '방문처리' or as_type = '원격처리') and (substring(err_printer,"& k &",4)<>'') and " + grade_sql + " and (CAST(acpt_date as date) >= '" + from_date + "' AND CAST(acpt_date as date) <= '"+to_date+"')"
...
for k = 1 to 13 step 6
	...
	sql = sql + " WHERE (as_process = '완료') and (as_type = '방문처리' or as_type = '원격처리') and (substring(err_network,"& k &",4)<>'') and " + grade_sql + " and (CAST(acpt_date as date) >= '" + from_date + "' AND CAST(acpt_date as date) <= '"+to_date+"')"
...
for k = 1 to 13 step 6
	...
	sql = sql + " WHERE (as_process = '완료') and (as_type = '방문처리' or as_type = '원격처리') and (substring(err_server,"& k &",4)<>'') and " + grade_sql + " and (CAST(acpt_date as date) >= '" + from_date + "' AND CAST(acpt_date as date) <= '"+to_date+"')"
...
for k = 1 to 13 step 6
	...
	sql = sql + " WHERE (as_process = '완료') and (as_type = '방문처리' or as_type = '원격처리') and (substring(err_adapter,"& k &",4)<>'') and " + grade_sql + " and (CAST(acpt_date as date) >= '" + from_date + "' AND CAST(acpt_date as date) <= '"+to_date+"')"
	...
	<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
		<div id="wrap">			
			...
			<div id="container">
				...
				<form action="waiting.asp?pg_name=err_type_sum_user.asp" method="post" name="frm">
				<fieldset class="srch">
					<legend>조회영역</legend>
					<dl>					
						<dt>조건 검색</dt>
