...
objBuilder.Append "	saupbu_person, "
objBuilder.Append "	tot_person, "
objBuilder.Append "	saupbu_per, "	'인원 차지율
objBuilder.Append "	saupbu_cost_amt, "	'전사공통비(인원)
objBuilder.Append "	saupbu_sale, "	'사업부 매출
objBuilder.Append "	(tot_cost_amt * 0.5 / tot_sale * saupbu_sale) AS saupbu_sale_amt, "	'전사공통비(매출)
objBuilder.Append "	(saupbu_sale / tot_sale) AS sale_per "	'매출 차지율
objBuilder.Append "FROM ("
objBuilder.Append "		SELECT mgct.saupbu,  "
objBuilder.Append "			mgct.saupbu_person, "
objBuilder.Append "			mgct.tot_person, "
objBuilder.Append "			mgct.saupbu_per, "
objBuilder.Append "			(tot_cost_amt * 0.5 / tot_person * saupbu_person) as saupbu_cost_amt, "
	...
	<body>
		<div id="wrap">
			...
			<div id="container">
				...
				<h3 class="stit">3. 전사공통비(인원) = 전사공통비합계 * 0.5 / 총인원 * 사업부별 인원, 전사공통비(매출) = 전사공통비합계 * 0.5 / 총매출 * 사업부별 매출 </h3>
				      ...
				      <td width="52%" height="356" valign="top">
				      	...
				      	<table cellpadding="0" cellspacing="0" class="tableList">
                            ...
                            <tr>
                                ...
                                <th scope="col" colspan="3" style="border-bottom:1px solid #e3e3e3;">전사공통비(인원)</th>
