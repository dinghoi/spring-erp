			...
			<div id="container">
				...
				<div class="gView">
					<table border="1" cellpadding="0" cellspacing="0" class="tableList">
						...
						<tbody>
						<%
						Dim rsPay, arrPay, num, i
						Dim cost_center, mg_saupbu, pmg_id, pmg_emp_name, pmg_yymm, pmg_emp_no, pmg_give_total
						Dim org_company, org_bonbu, org_saupbu, org_team, emp_org_name, emp_reside_place, emp_reside_company
						Dim account, customer, tax_bill_yn, gubun, cost_vat, slip_memo

						num = 0

						'If (saupbu = sales_saupbu And position = "사업부장") Or (saupbu = sales_saupbu And position = "본부장") Or sales_grade = "0" Then
						If empProfitGrade = "Y" And sales_grade = "0" Then
							...
							If sales_saupbu = "전사공통비" Or sales_saupbu = "부문공통비" Or sales_saupbu = "부문공통비(2)" Then
						...
						<%
							...
							Dim rsInsure, arrInsure, tot_cost, base_pay, meals_pay, overtime_pay, tax_no, insure_tot
							Dim income_tax, annual_pay, retire_pay
						...
						Dim rsAlba, arrAlba, company, cost_company, draft_man, give_date, draft_no, alba_give_total, draft_tax_id

						'인건비 > 알바비
						objBuilder.Append "SELECT cost_center, mg_saupbu, company, bonbu, saupbu, team, org_name, cost_company, "
						objBuilder.Append "	draft_man, give_date, draft_no, alba_give_total, draft_tax_id "
						...
						Else
							...
							If Mid(cost_month, 5, 2) = "06" Or Mid(cost_month, 5, 2) = "12" Then
								objBuilder.Append "	AND slip_memo NOT LIKE '%표준&실제%' "		'6월, 12월 해당 비용 제외 처리요청(재무)
							End If
						End If
						...
						Dim rsTran, arrTran, car_owner, run_date, run_seq, somopum
						Dim oil_price, fare, parking, toll, run_memo
