				...
				<div class="gView">
					<table border="1" cellpadding="0" cellspacing="0" class="tableList">
						...
						If (saupbu = sales_saupbu And position = "사업부장") Or (saupbu = sales_saupbu And position = "본부장") Or sales_grade = "0" Then
							...
							objBuilder.Append "WHERE pmg_yymm = '"&cost_month&"' AND pmg_id <> '4' AND (cost_center <> '손익제외') "
						...
						<%
							...
							if sales_saupbu = "전사공통비" or sales_saupbu = "부문공통비" Then
								...
								objBuilder.Append "	AND (cost_center ='직접비' or cost_center ='상주직접비') AND  mg_saupbu ='"&sales_saupbu&"' "
							end If
						...
						if sales_saupbu = "전사공통비" or sales_saupbu = "부문공통비" then
							...
							objBuilder.Append "	AND mg_saupbu ='"&sales_saupbu&"' and (cost_center ='직접비' or cost_center ='상주직접비') "
						end If
