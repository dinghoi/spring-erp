		...
		<div id="container">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
				  <tr>
				    <td>
					<div class="btnCenter">
                    <a href="/sales/excel/saupbu_sales_detail_excel_old.asp?cost_month=<%=cost_month%>&sales_saupbu=<%="회사간거래"%>" class="btnType04">매출액 엑셀다운로드</a>
                    <a href="/sales/excel/company_deal_detail_excel_old.asp?cost_month=<%=cost_month%>" class="btnType04">비용 엑셀다운로드</a>
					</div>                  
                    </td>
			      </tr>
				  </table>
