				...
				<form action="" method="post" name="frm">
					...
					<tr>
				    	...
				    	<table cellpadding="0" cellspacing="0" class="scrollList">
							...
							<tbody>
								...
								arrCommCost = Array("78000000", "83000000", "22000000", "30000000", "19000000", "20000000", "17000000", "5000000", "5000000")
								%>
								<!--=====	비용합계	=====-->
								<tr bgcolor="#FFFFCC">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
				  	<tr>
				    	<td>
							<div class="btnCenter">
			            		<a href="/sales/saupbu_profit_loss_excel_std.asp?cost_year=<%=cost_year%>&cost_mm=<%=cost_mm%>&sales_saupbu=<%=sales_saupbu%>" class="btnType04">화면 엑셀다운로드</a>
			            		<a href="/sales/cost_center_detail_excel_std.asp?cost_month=<%=cost_month%>&sales_saupbu=<%=sales_saupbu%>" class="btnType04">상주비/직접비 엑셀다운로드</a>
								...
								<%'If sales_grade = "0" Then	%>
			            			<!--<a href="/sales/cost_center_detail_excel_std.asp?cost_month=<%=cost_month%>&sales_saupbu=<%="전사공통비"%>" class="btnType04">전사공통비 엑셀다운로드</a>
			          				<a href="/sales/cost_center_detail_excel_std.asp?cost_month=<%=cost_month%>&sales_saupbu=<%="부문공통비"%>" class="btnType04">부문공통비 엑셀다운로드</a>-->
								<%'End If%>
							</div>
            			</td>
			    	</tr>
