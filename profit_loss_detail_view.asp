...
if cost_id = "인건비" and cost_detail = "알바비" then
	...
	sql = sql & " Where saupbu='"&mg_saupbu&"' "
					...
					<table cellpadding="0" cellspacing="0" class="tableList">
						...
						<tbody>
							...
							<tr>
								...
								<td class="left">
							<% if (cost_id = "임차료" or cost_id = "외주비" or cost_id = "자재" or cost_id = "장비" or cost_id = "운반비") and (user_id = "900001" or user_id = "100359"or user_id = "100952") then	%>
