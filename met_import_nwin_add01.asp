	...
	<body>
		<div id="container">				
			<div class="gView">
                ...
                <form method="post" name="frm" action="met_import_nwin_add01_save.asp" enctype="multipart/form-data">
                    <table cellpadding="0" cellspacing="0" summary="" class="tableWrite">
						...
						<tbody>
							...
							<tr>
							  <th>비고</th>
							  <td class="left" colspan="8" ><textarea name="buy_memo" rows="2" id="textarea"><%=buy_memo%></textarea></td>
						    </tr>
						</tbody>
					</table>
                <br>
            	...
            	<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						%>
			  				<tr id="pummok_list<%=i%>" style="display:none">
                                ...
                                <td class="left">
                                <input name="excel_att_file<%=i%>" type="file" id="excel_att_file<%=i%>" size="1">
                                </td>
							</tr>
