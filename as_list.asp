			...
			<div id="container">
				...
				<form action="as_list.asp" method="post" name="frm">
						...
						<table cellpadding="0" cellspacing="0" class="tableList">
							...
							<thead>
								<tr>
                                    ...
                                    if tottal_record <> 0 then
                                        ...
                                        if (user_id="100037") or (c_grade = "0") and (process_sw = "N") then
                                    ...
                                    <%
                                        if tottal_record <> 0 then
                                            ...
                                            if (user_id="100037") or c_grade < "3" and (process_sw = "N") then
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<% if ((user_id="101100") or (user_id="100037") or (user_id="100431") or (user_id="100298") or (user_id="100249")) or ((c_grade = "0") and (rs( "as_process")="접수" or rs("as_process")="입고" or rs("as_process")="연기")) then %>
									...
									<td>
								  	<%
								  	If (user_id="101100" Or user_id="100037" Or user_id="100249" Or user_id="100431" Or user_id="100298" Or user_id = "101480") Or (c_grade < "3" And (rs("as_process")="접수" Or rs("as_process")="입고" Or rs("as_process")="연기")) Then
                                    ...
                                    <td>
								  	<% If ((user_id="101100") or (user_id="100037") or (user_id="100249") or (user_id="100431") or (user_id="100298")) or  (c_grade < "3" or rs("acpt_man") = user_name ) and (rs( "as_process")="접수" or rs("as_process")="입고" or rs("as_process")="연기") then %>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="15%">
                                <div class="btnCenter"><a href="/excel_down_condi.asp?from_date=<%=from_date%>&to_date=<%=to_date%>&date_sw=<%=date_sw%>&process_sw=<%=process_sw%>&cowork_yn=<%=cowork_yn%>&field_check=<%=field_check%>&field_view=<%=field_view%>&company=<%=company%>" class="btnType04">엑셀다운로드</a></div>
                            </td>
                            <td>
                                <div id="paging">
