		...
		<div id="container">
				...
				<div class="gView">
					<table cellpadding="0" cellspacing="0" class="tableList">
						...
						%>
							<tr>
								<td class="first" colspan="8">내역이 없습니다</td>
							</tr>
                        <%
						end if
						%>
							<tr>
								<td class="first; left" colspan="8"><span class="btnType04"><input type="button" value="선택" onclick="javascript:frmcheck1();"></span></td>
							</tr>
						</tbody>
					</table>
				</div>
