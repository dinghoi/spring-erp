    ...
    <td style="border-bottom:none; border-top:none;">
     <table width="680" border="1px" cellpadding="0" cellspacing="0">
      <tr>  
        ...
        <td width="*" height="30" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=chulgo_date%>(<%=rele_no%>&nbsp;<%=rele_seq%>)</span></td>
      ...
      <tr>  
        ...
        <td width="*" height="30" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rele_company%></span></td>
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">요청사업부</span></td>
        <td width="20%" height="30" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rele_saupbu%></span></td>
      ...
      <tr>  
        ...
        <td width="*" height="30" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=chulgo_id%></span></td>

        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">비고</span></td>
        <td colspan="3" width="20%" height="30" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=chulgo_memo%></span></td>
      </tr>
    </table>
   </td>
  </tr>  
  ...
  <tr>
    <td style="border-bottom:none; border-top:none;"><table width="680" border="1px" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="10%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">용도구분</strong></td>
