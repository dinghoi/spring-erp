					...
					<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						<tbody>
							...
							<tr>
								...
								<th>사용자</th>
								<td class="left"><input name="acpt_user" type="text" size="10" onKeyUp="checklength(this,20)" notnull errname="사용자">
								  &nbsp;<strong>직급</strong>
							...
							<tr>
                                ...
                                <input name="sido" type="text" id="sido" style="width:50px" readonly="true">
              					...
              					<input name="addr" type="text" id="addr" style="width:250px" notnull errname="번지" onKeyUp="checklength(this,50)">
							...
							<tr>
								...
								<td class="left" colspan="5">
                                <input name="mg_ce_id" type="hidden" id="mg_ce_id" size="10" readonly="true" value="">
                                <input name="mg_ce" type="hidden" id="mg_ce" size="8" readonly="true" value="">
              					<input name="team" type="hidden" id="team" size="12" readonly="true" value="">
            					<input name="reside_place" type="hidden" id="reside_place" size="12" readonly="true" value="">
                                <input name="s_ce_id" type="text" id="s_ce_id" size="10" readonly="true">
                                <input name="s_ce" type="text" id="s_ce" size="8" readonly="true">
              					<input name="s_team" type="hidden" id="s_team" value="">
            					<input name="s_reside_place" type="hidden" id="s_reside_place" value="">
            					<a href="#" class="btnType03" onClick="pop_Window('ce_select.asp?gubun=<%="입력"%>&mg_group=<%=mg_group%>','ceselect','scrollbars=yes,width=500,height=400')">CE지정</a>
                                </td>
								<th>문자발송</th>
								<td class="left">
							...
							%>
								...
								<th>모델명</th>
								<td class="left"><input name="model_no" type="text" id="model_no" style="width:150px" notnull errname="모델명" onKeyUp="checklength(this,20)"></td>
								<th>처리유형</th>
								<td class="left">
                                <select name="as_type" id="as_type" style="width:150px">
							...
							<tr>
								...
								<th>시리얼번호</th>
								<td class="left"><input name="serial_no" type="text" id="serial_no" style="width:150px" notnull errname="시리얼번호" onKeyUp="checklength(this,20)"></td>
								<th>자산번호</th>
								<td class="left"><input name="asets_no" type="text" id="asets_no" style="width:150px" notnull errname="자산번호" onKeyUp="checklength(this,20)"></td>
								<th>다량접수</th>
								<td class="left">
                                <input name="w_cnt" type="text" id="w_cnt"  value="<%=w_cnt%>" size="2" maxlength="2" onKeyPress="onlynum();" style="ime-mode:disabled">&nbsp;<strong>건 저장</strong>
                                </td>
							</tr>
						</tbody>
					</table>
