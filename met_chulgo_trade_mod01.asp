...
//				window.open('met_stock_goods_del_ok.asp?code_ary='+code_ary+'&del_ary='+del_ary+'&goods_type='+goods_type+'&stock_code='+stock_code+'', '팝업공지', 'width='+ popupW +', height='+ popupH +', left='+ left +', top='+ top +', location=no, status=no, menubar=no, toolbar=no, scrollbars=no, resizable=no');
		...
		function delcheck() 
				...
				if (a==true) {
					...
					document.frm.action = "met_chulgo_trade_del_ok.asp";
					document.frm.submit();
				return true;
				}
				return false;
	...
	<body onload="pummok_list_view();">
			<div id="container">
                ...
                <form method="post" name="frm" action="met_chulgo_trade_mod01_save.asp">
				<div class="gView">
            	...
            	<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						<thead>
							<tr>
								<th class="first; left" colspan="9" scope="col" style=" border-bottom:1px solid #e3e3e3;"><a href="#" onClick="pop_pummok_del()" class="btnType03">선택삭제</a>&nbsp;<a href="#" onClick="pop_pummok()" class="btnType03">출고품목선택</a></th>
							</tr>
							<tr>
