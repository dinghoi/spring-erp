	...
	<body>
		<div id="wrap">			
			...
			<div id="container">
				...
				<form action="waiting.asp?pg_name=ce_type.asp" method="post" name="frm">
				<fieldset class="srch">
					<legend>조회영역</legend>
					<dl>					
						<dt>조건 검색</dt>
                        <dd>
                            <p>
                    			...
                    			<a href="ce_type_excel.asp?from_date=<%=from_date%>&to_date=<%=to_date%>&team=<%=team%>" class="btnType04">엑셀다운로드</a>
                    			<a href="ce_type_detail_excel.asp?from_date=<%=from_date%>&to_date=<%=to_date%>" class="btnType04">세부내역 엑셀다운로드</a>
