	...
	<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
		<div id="wrap">
			...
			<div id="container">
				...
				<form action="insa_pay_overtime_report2.asp?ck_sw=<%="n"%>" method="post" name="frm">
				<fieldset class="srch">
					<legend>조회영역</legend>
					<dl>
						<dt>조건 검색</dt>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
	      	...
	      	<td width="20%">
	            ...
	            <a href="insa_pay_overtime_excel2.asp?view_condi=<%=view_condi%>&from_date=<%=from_date%>&to_date=<%=to_date%>&pmg_yymm=<%=pmg_yymm%>" class="btnType04">조직/개인별합계</a>
						</div>
	        </td>
					<td width="50%"></td
					<td width="20%">
