...
if view_condi = "전체" then
      Sql = "select * from pay_month_give where (pmg_yymm = '"+pmg_yymm+"' ) and (pmg_id = '1') ORDER BY pmg_bonbu,pmg_saupbu,pmg_team ASC"
   else   
	  Sql = "select * from pay_month_give where (pmg_yymm = '"+pmg_yymm+"' ) and (pmg_id = '1') and (pmg_company = '"+view_condi+"') ORDER BY pmg_company,pmg_bonbu,pmg_saupbu,pmg_team ASC"
end if
Rs.Open Sql, Dbconn, 1

curr_yyyy = mid(cstr(pmg_yymm),1,4)
curr_mm = mid(cstr(pmg_yymm),5,2)
title_line = cstr(curr_yyyy) + "년 " + cstr(curr_mm) + "월 " + " 팀별 급여내역(" + view_condi + ")"
...
-->
    ...
    <object id="factory" style="display:none;" viewastext classid="clsid:1663ed61-23eb-11d2-b92f-008048fdd814" codebase="/smsx.cab#Version=7.0.0.8">
    	...
    	<div id="wrap">			
			<div id="container">
				<form action="insa_pay_month_saup_print2.asp" method="post" name="frm">
				<div class="gView">
                ...
                <table width="1150" border="1px" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tablePrt">
						...
						<thead>
							<tr>
				               <th colspan="2" height="30" scope="col" style=" border-bottom:1px solid #e3e3e3;">팀&nbsp;&nbsp;명</th>
...
' 사업부가틀리면
                           if bi_org <> pmg_saupbu then
							  ...
							  if bi_team = "" and bi_org = "" and bi_bonbu = "" then
							           bi_team = bi_company 
							      else
							          if bi_team = "" and bi_org = "" then
								             bi_team = bi_bonbu + " 직할"
										 else
										     if bi_team = "" then
											     bi_team = bi_org + " 직할"
	       ...
	       %>
                              <tr>
                                <td rowspan="3" class="first"><%=bi_team%>&nbsp;&nbsp;계</td>
                                <td rowspan="3" class="right" style="font-size:11px;"><%=formatnumber(team_pay_count,0)%>&nbsp;명</td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_base_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_meals_pay,0)%></td>
                                <td class="right" style="font-size:11px;">&nbsp;</td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_postage_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_re_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_overtime_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_car_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_nps_amt,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_nhis_amt,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_epi_amt,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_longcare_amt,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_income_tax,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_wetax,0)%></td>
							</tr>
                            <tr>
                                <td class="right" style=" border-left:1px solid #e3e3e3;font-size:11px;"><%=formatnumber(team_position_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_custom_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_job_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_job_support,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_jisa_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_long_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_disabled_pay,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_other_amt1,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_sawo_amt,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_school_amt,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_nhis_bla_amt,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_long_bla_amt,0)%></td>
                                <td class="right" style="font-size:11px;"><strong><%=formatnumber(team_deduct_tot,0)%></strong></td>
							</tr>
                            <tr>
                                ...
                                <td class="right" style="font-size:11px;">&nbsp;</td>
                                <td class="right" style="font-size:11px;">&nbsp;</td>
                                <td class="right" style="font-size:11px;"><strong><%=formatnumber(team_give_tot,0)%></strong></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_hyubjo_amt,0)%></td>
                                
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_year_incom_tax,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_year_wetax,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_year_incom_tax2,0)%></td>
                                <td class="right" style="font-size:11px;"><%=formatnumber(team_year_wetax2,0)%></td>
                                <td class="right" style="font-size:11px;"><strong><%=formatnumber(team_curr_pay,0)%></strong></td>
							</tr>
	       <%
                            team_base_pay = 0 
				            team_meals_pay = 0
