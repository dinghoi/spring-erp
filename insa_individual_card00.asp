...
'be_pg = request("be_pg")
be_pg1 = "insa_individual_card00.asp"
'page = request("page")
	...
	<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false" onLoad="inview()">
		<div id="wrap">			
			<div id="container">
				...
				<form action="insa_individual_card00.asp" method="post" name="frm">
                <div class="gView">
					<table cellpadding="0" cellspacing="0" class="tableWrite">
                        ...
                        <% if not rs.EOF or not rs.BOF then %>
                            ...
                            <tr>
                                ...
                                <th>e-메일주소</th>
								<td colspan="3" class="left"><%=rs("emp_email")%>@k-won.co.kr&nbsp;</td>
							</tr>
                            <tr>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
				  <tr>
				    ...
				    <td width="20%">
					<div class="btnCenter">
                    <a href="#" class="btnType04" onClick="pop_Window('insa_card01.asp?emp_no=<%=rs("emp_no")%>&be_pg=<%=be_pg1%>','emp_card1_pop','scrollbars=yes,width=1300,height=750')">☞ 인사기록 기타정보</a>
					</div>                  
                    </td>
			      </tr>
				  </table>
