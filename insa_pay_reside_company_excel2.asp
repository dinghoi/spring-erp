					...
					<table border="1" cellpadding="0" cellspacing="0" class="tableList">
						<thead>
							<tr>
				               ...
				               <th colspan="14" scope="col" style="background:#FFFFE6;">기본급여 및 제수당</th>
                               <th colspan="15" scope="col" style="background:#E0FFFF;">공제 및 차인지급액</th>
                            ...
                            <tr>
                                ...
                                <td scope="col" style="background:#f8f8f8;">통신비</td>
                                <td scope="col" style="background:#f8f8f8;">소급급여</td>
                                <td scope="col" style="background:#f8f8f8;">연장근로수당</td>
                                <td scope="col" style="background:#f8f8f8;">주차지원금</td>
                                <td scope="col" style="background:#f8f8f8;">직책수당</td>
                                <td scope="col" style="background:#f8f8f8;">고객관리수당</td>
                                <td scope="col" style="background:#f8f8f8;">직무보조비</td>
                                <td scope="col" style="background:#f8f8f8;">업무장려비</td>
                                <td scope="col" style="background:#f8f8f8;">본지사근무비</td>
                                <td scope="col" style="background:#f8f8f8;">근속수당</td>
                                <td scope="col" style="background:#f8f8f8;">장애인수당</td>
                                <td scope="col" style="background:#f8f8f8;">지급소계</td>
                                
								<td scope="col" style="background:#f8f8f8;">국민연금</td>
                                <td scope="col" style="background:#f8f8f8;">건강보험</td>
								<td scope="col" style="background:#f8f8f8;">고용보험</td>
                                <td scope="col" style="background:#f8f8f8;">장기요양보험료</td>
                                <td scope="col" style="background:#f8f8f8;">소득세</td>
                                <td scope="col" style="background:#f8f8f8;">지방소득세</td>
                                <td scope="col" style="background:#f8f8f8;">연말정산소득세</td>
                                <td scope="col" style="background:#f8f8f8;">연말정산지방세</td>
                                <td scope="col" style="background:#f8f8f8;">연말재정산소득세</td>
                                <td scope="col" style="background:#f8f8f8;">연말재정산지방세</td>
                                <td scope="col" style="background:#f8f8f8;">기타공제</td>
                                <td scope="col" style="background:#f8f8f8;">사우회 회비</td>
                                <td scope="col" style="background:#f8f8f8;">학자금상환</td>
                                <td scope="col" style="background:#f8f8f8;">건강보험료정산</td>
                                <td scope="col" style="background:#f8f8f8;">장기요양보험료정산</td>
                                <td scope="col" style="background:#f8f8f8;">협조비</td>
                                <td scope="col" style="background:#f8f8f8;">공제합계</td>
							</tr>
						</thead>
                        <tbody>
					<%
						do until rs.eof
	           			...
	           			%>
							<tr>
                                ...
                                <td align="right"><%=rs("saup_count")%>&nbsp;명</td>
                                <td align="right"><%=formatnumber(rs("pmg_base_pay"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("pmg_meals_pay"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("pmg_postage_pay"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("pmg_re_pay"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("pmg_overtime_pay"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("pmg_car_pay"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("pmg_position_pay"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("pmg_custom_pay"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("pmg_job_pay"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("pmg_job_support"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("pmg_jisa_pay"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("pmg_long_pay"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("pmg_disabled_pay"),0)%>&nbsp;</td>
                       ...
                       %>
                                <td align="right"><%=formatnumber(rs("de_nps_amt"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("de_nhis_amt"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("de_epi_amt"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("de_longcare_amt"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("de_income_tax"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("de_wetax"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("de_year_incom_tax"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("de_year_wetax"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("de_year_incom_tax2"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("de_year_wetax2"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("de_other_amt1"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("de_sawo_amt"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("de_school_amt"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("de_nhis_bla_amt"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("de_long_bla_amt"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("de_hyubjo_amt"),0)%>&nbsp;</td>
                                <td align="right"><%=formatnumber(rs("de_deduct_total"),0)%>&nbsp;</td>
					   ...
					   <%
						...
						%>
                          	<tr>
                                ...
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_postage_pay(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_re_pay(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_overtime_pay(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_car_pay(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_position_pay(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_custom_pay(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_job_pay(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_job_support(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_jisa_pay(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_long_pay(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_disabled_pay(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_give_tot(6),0)%>&nbsp;</th>
                                
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_nps_amt(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_nhis_amt(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_epi_amt(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_longcare_amt(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_income_tax(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_wetax(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_year_incom_tax(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_year_wetax(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_year_incom_tax2(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_year_wetax2(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_other_amt1(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_sawo_amt(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_school_amt(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_nhis_bla_amt(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_long_bla_amt(6),0)%>&nbsp;</th>
                                <th bgcolor="#EEFFFF" align="right"><%=formatnumber(sum_hyubjo_amt(6),0)%>&nbsp;</th>
						 ...
						 %>	
                            <tr>
                                ...
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(pay_count(i),0)%>&nbsp;명</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_base_pay(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_meals_pay(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_postage_pay(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_re_pay(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_overtime_pay(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_car_pay(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_position_pay(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_custom_pay(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_job_pay(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_job_support(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_jisa_pay(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_long_pay(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_disabled_pay(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_give_tot(i),0)%>&nbsp;</th>
                                
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_nps_amt(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_nhis_amt(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_epi_amt(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_longcare_amt(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_income_tax(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_wetax(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_year_incom_tax(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_year_wetax(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_year_incom_tax2(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_year_wetax2(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_other_amt1(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_sawo_amt(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_school_amt(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_nhis_bla_amt(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_long_bla_amt(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_hyubjo_amt(i),0)%>&nbsp;</th>
                                <th bgcolor="#FFE8E8" align="right"><%=formatnumber(sum_deduct_tot(i),0)%>&nbsp;</th>
