			...
			<div id="container">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
				  <tr>
				    <td width="15%">
					<div class="btnCenter">
                    <a href="excel_down_ce_user.asp" class="btnType04">엑셀다운로드</a>
					</div>
                  	</td>
				    <td>
                    <div id="paging">
                        <a href="as_list_ce_user.asp?page=<%=first_page%>&view_sort=<%=view_sort%>">[처음]</a>
                  	<% If intstart > 1 Then %>
                        <a href="as_list_ce_user.asp?page=<%=intstart -1%>&view_sort=<%=view_sort%>">[이전]</a>
                    <% End If %>
                    ...
                    <% For i = intstart To intend %>
						<% If i = Int(page) Then %>
							<b>[<%=i%>]</b>
						<% Else %>
							<a href="as_list_ce_user.asp?page=<%=i%>&view_sort=<%=view_sort%>">[<%=i%>]</a>
						<% End If %>
                    <% Next %>

                  	<% If intend < total_page Then %>
                        <a href="as_list_ce_user.asp?page=<%=intend+1%>&view_sort=<%=view_sort%>">[다음]</a> <a href="as_list_ce_user.asp?page=<%=total_page%>&view_sort=<%=view_sort%>">[마지막]</a>
                    <% Else %>
                        [다음]&nbsp;[마지막]
                    <% End If %>
                    </div>
					...
					<% If view_sort = "DESC" Then %>
                          <a href="as_list_ce_user.asp?view_sort=asc" class="btnType04">정순조회</a>
                    <% Else %>
                          <a href="as_list_ce_user.asp?view_sort=desc" class="btnType04">역순조회</a>
                    <% End If %>
					</div>
                    </td>
			      </tr>
