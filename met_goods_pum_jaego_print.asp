...
-->
    ...
    <object id="factory" style="display:none;" viewastext classid="clsid:1663ed61-23eb-11d2-b92f-008048fdd814" codebase="/smsx.cab#Version=7.0.0.8">
		...
		<div id="wrap">			
			<div id="container">
				<form action="met_goods_pum_jaego_print.asp" method="post" name="frm">
				<div class="gView">
						...
						<colgroup>
						 ...
						 <thead>
                              <tr bgcolor="#f8f8f8">
				                ...
				                <th rowspan="2" scope="col" align="center" class="style14C">창고</th>
                                <th colspan="2" scope="col" align="center" class="style14C">전년이월</th>
                                <th colspan="2" scope="col" align="center" class="style14C">입고</th>
                                <th colspan="2" scope="col" align="center" class="style14C">출고</th>
                                <th colspan="2" scope="col" align="center" class="style14C">현재고</th>
			                  </tr>
                              <tr>
