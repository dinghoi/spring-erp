...
'	end if
	...
	do until i = w_cnt
		...
		if	(company = "웅진씽크빅" or company = "웅진식품" or company = "코웨이") then		
			sql="insert into nkp.as_acpt (acpt_date,acpt_man,acpt_grade,acpt_user,user_grade,tel_ddd,tel_no1,tel_no2,hp_ddd,hp_no1,hp_no2,company,dept,sido,gugun,dong,addr,mg_ce_id,mg_ce,mg_group,as_memo,request_date,request_time,as_process,as_type,visit_request_yn,maker,as_device,model_no,serial_no,asets_no,reside,reside_place,reside_company,team,sms,reg_id,write_date,write_cnt) values (cast('"&acpt_date&"' as datetime),'"&acpt_man&"','"&acpt_grade&"','"&acpt_user&"','"&user_grade&"','"&tel_ddd&"','"&tel_no1&"','"&tel_no2&"','"&hp_ddd&"','"&hp_no1&"','"&hp_no2&"','"&company&"','"&dept&"','"&sido&"','"&gugun&"','"&dong&"','"&addr&"','"&s_ce_id&"','"&s_ce&"','"&mg_group&"','"&as_memo&"','"&request_date&"','"&request_time&"','"&as_process&"','"&as_type&"','"&visit_request_yn&"','"&maker&"','"&as_device&"','"&model_no&"','"&serial_no&"','"&asets_no&"','"&reside&"','"&reside_place&"','"&reside_companye&"','"&team&"','"&sms_yn&"','"&regi_id&"',cast('"&acpt_date&"' as datetime),"&i&")"
			dbconn.execute(sql)
			itft_type = as_type
			...
			sql="insert into itft2005.as_acpt (acpt_date,acpt_man,acpt_user,user_man,tel_ddd,tel_no1,tel_no2,company,dept,sido,gugun,dong,addr,mg_ce_id,mg_ce,as_major,as_memo,request_date,request_time,as_process,as_type,maker,as_device,model_no,serial_no,asets_no,reside_place,sms,mg_company,write_date,write_cnt) values (cast('"&acpt_date&"' as datetime),'"&acpt_man&"','"&acpt_user&"','"&acpt_user&"','"&tel_ddd&"','"&tel_no1&"','"&tel_no2&"','"&company&"','"&dept&"','"&sido&"','"&gugun&"','"&dong&"','"&addr&"','"&s_ce_id&"','"&s_ce&"','"&as_major&"','"&as_memo&"','"&request_date&"','"&request_time&"','"&as_process&"','"&itft_type&"','"&maker&"','"&as_device&"','"&model_no&"','"&serial_no&"','"&asets_no&"','콜센터','"&sms_yn&"','케이원',cast('"&acpt_date&"' as datetime),"&i&")"
			'dbconn1.execute(sql)
		else
			sql="insert into nkp.as_acpt (acpt_date,acpt_man,acpt_grade,acpt_user,user_grade,tel_ddd,tel_no1,tel_no2,hp_ddd,hp_no1,hp_no2,company,dept,sido,gugun,dong,addr,mg_ce_id,mg_ce,mg_group,as_memo,request_date,request_time,as_process,as_type,visit_request_yn,maker,as_device,model_no,serial_no,asets_no,reside,reside_place,reside_company,team,sms,reg_id) values (cast('"&acpt_date&"' as datetime),'"&acpt_man&"','"&acpt_grade&"','"&acpt_user&"','"&user_grade&"','"&tel_ddd&"','"&tel_no1&"','"&tel_no2&"','"&hp_ddd&"','"&hp_no1&"','"&hp_no2&"','"&company&"','"&dept&"','"&sido&"','"&gugun&"','"&dong&"','"&addr&"','"&s_ce_id&"','"&s_ce&"','"&mg_group&"','"&as_memo&"','"&request_date&"','"&request_time&"','"&as_process&"','"&as_type&"','"&visit_request_yn&"','"&maker&"','"&as_device&"','"&model_no&"','"&serial_no&"','"&asets_no&"','"&reside&"','"&reside_place&"','"&reside_company&"','"&team&"','"&sms_yn&"','"&user_id&"')"
			dbconn.execute(sql)
		end if  
	loop
