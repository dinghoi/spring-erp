	...
	<body>
		<div id="container">
			<div class="gView">
                ...
                <form method="post" name="frm" action="met_stock_in_add01_save.asp" enctype="multipart/form-data">
                    <table cellpadding="0" cellspacing="0" summary="" class="tableWrite">
						...
						<tbody>
							...
							<tr>
							  <th>비고</th>
							  <td class="left" colspan="8" ><textarea name="buy_memo" rows="3" style="text-align:left; ime-mode:active" id="textarea"><%=buy_memo%></textarea></td>
						    </tr>
						</tbody>
					</table>
                <br>
