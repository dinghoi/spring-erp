...
//				}	
		...
		function NumCal(txtObj){
			...
			for (j=1;j<21;j++) {
				...
				acpt_qty = parseInt(mvin_qty[j]);
				sign_qty = parseInt(c_qty[j]);
				
//				if (mvin_qty[j] > c_qty[j]) {
				if (acpt_qty != sign_qty) {	
					alert ("출고수량과 입고수량이 같지않습니다!!");
					return false;
				}
	...
	<body onload="pummok_list_view();">
			<div id="container">
                ...
                <form method="post" name="frm" action="met_chulgo_stin_add_save.asp">
				<div class="gView">
