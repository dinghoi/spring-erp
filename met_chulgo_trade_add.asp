...
//				var url = "met_goods_select.asp?code_ary="+code_ary;
				pop_Window(url,'출고품목선택','scrollbars=yes,width=800,height=400');
...
//				window.open('met_stock_goods_del_ok.asp?code_ary='+code_ary+'&del_ary='+del_ary+'&goods_type='+goods_type+'&stock_code='+stock_code+'', '팝업공지', 'width='+ popupW +', height='+ popupH +', left='+ left +', top='+ top +', location=no, status=no, menubar=no, toolbar=no, scrollbars=no, resizable=no');
	...
	<body>
			<div id="container">
                ...
                <form method="post" name="frm" action="met_chulgo_trade_add_save.asp">
				<div class="gView">
					<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						<tbody>
                            ...
                            %>
                              ...
                              <th>서비스NO</th>
							  <td class="left">
							  <input name="service_no" type="text" id="service_no" style="width:80px" readonly="true" value="<%=service_no%>">
							  <a href="#" class="btnType03" onClick="pop_Window('met_as_search.asp?work_item=<%=work_item%>','met_as_search','scrollbars=yes,width=900,height=400')">서비스조회</a>
                              <input type="hidden" name="acpt_date" value="<%=acpt_date%>" ID="work_date">
                              <input type="hidden" name="as_device" value="<%=as_device%>" ID="work_item">
                              </td>
							  <th>고객사</th>
							  <td class="left">
                              <input name="chulgo_trade_name" type="text" value="<%=chulgo_trade_name%>" readonly="true" style="width:120px">
                              
                              <input name="chulgo_trade_dept" type="text" value="<%=chulgo_trade_dept%>" readonly="true" style="width:120px">
                            ...
                            <tr>
							  <th>비고</th>
							  <td class="left" colspan="8" ><textarea name="chulgo_memo" rows="3" id="textarea"><%=chulgo_memo%></textarea></td>
						    </tr>
						</tbody>
					</table>
				</div>
            	...
            	<table cellpadding="0" cellspacing="0" class="tableWrite">
						...
						<thead>
							<tr>
								<th class="first; left" colspan="8" scope="col" style=" border-bottom:1px solid #e3e3e3;"><a href="#" onClick="pop_pummok_del()" class="btnType03">선택삭제</a>&nbsp;<a href="#" onClick="pop_pummok()" class="btnType03">출고품목선택</a></th>
							</tr>
							<tr>
