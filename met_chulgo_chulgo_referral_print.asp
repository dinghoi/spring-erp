    ...
    <td style="border-bottom:none; border-top:none;">
     <table width="680" border="1px" cellpadding="0" cellspacing="0">
      <tr>  
        ...
        <td width="*" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=chulgo_no%>&nbsp;<%=chulgo_stock%>&nbsp;<%=rele_seq%></strong></td>
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">출고담당</span></td>
        <td width="20%" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=chulgo_emp_name%>&nbsp;<%=chulgo_org_name%></strong></td>
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">출고창고</span></td>
        <td width="20%" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=chulgo_stock_name%>&nbsp;(<%=chulgo_stock_company%>)</strong></td>
      </tr>
      <tr>  
        ...
        <td width="20%" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=rele_stock_name%>&nbsp;(<%=rele_stock_company%>)</strong></td>
      </tr>
      <tr>  
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">신청자</span></td>
        <td width="*" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=rele_emp_name%>&nbsp;<%=rele_org_name%></strong></td>
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">출고요청일</span></td>
        <td width="20%" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=chulgo_rele_date%></strong></td>
        <td width="12%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><span class="style1">신청창고<br>입고일</span></td>
        <td width="20%" height="30" align="left" valign="middle" ><span class="style1"><strong>&nbsp;<%=rele_emp_name%>&nbsp;<%=in_stock_date%></strong></td>
      </tr>
      <tr>  
  ...
  <tr>
    <td style="border-bottom:none; border-top:none;"><table width="680" border="1px" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="6%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">용도</strong></td>
        ...
        <td width="8%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">의뢰수량</strong></td>
        <td width="8%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">출고수량</strong></td>
        <td width="8%" height="30" align="center" valign="middle" style=" background-color:#eaeaea;"><strong class="style1">상태</strong></td>
   ...
   %>
      <tr>
        ...
        <td width="6%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp;<%=rs("cg_goods_type")%></span></td>
        ...
        <td width="8%" height="20" align="right" valign="middle" ><span class="style1"><span><%=formatnumber(rs("rl_qty"),0)%></span>&nbsp;</td>
        <td width="8%" height="20" align="right" valign="middle" ><span class="style1"><span><%=formatnumber(rs("cg_qty"),0)%></span>&nbsp;</td>
        <td width="8%" height="20" align="left" valign="middle" ><span class="style1"><span>&nbsp<%=rs("cg_goods_grade")%>;</span></td>
