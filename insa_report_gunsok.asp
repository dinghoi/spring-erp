	...
	<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
		<div id="wrap">			
			...
			<div id="container">
				...
				<form action="insa_report_gunsok.asp?ck_sw=<%="n"%>" method="post" name="frm">
				<fieldset class="srch">
					<legend>조회영역</legend>
					<dl>					
						<dt>조건 검색</dt>
					...
					<table cellpadding="0" cellspacing="0" class="tableList">
						...
						<thead>
							<tr>
                                ...
                                <th colspan="17" scope="col" style=" border-bottom:1px solid #e3e3e3;">근&nbsp;속&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;년&nbsp;수(년)</th>
						...
						%>	
                            <tr>
                                ...
                                <td><%=formatnumber(gun_cnt(i,2),0)%></td>
                                <td><%=formatnumber(gun_cnt(i,3),0)%></td>
                                <td><%=formatnumber(gun_cnt(i,4),0)%></td>
                                <td><%=formatnumber(gun_cnt(i,5),0)%></td>
                                <td><%=formatnumber(gun_cnt(i,6),0)%></td>
                                <td><%=formatnumber(gun_cnt(i,7),0)%></td>
                                <td><%=formatnumber(gun_cnt(i,8),0)%></td>
                                <td><%=formatnumber(gun_cnt(i,9),0)%></td>
                                <td><%=formatnumber(gun_cnt(i,10),0)%></td>
                                <td><%=formatnumber(gun_cnt(i,11),0)%></td>
                                <td><%=formatnumber(gun_cnt(i,12),0)%></td>
                                <td><%=formatnumber(gun_cnt(i,13),0)%></td>
                                <td><%=formatnumber(gun_cnt(i,14),0)%></td>
                                <td><%=formatnumber(gun_cnt(i,15),0)%></td>
                                <td><%=formatnumber(gun_cnt(i,16),0)%></td>
                                <td><%=formatnumber(gun_cnt(i,17),0)%></td>
