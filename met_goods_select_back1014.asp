...
if view_c = "acpt" then
	sql = "select * from met_goods_code where goods_type = '"&goods_type&"' and goods_name like '%"&acpt_gname&"%' ORDER BY goods_name,goods_code ASC"
  else
	sql = "select * from met_goods_code where goods_type = '"&goods_type&"' and goods_standard like '%"&acpt_standard&"%' ORDER BY goods_name,goods_code ASC"
end if
...
//				}
	...
	<body onLoad="condi_view()">
		<div id="container">
				...
				<form action="met_goods_select.asp?code_ary=<%=code_ary%>&ck_sw=<%="n"%>" method="post" name="frm">
				<fieldset class="srch">
					<legend>조회영역</legend>
					<dl>					
                        <dd>
					 ...
					 %>
                                ...
                                <label id="p_gname">
								<strong>품목명</strong>
                                    <input name="acpt_gname" type="text" value="<%=acpt_gname%>" style="width:130px" id="acpt_gname">
								</label>
								<label id="p_standard">
								<strong>규격</strong>
                                	<input name="acpt_standard" type="text" value="<%=acpt_standard%>" style="width:130px" id="acpt_standard">
								</label>
				...
				<form action="met_goods_select_ok.asp" method="post" name="frm1">
				<div class="gView">
					<table cellpadding="0" cellspacing="0" class="tableList">
						...
						%>
							<tr>
								<td class="first; left" colspan="7"><span class="btnType04"><input type="button" value="선택" onclick="javascript:frmcheck1();"></span></td>
							</tr>
						</tbody>
					</table>
				</div>
