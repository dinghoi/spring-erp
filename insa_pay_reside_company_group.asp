...
be_pg = "insa_pay_reside_company_group.asp"
	...
	<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
		<div id="wrap">			
			...
			<div id="container">
				...
				<form action="insa_pay_reside_company_group.asp?ck_sw=<%="n"%>" method="post" name="frm">
				<fieldset class="srch">
					<legend>조회영역</legend>
					<dl>					
						<dt>◈ 검색◈</dt>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
				  <tr>
                    <td width="25%">
					<div class="btnleft">
                    <a href="insa_pay_reside_company_excel.asp?view_condi=<%=view_condi%>&pmg_yymm=<%=pmg_yymm%>" class="btnType04">엑셀다운로드</a>
                    <a href="insa_pay_reside_company_excel2.asp?view_condi=<%=view_condi%>&pmg_yymm=<%=pmg_yymm%>" class="btnType04">엑셀(전체항목)</a>
					</div>                  
                    </td>
                    <td width="50%">
                    </td>
				    <td width="25%">
					<div class="btnRight">
                    <a href="#" onClick="pop_Window('insa_pay_reside_company_print.asp?view_condi=<%=view_condi%>&pmg_yymm=<%=pmg_yymm%>','insa_pay_reside_company_pop','scrollbars=yes,width=1250,height=700')" class="btnType04">상주회사별 급여현황출력</a>
					</div>                  
                    </td>        
                    </td> 
			      </tr>
