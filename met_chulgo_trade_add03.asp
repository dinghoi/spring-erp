...
if not Rs_jago.eof then
	...
	pummok_tab(1,i) = Rs_jago("in_goods_type")
	pummok_tab(2,i) = Rs_jago("in_goods_gubun")
	pummok_tab(3,i) = Rs_jago("in_goods_code")
	pummok_tab(4,i) = Rs_jago("in_goods_name")
	pummok_tab(5,i) = Rs_jago("in_standard")
	pummok_tab(6,i) = Rs_jago("in_goods_grade")

	amount_tab(2,i) = Rs_jago("in_qty")
	amount_tab(3,i) = Rs_jago("in_cg_qty")
...
<html>
	...
	<body onload="pummok_list_view();">
			<div id="container">
                ...
                <form method="post" name="frm" action="met_chulgo_trade_add03_save.asp">
				<div class="gView">
