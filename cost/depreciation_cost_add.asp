...
<html lang="ko">
	<head>
		...
		<script type="text/javascript">
			...
			function delcheck()
				...
				if (a==true) {
					document.frm.action = "/cost/genneral_cost_del_ok.asp";
					document.frm.submit();
				return true;
				}
				return false;
	...
	<body onLoad="condi_view()">
			<div id="container">
				...
				<form action="/cost/depreciation_cost_add_save.asp" method="post" name="frm">
				<div class="gView">
				        ...
				        <td class="left">
                            <select name="org_company" id="org_company" style="width:120px">
                              ...
                              <%
								...
								SQL = "SELECT org_name FROM emp_org_mst "
								SQL = SQL & "WHERE (ISNULL(org_end_date) OR org_end_date = '0000-00-00') "
								SQL = SQL & "AND org_level = '회사' "
								SQL = SQL & "ORDER BY org_company ASC "
