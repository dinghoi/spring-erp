...
objBuilder.Append "WHERE eomt.org_bonbu = '' "
objBuilder.Append "	AND pmgt.pmg_yymm ='"&end_month&"' "
objBuilder.Append "	AND pmgt.pmg_id ='2' "
objBuilder.Append "GROUP BY eomt.org_company, eomt.org_bonbu, eomt.org_saupbu, eomt.org_team, eomt.org_name "
