...
be_pg = "insa_pay_grade_org_report.asp"
...
if view_condi = "전체" then
   ...
   elseif condi = "전체" then  
			...
			Sql = "select * from pay_month_give where (pmg_yymm = '"+pmg_yymm+"' ) and (pmg_id = '1') and (pmg_company = '"+view_condi+"') and (pmg_bonbu='"+condi+"')"
end if
	...
	<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
		<div id="wrap">			
			...
			<div id="container">
                ...
                <form action="insa_pay_grade_org_report.asp?ck_sw=<%="n"%>" method="post" name="frm">
				<fieldset class="srch">
					<legend>조회영역</legend>
					<dl>					
						<dt>조건 검색</dt>
